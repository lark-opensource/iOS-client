...
@implementation BDDSSZipArchive
...
#ifndef BBR_ZIP_LATER_VERSION_2
        ...
        @autoreleasepool {
            ...
            if (fp)
            {
                ...
                if ( fileInfo.tmu_date.tm_year!=0 )
                {
                    ...
                    //NSCalendar *gregorianCalendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierGregorian];
                    NSDate* orgDate = [[[self class] _gregorian] dateFromComponents:components];
...
@implementation NSFileManager (BDDSSZipArchive)
