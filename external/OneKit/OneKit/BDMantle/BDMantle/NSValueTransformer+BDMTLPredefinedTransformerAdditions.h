//
//  NSValueTransformer+BDMTLPredefinedTransformerAdditions.h
//  BDMantle
//
...
extern NSString * const BDMTLURLValueTransformerName;

/// The name for a value transformer that converts strings into NSUUIDs and back.
extern NSString * const BDMTLUUIDValueTransformerName;
...
/// proper boolean.
extern NSString * const BDMTLBooleanValueTransformerName;

@interface NSValueTransformer (BDMTLPredefinedTransformerAdditions)
...
+ (NSValueTransformer<BDMTLTransformerErrorHandling> *)mtl_valueMappingTransformerWithDictionary:(NSDictionary *)dictionary defaultValue:(id)defaultValue reverseDefaultValue:(id)reverseDefaultValue;
...
+ (NSValueTransformer<BDMTLTransformerErrorHandling> *)mtl_valueMappingTransformerWithDictionary:(NSDictionary *)dictionary;
...
+ (NSValueTransformer<BDMTLTransformerErrorHandling> *)mtl_JSONDictionaryTransformerWithModelClass:(Class)modelClass __attribute__((deprecated("Replaced by +[BDMTLJSONAdapter dictionaryTransformerWithModelClass:]")));

+ (NSValueTransformer<BDMTLTransformerErrorHandling> *)mtl_JSONArrayTransformerWithModelClass:(Class)modelClass __attribute__((deprecated("Replaced by +[BDMTLJSONAdapter arrayTransformerWithModelClass:]")));
