...
@protocol BDMTLModel;
@protocol BDMTLTransformerErrorHandling;

/// A BDMTLModel object that supports being parsed from and serialized to JSON.
@protocol BDMTLJSONSerializing <BDMTLModel>
@required
...
/// back to JSON.
///
/// If the receiver implements a `+<key>JSONTransformer` method, BDMTLJSONAdapter
...
/// be passed into -[BDMTLJSONAdapter initWithJSONDictionary:modelClass:], but
...
/// The domain for errors originating from BDMTLJSONAdapter.
extern NSString * const BDMTLJSONAdapterErrorDomain;

/// +classForParsingJSONDictionary: returned nil for the given dictionary.
extern const NSInteger BDMTLJSONAdapterErrorNoClassFound;

/// The provided JSONDictionary is not valid.
extern const NSInteger BDMTLJSONAdapterErrorInvalidJSONDictionary;

/// The model's implementation of +JSONKeyPathsByPropertyKey included a key which
/// does not actually exist in +propertyKeys.
extern const NSInteger BDMTLJSONAdapterErrorInvalidJSONMapping;

/// An exception was thrown and caught.
extern const NSInteger BDMTLJSONAdapterErrorExceptionThrown;

/// Associated with the NSException that was caught.
extern NSString * const BDMTLJSONAdapterThrownExceptionErrorKey;

/// Converts a BDMTLModel object to and from a JSON dictionary.
@interface BDMTLJSONAdapter : NSObject

/// Attempts to parse a JSON dictionary into a model object.
///
/// modelClass     - The BDMTLModel subclass to attempt to parse from the JSON.
///                  This class must conform to <BDMTLJSONSerializing>. This
...
/// of a specific class.
///
/// modelClass - The BDMTLModel subclass to attempt to parse from the JSON. This
///              class must conform to <BDMTLJSONSerializing>. This argument must
///              not be nil.
...
///
/// modelClass - The BDMTLModel subclass to attempt to parse from the JSON and
///              back. This class must conform to <BDMTLJSONSerializing>. This
///              argument must not be nil.
///
...
/// using the BDMTLBooleanValueTransformerName transformer.
///
...
@interface BDMTLJSONAdapter (ValueTransformers)

/// Creates a reversible transformer to convert a JSON dictionary into a BDMTLModel
...
/// into an array of BDMTLModel objects, and vice-versa.
///
/// modelClass - The BDMTLModel subclass to attempt to parse from each JSON
///              dictionary. This class must conform to <BDMTLJSONSerializing>.
...
/// This value transformer is used by BDMTLJSONAdapter to automatically convert
...
@interface BDMTLJSONAdapter (Deprecated)

@property (nonatomic, strong, readonly) id<BDMTLJSONSerializing> model __attribute__((unavailable("Replaced by -modelFromJSONDictionary:error:")));
...
+ (NSDictionary *)JSONDictionaryFromModel:(BDMTLModel<BDMTLJSONSerializing> *)model __attribute__((deprecated("Replaced by +JSONDictionaryFromModel:error:"))) NS_SWIFT_UNAVAILABLE("Replaced by +JSONDictionaryFromModel:error:");
...
- (id)initWithModel:(id<BDMTLJSONSerializing>)model __attribute__((unavailable("Replaced by -initWithModelClass:"))) NS_SWIFT_UNAVAILABLE("Replaced by -initWithModelClass:");
