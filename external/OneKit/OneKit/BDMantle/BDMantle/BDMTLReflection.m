...
SEL BDMTLSelectorWithKeyPattern(NSString *key, const char *suffix) {
...
SEL BDMTLSelectorWithCapitalizedKeyPattern(const char *prefix, NSString *key, const char *suffix) {
