...
/// Defines how a BDMTLModel property key should be encoded into an archive.
///
/// BDMTLModelEncodingBehaviorExcluded      - The property should never be encoded.
/// BDMTLModelEncodingBehaviorUnconditional - The property should always be
///                                         encoded.
/// BDMTLModelEncodingBehaviorConditional   - The object should be encoded only
///                                         if unconditionally encoded elsewhere.
///                                         This should only be used for object
///                                         properties.
typedef enum : NSUInteger {
    BDMTLModelEncodingBehaviorExcluded = 0,
    BDMTLModelEncodingBehaviorUnconditional,
    BDMTLModelEncodingBehaviorConditional,
} BDMTLModelEncodingBehavior;

/// Implements default archiving and unarchiving behaviors for BDMTLModel.
@interface BDMTLModel (NSCoding) <NSCoding>
...
/// The values of this dictionary should be boxed BDMTLModelEncodingBehavior
/// values.
///
...
/// behavior is BDMTLModelEncodingBehaviorConditional; otherwise, the default is
/// BDMTLModelEncodingBehaviorUnconditional.
...
/// The version of this BDMTLModel subclass.
///
...
/// of BDMantle (before the `BDMTLModel+NSCoding` interface existed).
@interface BDMTLModel (OldArchiveSupport)
