...
/// selector.
SEL BDMTLSelectorWithKeyPattern(NSString *key, const char *suffix) __attribute__((pure, nonnull(1, 2)));
...
/// Returns a selector, or NULL if the input strings cannot form a valid
/// selector.
SEL BDMTLSelectorWithCapitalizedKeyPattern(const char *prefix, NSString *key, const char *suffix) __attribute__((pure, nonnull(1, 2, 3)));
