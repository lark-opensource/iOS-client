...
int av_check_hijack_exit(const char *url);

void av_check_hijack_init(AVFormatContext *s, const char *check_info, int hijack_exit);

int av_check_hijack(AVFormatContext *s);

int av_check_hijack_vid(AVFormatContext *s, AVCheckInfoItem *item);

int av_check_hijack_media_type(AVFormatContext *s, AVCheckInfoItem *item);
