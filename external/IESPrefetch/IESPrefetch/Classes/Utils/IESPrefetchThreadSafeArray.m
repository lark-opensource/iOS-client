...
@interface IESPrefetchThreadSafeArray ()
{
    NSMutableArray *_arr;
...
@implementation IESPrefetchThreadSafeArray
...
+ (void)initialize {
    if (self == [IESPrefetchThreadSafeArray class]) {
...
- (BOOL)isEqualToArray:(NSArray *)otherArray {
    ...
    if ([otherArray isKindOfClass:IESPrefetchThreadSafeArray.class]) {
        IESPrefetchThreadSafeArray *other = (id)otherArray;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:IESPrefetchThreadSafeArray.class]) {
        IESPrefetchThreadSafeArray *other = object;
        BOOL isEqual;
        pthread_mutex_lock(&globalLock);
        pthread_mutex_lock(&_lock);
        pthread_mutex_lock(&(other->_lock));
