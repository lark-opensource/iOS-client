//
//  IESPrefetchThreadSafeDictionary.m
//  IESPrefetch
//
...
@interface IESPrefetchThreadSafeDictionary ()
{
...
@implementation IESPrefetchThreadSafeDictionary
static pthread_mutex_t globalLock;

+ (void)initialize {
    if (self == [IESPrefetchThreadSafeDictionary class]) {
...
- (BOOL)isEqualToDictionary:(NSDictionary *)otherDictionary {
    ...
    if ([otherDictionary isKindOfClass:IESPrefetchThreadSafeDictionary.class]) {
        IESPrefetchThreadSafeDictionary *other = (id)otherDictionary;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:IESPrefetchThreadSafeDictionary.class]) {
        IESPrefetchThreadSafeDictionary *other = object;
        BOOL isEqual;
        pthread_mutex_lock(&globalLock);
        pthread_mutex_lock(&_lock);
        pthread_mutex_lock(&(other->_lock));
