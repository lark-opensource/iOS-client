...
#ifndef LYNX_SHELL_RENDERKIT_BRIDGE_NATIVE_MODULE_IMPL_H_
#define LYNX_SHELL_RENDERKIT_BRIDGE_NATIVE_MODULE_IMPL_H_
...
class BridgeNativeModuleImpl {
 public:
  explicit BridgeNativeModuleImpl(const std::string& name)
  ...
  bool RegisterMethod(const std::string& name, NativeModuleX::Method method) {
    return module_->RegisterMethod(name, std::move(method));
  }
...
#endif  // LYNX_SHELL_RENDERKIT_BRIDGE_NATIVE_MODULE_IMPL_H_
