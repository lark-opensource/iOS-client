...
#ifndef LYNX_JSBRIDGE_JSCACHE_META_DATA_H_
#define LYNX_JSBRIDGE_JSCACHE_META_DATA_H_
...
/**
 * Metadata of all js and cache files.
 * Will be saved to and loaded from storage as a json string.
 *
 * Json String Example:
 * {
 *   "lynx": {
 ...
 *   "cache_files": {
 *     "lynx_core": {
 *       "md5": "c2e9f2302d24488f8e11e713e6bdf590",
 *       "cache_size": "35721235"
 *     },
 *     "packaged": {
 *       "https://xxx.bytegecko.com/xxx/template.js": {
 *         "/app-service.js": {
 *           "md5": "7c0b91c033150b3bfd77397f12933be9",
 *           "last_accessed": "1644463739",
 *           "cache_size": "35721235"
 *         }
 *       }
 *     },
 *     "dynamic": {
 *       "https://xxx/utils.js": {
 *         "md5": "68e1e382fe0cde436fa7f42566d3b0d6",
 *         "last_accessed": "1644463739",
 *         "cache_size": "35721235"
 *       }
 *     }
 ...
 * }
 *
 * For more details See issue #6051.
 */
class MetaData {
 public:
  // category
  ...
  std::vector<CacheFileInfo> GetExpiredCacheFileInfo(
      int64_t expired_time_seconds) const;
  void ForEachUserCacheFileInfo(
      base::MoveOnlyClosure<void, const CacheFileInfo &> callback) const;
...
#endif  // LYNX_JSBRIDGE_JSCACHE_META_DATA_H_
