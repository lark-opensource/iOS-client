...
#ifndef LYNX_JSBRIDGE_V8_V8_RUNTIME_H_
#define LYNX_JSBRIDGE_V8_V8_RUNTIME_H_
...
class V8Runtime : public Runtime {
 public:
  ...
  void SetDebugViewId(int view_id);
 ...
 protected:
  ...
  virtual std::shared_ptr<piper::HostObject> getHostObject(
...
#endif  // LYNX_JSBRIDGE_V8_V8_RUNTIME_H_
