 ...
 */
#ifndef LYNX_JSBRIDGE_BINDINGS_BIG_INT_BIG_INTEGER_H_
#define LYNX_JSBRIDGE_BINDINGS_BIG_INT_BIG_INTEGER_H_
...
#endif  // LYNX_JSBRIDGE_BINDINGS_BIG_INT_BIG_INTEGER_H_
