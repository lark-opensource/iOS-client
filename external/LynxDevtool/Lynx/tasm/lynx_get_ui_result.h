...
#ifndef LYNX_TASM_LYNX_GET_UI_RESULT_H_
#define LYNX_TASM_LYNX_GET_UI_RESULT_H_
...
class LynxGetUIResult {
 public:
  ...
  lepus::Value StatusAsLepusValue() const {
    ...
    result_dict->SetValue("code", lepus::Value(ErrCode()));
    result_dict->SetValue("data", lepus::Value(ErrMsg().c_str()));
  ...
  std::string ErrMsg() const { return err_msg_; }
...
#endif  // LYNX_TASM_LYNX_GET_UI_RESULT_H_
