...
#ifndef LYNX_ANIMATION_TIMING_FUNCTION_H_
#define LYNX_ANIMATION_TIMING_FUNCTION_H_
#include <memory>

#include "animation/util/cubic_bezier.h"
...
#endif  // LYNX_ANIMATION_TIMING_FUNCTION_H_
