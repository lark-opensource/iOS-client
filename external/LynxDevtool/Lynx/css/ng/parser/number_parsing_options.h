...
#ifndef LYNX_CSS_NG_PARSER_NUMBER_PARSING_OPTIONS_H_
#define LYNX_CSS_NG_PARSER_NUMBER_PARSING_OPTIONS_H_
...
#endif  // LYNX_CSS_NG_PARSER_NUMBER_PARSING_OPTIONS_H_
