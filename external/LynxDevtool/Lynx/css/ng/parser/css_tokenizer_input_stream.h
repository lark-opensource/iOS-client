...
#ifndef LYNX_CSS_NG_PARSER_CSS_TOKENIZER_INPUT_STREAM_H_
#define LYNX_CSS_NG_PARSER_CSS_TOKENIZER_INPUT_STREAM_H_
...
#endif  // LYNX_CSS_NG_PARSER_CSS_TOKENIZER_INPUT_STREAM_H_
