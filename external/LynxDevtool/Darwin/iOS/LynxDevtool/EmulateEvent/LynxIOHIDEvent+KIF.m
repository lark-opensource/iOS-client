...
enum {
  ...
  kIOHIDEventTypeDockSwipe,  // just like kIOHIDEventTypeNavigationSwipe, but intended for
                             // consumption by Dock
...
IOHIDEventRef IOHIDEventCreateDigitizerEvent(CFAllocatorRef allocator, AbsoluteTime timeStamp,
                                             ...
                                             IOHIDFloat barrelPressure, Boolean range,
...
IOHIDEventRef kif_IOHIDEventWithTouches(NSArray *touches) {
  ...
  IOHIDEventRef handEvent =
      IOHIDEventCreateDigitizerEvent(kCFAllocatorDefault,                // allocator
                                     timeStamp,                          // timestamp
