...
- (void)onMessage:(NSString *)message {
  ...
  [context_ sendGlobalEvent:eventName_ withParams:args];
}
...
- (instancetype)initWithLynxContext:(LynxContext *)context {
  ...
  if (self) {
    ...
    if (owner != nil && [owner conformsToProtocol:@protocol(LynxBaseInspectorOwnerNG)]) {
      DevtoolWebSocketMessageHandler *remoteCallHandler =
      ...
      [(id<LynxBaseInspectorOwnerNG>)owner subscribeMessage:@"RemoteCall"
                                                withHandler:remoteCallHandler];
      DevtoolWebSocketMessageHandler *reactCallHandler =
...
- (void)onMessage:(NSString *)message {
  ...
  NSMutableArray *args = [[NSMutableArray alloc] init];
  [args addObject:message];
  [context_ sendGlobalEvent:@"onRemoteCallMessage" withParams:args];
}

- (nullable id<LynxBaseInspectorOwner>)getInspectorOwner {
  id<LynxBaseInspectorOwner> owner = nil;
  LynxView *_lynxView = [context_ getLynxView];
  if (_lynxView != nil) {
