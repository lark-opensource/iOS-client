...
V8Debugger::V8Debugger(v8::Isolate* isolate, V8InspectorImpl* inspector)
    : m_isolate(isolate),
      ...
      m_defalutMaxAsyncCallStackDepth(0),
      m_pauseOnExceptionsState(v8::debug::NoBreakOnException),
      m_wasmTranslation(isolate) {}

void V8Debugger::setAsyncCallStackDepth(int depth) {
  m_maxAsyncCallStackDepth = m_defalutMaxAsyncCallStackDepth = depth;
}
...
void V8Debugger::resetAsyncCallStackDepth(V8DebuggerAgentImpl* agent) {
  setAsyncCallStackDepth(agent, m_defalutMaxAsyncCallStackDepth);
}
