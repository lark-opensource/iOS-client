...
constexpr int kStackSizeArm = 814;
constexpr int kStackSize = 934;
#elif defined(OS_IOS)
// Slightly less than 512K, since Windows' default stack size for
// the ios execution thread is 512K for both 32 and 64-bit in lynx.
constexpr int kStackSizeArm = 352;
constexpr int kStackSize = 472;
#else
// Set stack limit lower for ARM than for other architectures because
// stack allocating MacroAssembler takes 120K bytes.
// See issue crbug.com/405338
constexpr int kStackSizeArm = 864;
// Slightly less than 1MB, since Windows' default stack size for
// the main execution thread is 1MB for both 32 and 64-bit.
constexpr int kStackSize = 984;
#endif

#ifdef V8_TARGET_ARCH_ARM
#define V8_DEFAULT_STACK_SIZE_KB kStackSizeArm
#else
#define V8_DEFAULT_STACK_SIZE_KB kStackSize
#endif
