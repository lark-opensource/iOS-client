...
class V8_EXPORT Isolate {
 public:
  ...
  struct CreateParams {
    // <Bytedance begin>
    CreateParams(v8::Platform* platform = nullptr)
    // <Bytedance end>
   ...
   */
  static Isolate* Allocate(/*<Bytedance change>*/v8::Platform* platform = nullptr);
...
class V8_EXPORT V8 {
 public:
  ...
  // <Bytedance begin>
  /**
   * Detach the platform in multiple platform mode.
   */
  static void DeInitializePlatform(Platform* platform);
  // <Bytedance end>
