...
class EventName_Decoder : public ::lynx::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
  ...
  explicit EventName_Decoder(const ::lynx::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_iid() const { return at<1>().valid(); }
  uint64_t iid() const { return at<1>().as_uint64(); }
  bool has_name() const { return at<2>().valid(); }
  ::lynx::protozero::ConstChars name() const { return at<2>().as_string(); }
};

class EventName : public ::lynx::protozero::Message {
 public:
...
class EventCategory_Decoder : public ::lynx::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
  ...
  explicit EventCategory_Decoder(const ::lynx::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_iid() const { return at<1>().valid(); }
  uint64_t iid() const { return at<1>().as_uint64(); }
  bool has_name() const { return at<2>().valid(); }
  ::lynx::protozero::ConstChars name() const { return at<2>().as_string(); }
...
class EventCategory : public ::lynx::protozero::Message {
 public:
...
class TrackEventDefaults_Decoder : public ::lynx::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/45, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  ...
  explicit TrackEventDefaults_Decoder(const ::lynx::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  ...
  ::lynx::protozero::RepeatedFieldIterator<uint64_t> extra_counter_track_uuids() const { return GetRepeated<uint64_t>(31); }
  bool has_extra_double_counter_track_uuids() const { return at<45>().valid(); }
  ::lynx::protozero::RepeatedFieldIterator<uint64_t> extra_double_counter_track_uuids() const { return GetRepeated<uint64_t>(45); }
};

class TrackEventDefaults : public ::lynx::protozero::Message {
 public:
...
class TrackEvent_Decoder : public ::lynx::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/46, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  ...
  explicit TrackEvent_Decoder(const ::lynx::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_category_iids() const { return at<3>().valid(); }
  ::lynx::protozero::RepeatedFieldIterator<uint64_t> category_iids() const { return GetRepeated<uint64_t>(3); }
  bool has_categories() const { return at<22>().valid(); }
  ::lynx::protozero::RepeatedFieldIterator<::lynx::protozero::ConstChars> categories() const { return GetRepeated<::lynx::protozero::ConstChars>(22); }
  ...
  ::lynx::protozero::ConstChars name() const { return at<23>().as_string(); }
  ...
  ::lynx::protozero::RepeatedFieldIterator<int64_t> extra_counter_values() const { return GetRepeated<int64_t>(12); }
  bool has_extra_double_counter_track_uuids() const { return at<45>().valid(); }
  ::lynx::protozero::RepeatedFieldIterator<uint64_t> extra_double_counter_track_uuids() const { return GetRepeated<uint64_t>(45); }
  bool has_extra_double_counter_values() const { return at<46>().valid(); }
  ::lynx::protozero::RepeatedFieldIterator<double> extra_double_counter_values() const { return GetRepeated<double>(46); }
  bool has_flow_ids() const { return at<36>().valid(); }
  ::lynx::protozero::RepeatedFieldIterator<uint64_t> flow_ids() const { return GetRepeated<uint64_t>(36); }
  bool has_terminating_flow_ids() const { return at<42>().valid(); }
  ::lynx::protozero::RepeatedFieldIterator<uint64_t> terminating_flow_ids() const { return GetRepeated<uint64_t>(42); }
  bool has_debug_annotations() const { return at<4>().valid(); }
  ::lynx::protozero::RepeatedFieldIterator<::lynx::protozero::ConstBytes> debug_annotations() const { return GetRepeated<::lynx::protozero::ConstBytes>(4); }
  bool has_task_execution() const { return at<5>().valid(); }
  ::lynx::protozero::ConstBytes task_execution() const { return at<5>().as_bytes(); }
  bool has_log_message() const { return at<21>().valid(); }
  ::lynx::protozero::ConstBytes log_message() const { return at<21>().as_bytes(); }
  bool has_cc_scheduler_state() const { return at<24>().valid(); }
  ::lynx::protozero::ConstBytes cc_scheduler_state() const { return at<24>().as_bytes(); }
  bool has_chrome_user_event() const { return at<25>().valid(); }
  ::lynx::protozero::ConstBytes chrome_user_event() const { return at<25>().as_bytes(); }
  bool has_chrome_keyed_service() const { return at<26>().valid(); }
  ::lynx::protozero::ConstBytes chrome_keyed_service() const { return at<26>().as_bytes(); }
  bool has_chrome_legacy_ipc() const { return at<27>().valid(); }
  ::lynx::protozero::ConstBytes chrome_legacy_ipc() const { return at<27>().as_bytes(); }
  bool has_chrome_histogram_sample() const { return at<28>().valid(); }
  ::lynx::protozero::ConstBytes chrome_histogram_sample() const { return at<28>().as_bytes(); }
  bool has_chrome_latency_info() const { return at<29>().valid(); }
  ::lynx::protozero::ConstBytes chrome_latency_info() const { return at<29>().as_bytes(); }
  bool has_chrome_frame_reporter() const { return at<32>().valid(); }
  ::lynx::protozero::ConstBytes chrome_frame_reporter() const { return at<32>().as_bytes(); }
  bool has_chrome_application_state_info() const { return at<39>().valid(); }
  ::lynx::protozero::ConstBytes chrome_application_state_info() const { return at<39>().as_bytes(); }
  bool has_chrome_renderer_scheduler_state() const { return at<40>().valid(); }
  ::lynx::protozero::ConstBytes chrome_renderer_scheduler_state() const { return at<40>().as_bytes(); }
  bool has_chrome_window_handle_event_info() const { return at<41>().valid(); }
  ::lynx::protozero::ConstBytes chrome_window_handle_event_info() const { return at<41>().as_bytes(); }
  bool has_chrome_content_settings_event_info() const { return at<43>().valid(); }
  ::lynx::protozero::ConstBytes chrome_content_settings_event_info() const { return at<43>().as_bytes(); }
  bool has_source_location() const { return at<33>().valid(); }
  ::lynx::protozero::ConstBytes source_location() const { return at<33>().as_bytes(); }
  ...
  ::lynx::protozero::ConstBytes chrome_message_pump() const { return at<35>().as_bytes(); }
  bool has_chrome_mojo_event_info() const { return at<38>().valid(); }
  ::lynx::protozero::ConstBytes chrome_mojo_event_info() const { return at<38>().as_bytes(); }
  ...
  ::lynx::protozero::ConstBytes legacy_event() const { return at<6>().as_bytes(); }
};

class TrackEvent : public ::lynx::protozero::Message {
 public:
  ...
  using LegacyEvent = ::lynx::perfetto::protos::pbzero::TrackEvent_LegacyEvent;
  using Type = ::lynx::perfetto::protos::pbzero::TrackEvent_Type;
  ...
  void set_type(::lynx::perfetto::protos::pbzero::TrackEvent_Type value) {
...
class TrackEvent_LegacyEvent_Decoder : public ::lynx::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/19, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
  ...
  explicit TrackEvent_LegacyEvent_Decoder(const ::lynx::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  ...
  ::lynx::protozero::ConstChars id_scope() const { return at<7>().as_string(); }
...
class TrackEvent_LegacyEvent : public ::lynx::protozero::Message {
 public:
  ...
  using FlowDirection = ::lynx::perfetto::protos::pbzero::TrackEvent_LegacyEvent_FlowDirection;
  using InstantEventScope = ::lynx::perfetto::protos::pbzero::TrackEvent_LegacyEvent_InstantEventScope;
  ...
  void set_flow_direction(::lynx::perfetto::protos::pbzero::TrackEvent_LegacyEvent_FlowDirection value) {
    AppendTinyVarInt(13, value);
  }
  void set_instant_event_scope(::lynx::perfetto::protos::pbzero::TrackEvent_LegacyEvent_InstantEventScope value) {
