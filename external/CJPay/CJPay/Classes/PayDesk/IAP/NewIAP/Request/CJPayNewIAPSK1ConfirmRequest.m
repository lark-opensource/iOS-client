//
//  CJPayNewIAPSK1ConfirmRequest.m
//  Pods
//
...
@implementation CJPayNewIAPSK1ConfirmRequest
...
+ (NSString *)p_buildServerUrl {
    return [NSString stringWithFormat:@"%@/%@",[self deskServerUrlString],@"cd-trade-sk1confirm"];
}
...
+ (NSDictionary *)buildWith:(NSDictionary *)extraBizParams bizContentParms: (NSDictionary *)params {
    ...
    [requestParams cj_setObject:@"tp.subscribe.IapNewConfirm" forKey:@"method"];
