...
@interface CJPayMethodTableViewCell()
...
@property (nonatomic, strong, readwrite) CJPayStyleCheckMark *confirmImageView;
@property (nonatomic, strong) UIView *seperateView;
@property (nonatomic, strong) UIView *disableView;

@property (nonatomic, strong) CJPayChannelBizModel *model;

//@property (nonatomic, strong) MASConstraint *titleLabelCenterBaseContentView;

@property (nonatomic, strong) MASConstraint *seperateViewLeftMarginConstraint;

@end

@implementation CJPayMethodTableViewCell
...
- (void)updateContent:(CJPayChannelBizModel *)model
{
    ...
    [self.confirmImageView setSelected:model.isConfirmed];
