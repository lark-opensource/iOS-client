...
//        CJPayLogInfo(@"Bad args digits(min 6, max 8): %lu secret: %@ algorithm: %@",
...
//
//  CJPayLogInfo(@"secret: %@", secret_);
//  CJPayLogInfo(@"counter: %llu", counter);
//  CJPayLogInfo(@"hash: %@", hash);
//  CJPayLogInfo(@"offset: %d", offset);
//  CJPayLogInfo(@"truncatedHash: %d", truncatedHash);
//  CJPayLogInfo(@"pinValue: %d", pinValue);
