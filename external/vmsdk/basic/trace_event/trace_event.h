#ifndef VMSDK_BASE_TRACE_EVENT_TRACE_EVENT_H_
#define VMSDK_BASE_TRACE_EVENT_TRACE_EVENT_H_
...
#if VMSDK_ENABLE_TRACING_BACKEND_NATIVE
#if OS_ANDROID
namespace vmsdk {
namespace general {
...
#define TRACE_EVENT0(category, name) \
  vmsdk::general::ScopedTracer INTERNAL_TRACE_EVENT_UID(tracer)(name);
...
#define TRACE_EVENT_BEGIN0(category, name) \
  if (vmsdk::general::ATrace_beginSection) \
    vmsdk::general::ATrace_beginSection(name);
...
#define TRACE_EVENT_END0(category, name) \
  if (vmsdk::general::ATrace_endSection) vmsdk::general::ATrace_endSection();
...
#define TRACE_EVENT_ASYNC_BEGIN0(category, name, id) \
  if (vmsdk::general::ATrace_beginAsyncSection)      \
    vmsdk::general::ATrace_beginAsyncSection(name, (int32_t)id);
...
#define TRACE_EVENT_ASYNC_END0(category, name, id) \
  if (vmsdk::general::ATrace_endAsyncSection)      \
    vmsdk::general::ATrace_endAsyncSection(name, (int32_t)id);
...
static std::unordered_map<std::string, uint32_t> ios_trace_map;
static Lock g_lock_ios_trace_map;
static constexpr uint32_t ios_trace_name = 1;
...
#define INNER_BEGIN_LOG(name, arg1, arg2, arg3, arg4)                       \
  if (__builtin_available(iOS 10.0, *)) {                                   \
    {                                                                       \
      vmsdk::general::AutoLock auto_lock(                                   \
          vmsdk::general::g_lock_ios_trace_map);                            \
      if (vmsdk::general::ios_trace_map.find(name) ==                       \
          vmsdk::general::ios_trace_map.end())                              \
        vmsdk::general::ios_trace_map[name] =                               \
            vmsdk::general::ios_trace_name++;                               \
    }                                                                       \
    kdebug_signpost_start(vmsdk::general::ios_trace_map[name], 0, 0, 0, 0); \
  }
...
#define INNER_END_LOG(name, arg1, arg2, arg3, arg4)                         \
  if (__builtin_available(iOS 10.0, *)) {                                   \
    if (vmsdk::general::ios_trace_map.find(name) !=                         \
        vmsdk::general::ios_trace_map.end())                                \
      kdebug_signpost_end(vmsdk::general::ios_trace_map[name], 0, 0, 0, 0); \
  }
...
#define INNER_BEGIN_LOG_WITH_ID(name, arg1, arg2, arg3, arg4)  \
  if (__builtin_available(iOS 10.0, *)) {                      \
    ...
    kdebug_signpost_start(vmsdk::general::ios_trace_map[name], \
                          (uintptr_t)arg1, 0, 0, 0);           \
  }
...
#define INNER_END_LOG_WITH_ID(name, arg1, arg2, arg3, arg4)    \
  if (__builtin_available(iOS 10.0, *)) {                      \
    if (vmsdk::general::ios_trace_map.find(name) !=            \
        vmsdk::general::ios_trace_map.end())                   \
      kdebug_signpost_end(vmsdk::general::ios_trace_map[name], \
                          (uintptr_t)arg1, 0, 0, 0);           \
  }
...
#define INNER_EVENT_EMIT_LOG(name, arg1, arg2, arg3, arg4)            \
  if (__builtin_available(iOS 10.0, *)) {                             \
    ...
    kdebug_signpost(vmsdk::general::ios_trace_map[name], 0, 0, 0, 0); \
  }

#define TRACE_EVENT0(category, name)                                          \
  {                                                                           \
    vmsdk::general::AutoLock auto_lock(vmsdk::general::g_lock_ios_trace_map); \
    if (vmsdk::general::ios_trace_map.find(name) ==                           \
        vmsdk::general::ios_trace_map.end())                                  \
      vmsdk::general::ios_trace_map[name] = vmsdk::general::ios_trace_name++; \
  }                                                                           \
  vmsdk::general::ScopedTracer INTERNAL_TRACE_EVENT_UID(tracer)(              \
      vmsdk::general::ios_trace_map[name], 0, 0, 0, 0);
#define TRACE_EVENT1(category, name, arg1_name, arg1_val) \
  TRACE_EVENT0(category, name)
#define TRACE_EVENT2(category, name, arg1_name, arg1_val, arg2_name, arg2_val) \
  TRACE_EVENT0(category, name)
...
#else   // VMSDK_ENABLE_TRACING_BACKEND_NATIVE
#include "basic/trace_event/trace_backend.h"

#define TRACE_EVENT_INTERNAL_CONCAT2(a, b) a##b
#define TRACE_EVENT_INTERNAL_CONCAT(a, b) TRACE_EVENT_INTERNAL_CONCAT2(a, b)
#define TRACE_EVENT_UID(prefix) TRACE_EVENT_INTERNAL_CONCAT(prefix, __LINE__)

#define INTERNAL_TRACE_EVENT_ADD(category, name, phase, ...)               \
  vmsdk::general::tracing::TraceBackend::TraceEvent(category, name, phase, \
                                                    ##__VA_ARGS__)
#define INTERNAL_TRACE_EVENT_ADD_WITH_ID(phase, category, name, id, ...)   \
  vmsdk::general::tracing::TraceBackend::TraceEvent(category, name, phase, \
                                                    ##__VA_ARGS__)

#define INTERNAL_SCOPED_TRACK_EVENT(category, name, ...)                      \
  struct TRACE_EVENT_UID(ScopedEvent) {                                       \
...
using TraceEvent = vmsdk::general::tracing::TraceBackend::EventType;
#define TRACE_EVENT(category, name, ...) \
  INTERNAL_SCOPED_TRACK_EVENT(category, name, ##__VA_ARGS__)
#define TRACE_EVENT_BEGIN(category, name, ...)                      \
  INTERNAL_TRACE_EVENT_ADD(category, name, TRACE_EVENT_PHASE_BEGIN, \
                           ##__VA_ARGS__)
#define TRACE_EVENT_END(category, ...)                                        \
  INTERNAL_TRACE_EVENT_ADD(category, /*name=*/nullptr, TRACE_EVENT_PHASE_END, \
                           ##__VA_ARGS__)
#define TRACE_EVENT_INSTANT(category, name, ...)                      \
  INTERNAL_TRACE_EVENT_ADD(category, name, TRACE_EVENT_PHASE_INSTANT, \
                           ##__VA_ARGS__)
#define TRACE_EVENT_CATEGORY_ENABLED(category) \
  vmsdk::general::tracing::TraceBackend::CategoryEnabled(category)
...
#define TRACE_EVENT_BEGIN1(category, name, arg1_name, arg1_val)                \
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_BEGIN, category, name, arg1_name, \
                           arg1_val)
#define TRACE_EVENT_BEGIN2(category, name, arg1_name, arg1_val, arg2_name,     \
                           arg2_val)                                           \
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_BEGIN, category, name, arg1_name, \
...
#define TRACE_EVENT_END1(category, name, arg1_name, arg1_val)                \
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_END, category, name, arg1_name, \
                           arg1_val)
#define TRACE_EVENT_END2(category, name, arg1_name, arg1_val, arg2_name,     \
                         arg2_val)                                           \
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_END, category, name, arg1_name, \
...
#define TRACE_EVENT_ASYNC_BEGIN1(category, name, id, arg1_name, arg1_val)  \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_NESTABLE_ASYNC_BEGIN, \
                                   category, name, id, arg1_name, arg1_val)
#define TRACE_EVENT_ASYNC_BEGIN2(category, name, id, arg1_name, arg1_val,   \
                                 arg2_name, arg2_val)                       \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_NESTABLE_ASYNC_BEGIN,  \
                                   category, name, id, arg1_name, arg1_val, \
...
#define TRACE_EVENT_FLOW_END1(category, name, id, arg1_name, arg1_val)         \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_FLOW_END, category, name, \
                                   id, arg1_name, arg1_val)
#define TRACE_EVENT_FLOW_END2(category, name, id, arg1_name, arg1_val,         \
                              arg2_name, arg2_val)                             \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_FLOW_END, category, name, \
                                   id, arg1_name, arg1_val, arg2_name,         \
                                   arg2_val)
...
#define TRACE_EVENT_CLOCK_SYNC_RECEIVER(sync_id)                       \
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_CLOCK_SYNC, "clock_sync", \
                           "__metadata", "sync_id", sync_id)
#endif  // VMSDK_ENABLE_TRACING_BACKEND_NATIVE
#else   // VMSDK_ENABLE_TRACING
...
#define TRACE_EVENT_CLOCK_SYNC_RECEIVER(sync_id)
#endif  // VMSDK_ENABLE_TRACING
#endif  // VMSDK_BASE_TRACE_EVENT_TRACE_EVENT_H_
