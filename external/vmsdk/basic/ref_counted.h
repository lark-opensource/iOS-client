...
class RefCountedThreadSafeBase {
 ...
 private:
  template <typename U>
  friend scoped_refptr<U> general::AdoptRef(U *);
  ...
  RefCountedThreadSafeBase &operator=(const RefCountedThreadSafeBase &) =
      delete;
};
...
namespace std {
template <class T>
struct hash<vmsdk::general::scoped_refptr<T>> {
  std::size_t operator()(const vmsdk::general::scoped_refptr<T> &k) const {
