 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `BDModelCustom` protocol for custom methods.
 */
 ...
 */
+ (nullable instancetype)bd_modelWithJSON:(id)json options:(BDModelMappingOptions)options;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)bd_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)bd_modelToJSONObject;
 ...
 */
- (nullable NSData *)bd_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)bd_modelToJSONString;
 ...
 */
+ (nullable NSArray *)bd_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (BDModel)
 ...
 */
+ (nullable NSDictionary *)bd_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<BDModelCustom>' to your class header.
 */
...
+ (BDModelMappingOptions)modelCustomMappingOptions;
