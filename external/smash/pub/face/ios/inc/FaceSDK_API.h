...
#define TT_MOBILE_FACE_240_DETECT_FASTMODE \
...
typedef struct AIFaceInfo {
  ...
  AIFaceInfoExtra
      extra_infos[AI_MAX_FACE_NUM];  // 眼睛，眉毛，嘴唇、虹膜关键点等额外的信息
 ...
 */
AILAB_EXPORT
int FS_CreateHandler(unsigned long long config,
 ...
 **/
AILAB_EXPORT
int FS_CreateHandlerFromBuf(unsigned long long config,
...
int FS_AddExtraModel(
    FaceHandle handle,
    unsigned long long
        config,  // 配置config，创建240或者280
                 // Config-240，TT_MOBILE_FACE_240_DETECT
                 // Config-280，TT_MOBILE_FACE_280_DETECT
                 // Config-240 快速模式, TT_MOBILE_FACE_240_DETECT |
                 // TT_MOBILE_FACE_240_DETECT_FASTMODE Config-280 快速模式,
                 // TT_MOBILE_FACE_280_DETECT |
 ...
 */
AILAB_EXPORT
int FS_AddExtraModelFromBuf(FaceHandle handle,
                            unsigned long long config,
                            const char *param_buf,
                            unsigned int param_buf_len);

AILAB_EXPORT
int FS_AddExtraFastModel(FaceHandle handle,
                         const char *param_path);

AILAB_EXPORT
int FS_AddExtraFastModelFromBuf(FaceHandle handle,
                            const char *param_buf,
                                unsigned int param_buf_len);
...
*/
AILAB_EXPORT
int FS_GetMouthMaskResult(FaceHandle handle,
...
*/
AILAB_EXPORT
int FS_GetTeenMaskResult(FaceHandle handle,
                          unsigned long long det_cfg,
...
*/
AILAB_EXPORT
int FS_GetFaceMaskResult(FaceHandle handle,
                          unsigned long long det_cfg,
...
// 设置检测参数
AILAB_EXPORT int FS_SetParam(FaceHandle handle,
 ...
 *
 */
AILAB_EXPORT int FS_GetRuntimeInfo(FaceHandle handle, ModuleRunTimeInfo * result);
