...
- (void)containsDataForKey:(nonnull NSString *)key
                 withBlock:(nullable void(^)(NSString * _Nonnull key, BOOL contains))block;
...
- (void)dataForKey:(nonnull NSString *)key
         withBlock:(nullable void(^)(NSString * _Nonnull key, NSData * _Nullable data))block;
 ...
 */
- (void)removeDataForKey:(nonnull NSString *)key
               withBlock:(nullable void(^)(NSString * _Nonnull key))block;
