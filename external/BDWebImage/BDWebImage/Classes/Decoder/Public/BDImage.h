...
@property (nonatomic, strong) id<BDImageDecoder> decoder;
...
@property (nonatomic, assign, class) BOOL bd_IsHeicSerialPreDecode DEPRECATED_MSG_ATTRIBUTE("Unused interface, new version is deprecated");// heic 图片串行预解码 default:NO
