//
//  BDImageDecoderAVIFColorSpace.m
//  BDWebImage
//
...
CGColorSpaceRef BDAVIFCreateColorSpaceMono(avifColorPrimaries const colorPrimaries, avifTransferCharacteristics const transferCharacteristics) {
...
CGColorSpaceRef BDAVIFCreateColorSpaceRGB(avifColorPrimaries const colorPrimaries, avifTransferCharacteristics const transferCharacteristics) {
    if (@available(iOS 8.0, *)) {
        vImage_Error err;
...
void BDAVIFCalcColorSpaceMono(avifImage * avif, CGColorSpaceRef* ref, BOOL* shouldRelease) {
    ...
    if(colorPrimaries == AVIF_COLOR_PRIMARIES_BT709 &&
       transferCharacteristics == AVIF_TRANSFER_CHARACTERISTICS_SRGB) {
        ...
        static dispatch_once_t onceToken;
        dispatch_once(&onceToken, ^{
            sRGB = BDAVIFCreateColorSpaceMono(colorPrimaries, transferCharacteristics);
            if(sRGB == NULL) {
    ...
    if(colorPrimaries == AVIF_COLOR_PRIMARIES_BT709 &&
       transferCharacteristics == AVIF_TRANSFER_CHARACTERISTICS_BT709) {
        ...
        static dispatch_once_t onceToken;
        dispatch_once(&onceToken, ^{
            bt709 = BDAVIFCreateColorSpaceMono(colorPrimaries, transferCharacteristics);
            if(bt709 == NULL) {
    ...
    if(colorPrimaries == AVIF_COLOR_PRIMARIES_BT2020 &&
       (transferCharacteristics == AVIF_TRANSFER_CHARACTERISTICS_BT2020_10BIT ||
        ...
        static dispatch_once_t onceToken;
        dispatch_once(&onceToken, ^{
            bt2020 = BDAVIFCreateColorSpaceMono(colorPrimaries, transferCharacteristics);
            if(bt2020 == NULL) {
    ...
    if(colorPrimaries == AVIF_COLOR_PRIMARIES_SMPTE432 /* Display P3 */ &&
       transferCharacteristics == AVIF_TRANSFER_CHARACTERISTICS_SRGB) {
        ...
        static dispatch_once_t onceToken;
        dispatch_once(&onceToken, ^{
            p3 = BDAVIFCreateColorSpaceMono(colorPrimaries, transferCharacteristics);
            if(p3 == NULL) {
    ...
    *ref = BDAVIFCreateColorSpaceMono(colorPrimaries, transferCharacteristics);
    if(*ref != NULL) {
        *shouldRelease = TRUE;
    } else {
        *ref = defaultColorSpace;
...
void BDAVIFCalcColorSpaceRGB(avifImage * avif, CGColorSpaceRef* ref, BOOL* shouldRelease) {
    ...
    *ref = BDAVIFCreateColorSpaceRGB(colorPrimaries, transferCharacteristics);
    if(*ref != NULL) {
        *shouldRelease = TRUE;
    } else {
        *ref = defaultColorSpace;
