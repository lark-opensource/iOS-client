//
//  BDImageDecoderAVIFConversion.m
//  BDWebImage
//
...
static CGImageRef CreateImageFromBuffer(avifImage * avif, vImage_Buffer* result) {
    ...
    if(monochrome){
        BDAVIFCalcColorSpaceMono(avif, &colorSpace, &shouldReleaseColorSpace);
    }else{
        BDAVIFCalcColorSpaceRGB(avif, &colorSpace, &shouldReleaseColorSpace);
    }
...
CGImageRef BDCreateCGImageFromAVIF(avifImage * avif) {
