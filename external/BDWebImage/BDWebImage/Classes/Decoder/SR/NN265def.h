#ifndef _NN265_DEF_H_
#define  _NN265_DEF_H_


#define BUNREF_SKIP_NONE    0
#define BUNREF_SKIP_FILTER  1
#define BUNREF_SKIP_BOTTOM  2
#define BUNREF_SKIP_ALL     4
...
#define STX_ALIGN(x, a)		(((x)+(a)-1)&~((a)-1))
...
enum
{
	KS_OK = (0x00000000),          // Success codes
	KS_FAIL = (0x80000001),        //  Unspecified error
	KS_OUTOFMEMORY = (0x80000002), //  Ran out of memory
	KS_POINTER = (0x80000003),     //  Invalid pointer
	KS_NOTSUPPORTED = (0x80000004),//  NOT support feature encoutnered
	KS_AUTH_INVALID = (0x80000005), //  authentication invalid
	KS_SEARCHING_ACCESS_POINT = (0x00000001), // in process of searching first access point
	KS_REF_PIC_NOT_FOUND = (0x00000007), // reference picture not found, can be ignored
#if defined(EMSCRIPTEN)||defined(_TEST_FOR_EMSCRIPTEN)
	KS_NEED_MORE_DATA = (0x00000008), //need push more data
#endif
	KS_BITSTREAM_ERROR = (0x00000009), // detecting bitstream error, can be ignored
};
...
#ifdef WIN32
#	define _nn_dll_export   __declspec(dllexport)
#else // for GCC
#	define _nn_dll_export __attribute__ ((visibility("default")))
#endif
...
extern "C" {
	...
	//libNN265 version number string
	_nn_dll_export extern const char strLibNN265Version[];
