...
extern NSString *const BDAsyncUdpSocketException;
extern NSString *const BDAsyncUdpSocketErrorDomain;

extern NSString *const BDAsyncUdpSocketQueueName;
extern NSString *const BDAsyncUdpSocketThreadName;

typedef NS_ENUM(NSInteger, BDAsyncUdpSocketError) {
	BDAsyncUdpSocketNoError = 0,          // Never used
	BDAsyncUdpSocketBadConfigError,       // Invalid configuration
	BDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	BDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	BDAsyncUdpSocketClosedError,          // The socket was closed
	BDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
**/
- (void)udpSocket:(BDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(BDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(BDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(BDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(BDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(BDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * Example:
 * 
 * BDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^BDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^BDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface BDAsyncUdpSocket : NSObject

/**
 * BDAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, BDAsyncSocket will automatically create its own socket queue.
...
- (instancetype)initWithDelegate:(nullable id <BDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id <BDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

#pragma mark Configuration

- (nullable id <BDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id <BDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id <BDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id <BDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id <BDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id <BDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means BDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, BDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, BDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, BDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that BDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about BDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable BDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable BDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * BDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, BDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about BDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable BDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable BDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The BDAsyncUdpSocket instance may optionally be used again.
...
/**
 * BDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(BDAsyncSocket *)sock
 * {
 ...
 *     return socketQueue;
 * }
 * - (void)socket:(BDAsyncSocket *)sock didAcceptNewSocket:(BDAsyncSocket *)newSocket
 * {
 ...
 * 
 * Generally BDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
