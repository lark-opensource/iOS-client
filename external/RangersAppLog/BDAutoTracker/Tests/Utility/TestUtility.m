...
- (void)testDictionary {
    ...
    XCTAssertTrue([param ok_boolValueForKey:@"Test1"]);
    XCTAssertTrue([param ok_boolValueForKey:@"Test2"]);
    XCTAssertFalse([param ok_boolValueForKey:@"Test3"]);
    XCTAssertFalse([param ok_boolValueForKey:@"Test4"]);


    XCTAssertEqual([param ok_integerValueForKey:@"Test1"], 1);
    XCTAssertEqual([param ok_integerValueForKey:@"Test2"], 2);
    XCTAssertEqual([param applog_unsignedIntegerValueForKey:@"Test1"], 1);
    XCTAssertEqual([param applog_unsignedIntegerValueForKey:@"Test2"], 2);
    XCTAssertEqual([param ok_longlongValueForKey:@"Test1"], 1);
    XCTAssertEqual([param ok_longlongValueForKey:@"Test2"], 2);

    XCTAssertEqual([param ok_integerValueForKey:@"Test3"], 0);

    XCTAssertEqualObjects([param ok_stringValueForKey:@"Test1"],@"1");
    XCTAssertEqualObjects([param ok_stringValueForKey:@"Test2"],@"2");
    XCTAssertEqualObjects([param ok_stringValueForKey:@"Test3"],@"0");

    XCTAssertNil([param ok_arrayValueForKey:@"Test01"]);
    XCTAssertNil([param ok_dictionaryValueForKey:@"Test01"]);
}
