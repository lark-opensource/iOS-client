           ...
           processId:(nullable NSString *)processId
{
    ...
    if (aggregation && aggregation.aggregationType > MONITOR_AGGREGATION_TYPE_NONE) {
        ...
        if (processId.length > 0) {
            [groupValues addObject:processId];
        }
...
- (void)endProcess:(NSString *)procId
{
    [[BDAutoTrackMonitorStore sharedStore]  updateProcess:procId];
}
