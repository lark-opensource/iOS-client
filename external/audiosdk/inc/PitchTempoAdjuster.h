 ...
 * @mainpage mammon
 *
 * The Pitch_Tempo adjustment API is contained in the single class
 * mammon::PitchTempoAdjuster.
 */
...
namespace mammon {
    ...
    public:
        /**
         * Processing options for the timeadjuster.  The preferred
         ...
         *
         * 1. Flags prefixed \c OptionProcess determine how the timeadjuster
         * will be invoked.  These options may not be changed after
         * construction.
         *
         *   \li \c OptionProcessOffline - Run the adjuster in offline
         ...
         *
         *   \li \c OptionProcessRealTime - Run the adjuster in real-time
         *   mode.  In this mode only process() should be called, and the
         *   adjuster adjusts dynamically in response to the input audio.
         *
         ...
         * variable timestretching.  PitchTempoAdjuster always adjusts the
         * stretch profile to minimise stretching of busy broadband
         * transient sounds, but the degree to which it does so is
         * adjustable. These options may not be changed after construction.
         *
         ...
         * model of the adjuster. These options may not be changed after
         * construction.
         *
         *   \li \c OptionThreadingAuto - Permit the adjuster to
         *   determine its own threading model.  Usually this means using
         *   one processing thread per audio channel in offline mode if
         *   the adjuster is able to determine that more than one CPU is
         ...
         *   situation where \c OptionThreadingAuto would do so, except omitting
        ...
        enum Option {
            ...
            // NB: Options is int, so we must stop before 0x80000000
        };
        ...
        /**
         * Construct a time and pitch adjuster object to run at the given
         ...
         */
        PitchTempoAdjuster(size_t sampleRate, size_t channels, Options options = DefaultOptions,
                           float initialTimeRatio = 1.0f, float initialPitchScale = 1.0f);
        /**
         * Deconstructure of time and pitch adjuster object.
         */
        ~PitchTempoAdjuster();

        /**
         * Reset the adjuster's internal buffers. The adjuster should
        ...
        /**
         * Set the time ratio for the adjuster. This is the ratio of
         ...
         *
         * If the adjuster was constructed in Offline mode, the time
         ...
         *
         * If the adjuster was constructed in RealTime mode, the time
        ...
        /**
         * Set the pitch scaling ratio for the adjuster.  This is the
         ...
         * pow(2.0, S / 12.0).
         *
         * If the adjuster was constructed in Offline mode, the pitch
         ...
         * not be called after study() or process() has been called.
         *
         * If the adjuster was constructed in RealTime mode, the pitch
        ...
        /**
         * Return the processing latency of the adjuster.  This is the
        ...
        /**
         * Change an OptionWindow configuration setting. This may be
         * called at any time in any mode
         * Note that if running multi-threaded in Offline mode, the change
         * may not take effect immediately if processing is already under
         * way when this function is called.
         */
        void setWindowOption(Options options);
        /**
        ...
        /**
         * Tell the adjuster exactly how many input samples it will
         * receive.  This is only useful in Offline mode, when it allows
         * the adjuster to ensure that the number of output samples is
        ...
        /**
         * Tell the adjuster the maximum number of sample frames that you
         * will ever be passing in to a single process() call.  If you
         * don't call this, the adjuster will assume that you are calling
        ...
        /**
         * Ask the adjuster how many audio sample frames should be
        ...
        /**
         * Provide a block of "samples" sample frames for the adjuster to
        ...
        /**
         * Ask the adjuster how many audio sample frames of output data
         ...
         * adjuster is running in threaded mode it may just mean that not
        ...
        /**
         * Obtain some processed output data from the adjuster.  Up to
         ...
         *
         * This function is provided for diagnostic purpose and not for general use.
         */
        ...
        /**
         * Return the number of channels this adjuster was constructed
         * with.
         */
        size_t getChannelCount() const;

        /**
         * Force the adjuster to calculate a stretch profile.  Normally
