...
- (BOOL)performValidate:(CAValidateType)type saveResult:(NSMutableString * _Nullable)storage prefixBlank:(NSUInteger)prefixBlank increaseblank:(NSUInteger)increaseBlank {
    ...
    /* array */
        ...
        [(__kindof NSMutableArray *)self enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            if(![obj performValidate:type saveResult:storage prefixBlank:prefixBlank + increaseBlank increaseblank:increaseBlank]) {
                subValidate = NO;
            }
        }];
    ...
    /* dictionary */
        ...
        [(__kindof NSDictionary *)self enumerateKeysAndObjectsUsingBlock:^(id  _Nonnull key, id  _Nonnull obj, BOOL * _Nonnull stop) {
            ...
            __unused BOOL result = [obj performValidate:type saveResult:storage prefixBlank:prefixBlank + increaseBlank increaseblank:increaseBlank];
        }];
        return NO;
    }
        ...
        [(__kindof NSMutableDictionary *)self enumerateKeysAndObjectsUsingBlock:^(id  _Nonnull key, id  _Nonnull obj, BOOL * _Nonnull stop) {
            ...
            if(![(__kindof NSObject *)obj performValidate:type saveResult:storage prefixBlank:prefixBlank + increaseBlank * 2 increaseblank:increaseBlank]) {
                subValidate = NO;
            }
        }];
        return !validate_immutable && subValidate;
