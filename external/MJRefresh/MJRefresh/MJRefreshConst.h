...
#ifndef mj_dispatch_async_safe
#define mj_dispatch_async_safe(queue, block)\
...
#ifndef mj_dispatch_async_main_thread_safe
#define mj_dispatch_async_main_thread_safe(block) mj_dispatch_async_safe(dispatch_get_main_queue(), block)
#endif
