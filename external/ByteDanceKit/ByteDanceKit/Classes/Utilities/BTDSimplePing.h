...
typedef NS_ENUM(NSInteger, BTDSimplePingAddressStyle) {
    BTDSimplePingAddressStyleAny,          ///< Use the first IPv4 or IPv6 address found; the default.
    BTDSimplePingAddressStyleICMPv4,       ///< Use the first IPv4 address found.
    BTDSimplePingAddressStyleICMPv6        ///< Use the first IPv6 address found.
};
...
@property (nonatomic, weak, readwrite, nullable) id<BTDSimplePingDelegate> delegate;

/*! Controls the IP address version used by the object.
 *  \details You should set this value before starting the object.
 */

@property (nonatomic, assign, readwrite) BTDSimplePingAddressStyle addressStyle;
