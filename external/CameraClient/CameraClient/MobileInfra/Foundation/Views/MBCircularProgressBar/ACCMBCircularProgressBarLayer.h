//
//  ACCMBCircularProgressBarLayer.h
...
/**
 * The ACCMBCircularProgressBarLayer class is a CALayer subclass that represents the underlying layer
 * of ACCMBCircularProgressBarView.
 */
