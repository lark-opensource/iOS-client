...
@class ACCCustomWebImageConfig;
@protocol ACCCustomWebImageProtocol <NSObject>

+ (BOOL)enableCache;

+ (nullable NSString *)getCacheName;

+ (nullable ACCCustomWebImageConfig *)getWebImageConfig;

@end

@interface ACCCustomWebImageConfig : NSObject
...
@class ACCCoverImageCacheModel, BDImageCache;
@interface ACCCustomWebImageManager : NSObject
...
@interface ACCCoverImageCacheModel : NSObject

@property (nonatomic, strong, nullable) NSString * cacheImageURLString;
...
@interface ACCWebImageManagerTools : NSObject
