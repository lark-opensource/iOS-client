//
//  ACCIntelligentMovieTIMManager.m
...
@implementation ACCIntelligentMovieTIMManager
...
+ (void)momentBIMResultWithMomentInfo:(ACCMomentAIMomentModel *)momentInfo
    ...
    ACCIntelligentMovieDataProvider *dataProvider = [[ACCIntelligentMovieDataProvider alloc] init];
