//
//  ACCFavoriteMVTemplatesDataController.m
//  CameraClient
//
...
@interface ACCFavoriteMVTemplatesDataController ()
...
@implementation ACCFavoriteMVTemplatesDataController
...
- (void)refreshContentDataWithCompletion:(void (^)(NSError * _Nonnull, NSArray<id<ACCMVTemplateModelProtocol>> * _Nonnull, BOOL))completion
{
    ...
    [ACCMVTemplatesFetch() refreshMergedFavoriteMVTemplatesCompletion:^(NSError * _Nullable error,
...
- (void)loadMoreContentDataWithCompletion:(void (^)(NSError * _Nonnull, NSArray<id<ACCMVTemplateModelProtocol>> * _Nonnull, BOOL))completion
{
    ...
    [ACCMVTemplatesFetch() loadmoreMergedFavoriteMVTemplatesWithCursor:self.cursor
