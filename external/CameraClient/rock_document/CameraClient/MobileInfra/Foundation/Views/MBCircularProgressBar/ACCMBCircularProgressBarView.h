//
//  ACCMBCircularProgressBarView.h
...
IB_DESIGNABLE
/**
 * The ACCMBCircularProgressBarView class is a UIView subclass that draws a circular progress bar with configurable attributes.
