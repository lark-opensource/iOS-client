//
//  ACCMBCircularProgressBarView.m
...
@implementation ACCMBCircularProgressBarView
...
-(ACCMBCircularProgressBarLayer*)progressLayer{
    ACCMBCircularProgressBarLayer* layer = (ACCMBCircularProgressBarLayer*) self.layer;
    return layer;
}

+ (Class) layerClass
{
    return [ACCMBCircularProgressBarLayer class];
}
