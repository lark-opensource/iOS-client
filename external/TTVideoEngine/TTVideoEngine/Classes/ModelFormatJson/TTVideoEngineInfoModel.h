...
static const NSInteger VALUE_CODEC_HAS_BYTEVC1   = 204;
...
FOUNDATION_EXPORT NSString *kTTVideoEngineCodecByteVC1;
...
/// Add by huangqing.
/// This is a typo of fileId; DO NOT CHANGE
@property (nonatomic, nullable, copy) NSString *fieldId;
...
- (nullable TTVideoEngineURLInfo *)videoInfoForType:(TTVideoEngineResolutionType)type
                                          mediaType:(nullable NSString *)mediaType
                                     otherCondition:(nullable NSMutableDictionary *)searchCondition;
