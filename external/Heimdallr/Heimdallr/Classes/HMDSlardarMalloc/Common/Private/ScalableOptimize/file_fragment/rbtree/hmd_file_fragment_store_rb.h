...
bool
file_map_store_lookup_entry_rb(file_map_header_t mapHdr, uintptr_t address, file_map_entry_t *vm_entry, file_map_entry_t *vm_entry_prev, file_map_entry_t *vm_entry_next, rb_tree_type tree_type);
