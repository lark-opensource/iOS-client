...
/**
 Whether app is updated. The judgment standard is to compare the field difference between the last startup and this startup.
  1. App short version
  2. App bundle identifier
  3. App bundle version
  4. Heimdallr version
 
 @note:  If it is the first startup, return YES.
 */
- (BOOL)whetherAppIsUpdated;

@property (nonatomic, strong, readonly) NSString *lastStartupShortVersion;
@property (nonatomic, strong, readonly) NSString *lastStartupBundleIdentifier;
@property (nonatomic, strong, readonly) NSString *lastStartupBuildVersion;
@property (nonatomic, strong, readonly) NSString *lastStartupSDKVersion;
