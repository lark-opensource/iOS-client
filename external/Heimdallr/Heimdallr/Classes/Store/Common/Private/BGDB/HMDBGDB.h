...
@property(nonatomic, copy, readonly, nonnull) NSString *rootPath;
/**
 获取单例函数.
 */
...
#pragma mark --> Here is the API to store an object directly
...
/**
 直接传入条件sql语句更新对象的某个属性.
 */
-(void)updateObject:(id _Nonnull)object propertyName:(NSString * _Nonnull)propertyName propertyValue:(id _Nonnull)propertyValue conditions:(NSString* _Nonnull)conditions complete:(hmdbg_complete_B)complete;
/**
直接传入条件sql语句更新对象的某个属性.  如果checkIvarChanged为YES，会去检查数据库字段是否有变化
*/
...
/**----------------------------------华丽分割线---------------------------------------------*/
#pragma mark --> The following API stores an object indirectly
...
/**
 ...
 @complete 回调的block
 */
-(void)createTableWithTableName:(NSString* _Nonnull)name keys:(NSArray<NSString*>* _Nonnull)keys unionPrimaryKeys:(NSArray* _Nullable)unionPrimaryKeys uniqueKeys:(NSArray* _Nullable)uniqueKeys complete:(hmdbg_complete_B)complete;
/**
 插入数据.
 @name 表名称.
 ...
 @complete 回调的block
 */
-(void)insertIntoTableName:(NSString* _Nonnull)name Dict:(NSDictionary* _Nonnull)dict complete:(hmdbg_complete_B)complete;
/**
 直接传入条件sql语句查询.
 @name 表名称.
 ...
 */
-(void)queryWithTableName:(NSString* _Nonnull)name keys:(NSArray<NSString*>* _Nullable)keys where:(NSArray* _Nullable)where complete:(hmdbg_complete_A)complete;
/**
 全部查询.
 @name 表名称.
 ...
 @complete 回调的block,返回的数组元素是字典 @[@{key:value},@{key:value}] .
 */
-(void)queryWithTableName:(NSString* _Nonnull)name where:(NSString* _Nullable)where complete:(hmdbg_complete_A)complete;
/**
 直接传入条件sql语句更新.
 */
...
/**
 ...
 @complete 回调的block.
 */
-(void)deleteWithTableName:(NSString* _Nonnull)name where:(NSArray* _Nonnull)where complete:(hmdbg_complete_B)complete;
/**
 直接传入条件sql语句删除.
 */
-(void)deleteWithTableName:(NSString* _Nonnull)name conditions:(NSString* _Nullable)conditions complete:(hmdbg_complete_B)complete;
/**
 根据keypath删除表内容.
 @name 表名称.
 @keyPathValues数组,形式@[@"user.student.name",Equal,@"小芳",@"user.student.conten",Contains,@"书"]
...
/**
 ...
 @complete 回调的block.
 */
-(void)clearTable:(NSString* _Nonnull)name complete:(hmdbg_complete_B)complete;
/**
 删除表.
 @name 表名称.
 @complete 回调的block.
 */
-(void)dropTable:(NSString* _Nonnull)name complete:(hmdbg_complete_B)complete;
/**
 删除表(线程安全).
 */
...
/**
 ...
 @complete 回调的block.
 */
-(void)addTable:(NSString* _Nonnull)name key:(NSString* _Nonnull)key complete:(hmdbg_complete_B)complete;
/**
 查询该表中有多少条数据
 @name 表名称.
...
#pragma mark Store arrays
/**
 直接存储数组.
 */
-(void)saveArray:(NSArray* _Nonnull)array name:(NSString* _Nonnull)name complete:(hmdbg_complete_B)complete;
/**
 读取数组.
 */
-(void)queryArrayWithName:(NSString* _Nonnull)name complete:(hmdbg_complete_A)complete;
/**
 读取数组某个元素.
 */
...
/**
 直接存储字典.
 */
-(void)saveDictionary:(NSDictionary* _Nonnull)dictionary complete:(hmdbg_complete_B)complete;
/**
 添加字典元素.
 */
...
// perfrom checkpoint to truncate wal-file
