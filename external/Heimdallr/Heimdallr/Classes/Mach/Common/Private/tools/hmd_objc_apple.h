...
#ifndef HDR_HMDObjCApple_h
#define HDR_HMDObjCApple_h
...
enum
{
    ...
    HMD_TAG_NSString          = 2,
    HMD_TAG_NSNumber          = 3,
    HMD_TAG_NSIndexPath       = 4,
    HMD_TAG_NSManagedObjectID = 5,
    HMD_TAG_NSDate            = 6,
    HMD_TAG_7                 = 7
};
...
typedef const struct CF_BRIDGED_TYPE(NSString) HMDString * HMDStringRef;
typedef struct CF_BRIDGED_MUTABLE_TYPE(NSMutableString) HMDString * HMDMutableStringRef;

// This is separate for C++
struct HMDNotInlineMutable {
    void *buffer;
    CFIndex length;
...
struct HMDString {
    ...
    union {    // In many cases the allocated structs are smaller than these
        ...
        struct HMDNotInlineMutable notInlineMutable;
    } variants;
};
 ...
 */
CF_INLINE Boolean HMDStrIsMutable(HMDStringRef str)                 {return (str->base._cfinfo[CF_INFO_BITS] & __kCFIsMutableMask) == __kCFIsMutable;}
CF_INLINE Boolean HMDStrIsInline(HMDStringRef str)                  {return (str->base._cfinfo[CF_INFO_BITS] & __kCFContentsMask) == __kCFHasInlineContents;}
CF_INLINE Boolean HMDStrFreeContentsWhenDone(HMDStringRef str)      {return (str->base._cfinfo[CF_INFO_BITS] & __kCFFreeContentsWhenDoneMask) == __kCFFreeContentsWhenDone;}
CF_INLINE Boolean HMDStrHasContentsDeallocator(HMDStringRef str)    {return (str->base._cfinfo[CF_INFO_BITS] & __kCFHasContentsDeallocatorMask) == __kCFHasContentsDeallocator;}
CF_INLINE Boolean HMDStrIsUnicode(HMDStringRef str)                 {return (str->base._cfinfo[CF_INFO_BITS] & __kCFIsUnicodeMask) == __kCFIsUnicode;}
CF_INLINE Boolean HMDStrIsEightBit(HMDStringRef str)                {return (str->base._cfinfo[CF_INFO_BITS] & __kCFIsUnicodeMask) != __kCFIsUnicode;}
CF_INLINE Boolean HMDStrHasNullByte(HMDStringRef str)               {return (str->base._cfinfo[CF_INFO_BITS] & __kCFHasNullByteMask) == __kCFHasNullByte;}
CF_INLINE Boolean HMDStrHasLengthByte(HMDStringRef str)             {return (str->base._cfinfo[CF_INFO_BITS] & __kCFHasLengthByteMask) == __kCFHasLengthByte;}
CF_INLINE Boolean HMDStrHasExplicitLength(HMDStringRef str)         {return (str->base._cfinfo[CF_INFO_BITS] & (__kCFIsMutableMask | __kCFHasLengthByteMask)) != __kCFHasLengthByte;}    // Has explicit length if (1) mutable or (2) not mutable and no length byte
CF_INLINE Boolean HMDStrIsConstant(HMDStringRef str) {
#if __LP64__
 ...
 */
CF_INLINE const void *HMDStrContents(HMDStringRef str) {
    if (HMDStrIsInline(str)) {
        return (const void *)(((uintptr_t)&(str->variants)) + (HMDStrHasExplicitLength(str) ? sizeof(CFIndex) : 0));
