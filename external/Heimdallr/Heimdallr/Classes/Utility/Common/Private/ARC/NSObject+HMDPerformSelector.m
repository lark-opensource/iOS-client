...
- (BOOL)hmd_checkExchangeConflictAndInvokeSelector:(SEL)aSelector withArguments:(nullable NSArray *)arguments
{
    return [self hmd_checkExchangeConflictAndInvokeSelector:aSelector withArguments:arguments result:NULL];
}

- (BOOL)hmd_checkExchangeConflictAndInvokeSelector:(SEL)aSelector withArguments:(nullable NSArray *)arguments result:(nullable void *)result
{
