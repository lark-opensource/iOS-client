...
FOUNDATION_EXTERN bool hmd_swizzle_instance_method_with_block(Class cls, SEL originalSelector, SEL swizzledSelector, id block);
FOUNDATION_EXTERN bool hmd_swizzle_class_method_with_block(Class cls, SEL originalSelector, SEL swizzledSelector, id block);
...
FOUNDATION_EXTERN BOOL hmd_insert_and_swizzle_instance_method_optimized;
