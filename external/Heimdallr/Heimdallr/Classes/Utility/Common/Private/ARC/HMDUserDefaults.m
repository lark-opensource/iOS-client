...
static NSString *const HMDUserDefaultsSuiteComponent = @"userdefaults";
...
- (instancetype)init {
    ...
    return [self initWithSuiteName:[HeimdallrUtilities customPlistSuiteComponent:HMDUserDefaultsSuiteComponent originalSuiteName:HMDUserDefaultsSuiteName]];
}
