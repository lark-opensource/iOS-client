#ifndef DEBUGROUTER_PROTOCOL_H_
#define DEBUGROUTER_PROTOCOL_H_
...
std::shared_ptr<RemoteDebugProtocolBody> CreateProtocolBody4Register(
    ...
    bool is_reconnect);
std::shared_ptr<RemoteDebugProtocolBody>
CreateProtocolBody4JoinRoom(RemoteDebugProtocolRoomId room_id);
std::shared_ptr<RemoteDebugProtocolBody>
CreateProtocolBody4Init(RemoteDebugPrococolClientId client_id);
std::shared_ptr<RemoteDebugProtocolBody>
CreateProtocolBody4RoomJoined(const char *room_id,
                              RemoteDebugPrococolClientId client_id);
std::shared_ptr<RemoteDebugProtocolBody> CreateProtocolBody4Registerd();
std::shared_ptr<RemoteDebugProtocolBody>
CreateProtocolBody4ChangeRoomServer(RemoteDebugPrococolClientId client_id,
                                    RemoteDebugProtocolRoomId room_id,
                                    const std::string &url);
std::shared_ptr<RemoteDebugProtocolBody>
CreateProtocolBody4ChangeRoomServerAck(RemoteDebugPrococolClientId client_id);
std::shared_ptr<RemoteDebugProtocolBody>
CreateProtocolBody4Custom(std::string type,
                          RemoteDebugPrococolClientId client_id,
...
std::shared_ptr<RemoteDebugProtocolBody>
CreateProtocolBody4Custom(const std::string &type, const std::string &open_type,
