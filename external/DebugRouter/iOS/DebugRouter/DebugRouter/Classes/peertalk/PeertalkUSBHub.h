...
FOUNDATION_EXPORT NSNotificationName const
    PeertalkUSBDeviceDidAttachNotification NS_SWIFT_NAME(deviceDidAttach);
...
//
FOUNDATION_EXPORT NSNotificationName const
    PeertalkUSBDeviceDidDetachNotification NS_SWIFT_NAME(deviceDidDetach);

typedef NSString *PeertalkUSBHubNotificationKey NS_TYPED_ENUM;
FOUNDATION_EXPORT PeertalkUSBHubNotificationKey const
    PeertalkUSBHubNotificationKeyDeviceID NS_SWIFT_NAME(deviceID);
FOUNDATION_EXPORT PeertalkUSBHubNotificationKey const
    PeertalkUSBHubNotificationKeyMessageType NS_SWIFT_NAME(messageType);
FOUNDATION_EXPORT PeertalkUSBHubNotificationKey const
    PeertalkUSBHubNotificationKeyProperties NS_SWIFT_NAME(properties);

// NSError domain
FOUNDATION_EXPORT NSString *const PeertalkUSBHubErrorDomain;

// Error codes returned with NSError.code for NSError domain PeertalkUSBHubErrorDomain
typedef enum {
  PeertalkUSBHubErrorBadDevice = 2,
  PeertalkUSBHubErrorConnectionRefused = 3,
} PeertalkUSBHubError;

@interface PeertalkUSBHub : NSObject
