...
// -----------------------------------------------------------------------------
/// Forked change:
/// Mark original Message+JSONAdditions funcs as internal, 
/// and make MessageLarkExt+JSONAdditions funcs as public for private usage:
///
/// Extensions to `MessageJSONLarkExt` to support JSON encoding/decoding.
///
// -----------------------------------------------------------------------------
...
public protocol MessageJSONLarkExt {}

/// JSON encoding and decoding methods for messages.
extension MessageJSONLarkExt where Self: Message {
