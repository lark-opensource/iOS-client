#ifndef MOBILECV2_UTILS_INSTR_HPP
#define MOBILECV2_UTILS_INSTR_HPP
...
{
public:
    NodeData(const char* funName = 0, const char* fileName = NULL, int lineNum = 0, void* retAddress = NULL, bool alwaysExpand = false, mobilecv2::instr::TYPE instrType = TYPE_GENERAL, mobilecv2::instr::IMPL implType = IMPL_PLAIN);
    NodeData(NodeData &ref);
    ~NodeData();
    NodeData& operator=(const NodeData&);

    mobilecv2::String          m_funName;
    mobilecv2::instr::TYPE     m_instrType;
    mobilecv2::instr::IMPL     m_implType;
    ...
    // No synchronization
    double getTotalMs()   const { return ((double)m_ticksTotal / mobilecv2::getTickFrequency()) * 1000; }
    double getMeanMs()    const { return (((double)m_ticksTotal/m_counter) / mobilecv2::getTickFrequency()) * 1000; }
};
