#ifndef MOBILECV2_FLANN_ANY_H_
#define MOBILECV2_FLANN_ANY_H_
/*
...
template<> inline void big_any_policy<mobilecv2::String>::print(std::ostream& out, void* const* src)
{
    out << (*reinterpret_cast<mobilecv2::String const*>(*src)).c_str();
}
