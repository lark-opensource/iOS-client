...
- (void)setBaseURL:(NSURL *)baseURL {
  _baseURL = baseURL;
  self.assetGroup.baseURL = baseURL;
}

- (void)setIgnoreBundleResource:(BOOL)ignoreBundleResource {
  _ignoreBundleResource = ignoreBundleResource;
  self.assetGroup.ignoreBundleResource = ignoreBundleResource;
}

- (void)setReferencedAnimationView:(LOTAnimationView *)referencedAnimationView
{
  _referencedAnimationView = referencedAnimationView;
  self.assetGroup.referencedAnimationView = referencedAnimationView;
}
