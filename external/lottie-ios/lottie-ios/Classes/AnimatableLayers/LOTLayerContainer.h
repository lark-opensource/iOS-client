...
typedef void(^LOTAsyncLoadingCallback)(NSError * _Nullable error);
...
@property (nonatomic, assign) BOOL asyncLoadingResource;
@property (nonatomic, copy, nullable) LOTAsyncLoadingCallback asyncLoadingCallback;
