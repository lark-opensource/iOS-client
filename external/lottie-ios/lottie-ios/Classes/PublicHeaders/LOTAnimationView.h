...
/// Setting 0 will loop the animation forever.
/// Note this value will be used only if `loopAnimation` is YES.
@property (nonatomic, assign) NSUInteger repeatCount;

@property (nonatomic, weak, nullable) id<LOTAnimationDelegate> animationDelegate;
