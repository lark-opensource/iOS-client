...
EVENT_TYPE(TTQUIC_FEC_SOURCE_SYMBOL_SENT)
EVENT_TYPE(TTQUIC_FEC_SOURCE_SYMBOL_RECEIVED)
EVENT_TYPE(TTQUIC_FEC_REPAIR_SYMBOL_SENT)
EVENT_TYPE(TTQUIC_FEC_REPAIR_SYMBOL_RECEIVED)
EVENT_TYPE(TTQUIC_FEC_PACKET_REVIVED)
// #endif
