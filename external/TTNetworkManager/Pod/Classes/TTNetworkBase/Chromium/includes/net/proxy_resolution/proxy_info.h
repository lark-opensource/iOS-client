...
class NET_EXPORT ProxyInfo {
 ...
 public:
  bool is_ttnet_consumed() const { return is_ttnet_consumed_; }

  void set_ttnet_consumed(bool value) { is_ttnet_consumed_ = value; }

  bool is_ttnet_proxy_enabled() const { return is_ttnet_proxy_enabled_; }

  void set_ttnet_proxy_enabled(bool value) { is_ttnet_proxy_enabled_ = value; }

  void put_ttnet_proxy_auth(const std::string& key, const std::string& value) {
    ttnet_proxy_auth_[key] = value;
  }
 ...
 private:
  // Identify whether the proxy is available.
  bool is_ttnet_proxy_enabled_ = false;

  // Whether it is resolved from ttnet consumed proxy.
  bool is_ttnet_consumed_ = false;
