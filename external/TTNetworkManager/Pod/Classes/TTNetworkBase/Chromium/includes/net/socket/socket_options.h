...
// GetSocketBufferSize return the SO_RCVBUF or SO_SNDBUF option value for socket
// fd. On error return -1.
int32_t GetSocketBufferSizeOption(SocketDescriptor fd, bool send_buf);
#endif
