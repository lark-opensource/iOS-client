...
#if BUILDFLAG(TTNET_IMPLEMENT)
  void set_enable_ping_without_active_dynamic_streams(bool enable) {
    enable_ping_without_active_dynamic_streams_ = enable;
  }
 private:
  bool enable_ping_without_active_dynamic_streams_;
#endif
