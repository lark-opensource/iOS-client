...
class QUIC_EXPORT_PRIVATE QuicStream
 ...
 public:
  ...
  QuicFlowController* flow_controller() {
    return flow_controller_.has_value() ? &flow_controller_.value() : nullptr;
  }

  QuicFlowController* connection_flow_controller() {
    return connection_flow_controller_;
  }

  // QuicStreamSequencer::StreamInterface implementation.
  size_t throttle() const override;
#endif

 private:
  // Record connection error details and close source when QUIC failed.
