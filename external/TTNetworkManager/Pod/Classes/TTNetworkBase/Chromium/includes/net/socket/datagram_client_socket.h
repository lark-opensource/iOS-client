...
class NET_EXPORT_PRIVATE DatagramClientSocket : public DatagramSocket,
 ...
 public:
  ...
  virtual int MultipleRead(DatagramReadBuffers* read_buffers,
                           int buf_len,
                           CompletionOnceCallback callback) = 0;
#endif
  // Jira:TTNET2-20.
  virtual const quic::QuicWallTime& GetQuicWallTimestamp() = 0;
  virtual void SetBeforeConnect(bool enable_wall_timestamp,
                                bool enable_multi_network) {}
#endif
};
