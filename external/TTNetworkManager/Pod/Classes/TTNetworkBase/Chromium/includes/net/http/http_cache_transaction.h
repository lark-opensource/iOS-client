...
#if BUILDFLAG(TTNET_IMPLEMENT)
    SocketPoolInfo old_socket_pool_info;
    std::vector<int> old_error_for_reset_list;
    int old_retry_attempts = 0;
#endif
...
#if BUILDFLAG(TTNET_IMPLEMENT)
  bool has_set_response_;  // Flag to show if we have got the response info.
#endif
