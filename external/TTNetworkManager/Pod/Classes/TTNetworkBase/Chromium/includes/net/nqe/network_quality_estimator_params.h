...
class NET_EXPORT NetworkQualityEstimatorParams {
 public:
  ...
  void SetIgnoreConnectChangeForTesting(bool ignore) {
    ignore_connect_change_for_testing_ = ignore;
  }
  bool isIgnoreConnectChangeForTesting() const {
    return ignore_connect_change_for_testing_;
  }
#endif
  ...
  void SetIgnoreGatherEstimatesForConstruct(bool enabled) {
    ignore_gather_estimates_for_construct_ = enabled;
  }
  bool IsIgnoreGatherEstimatesForConstruct() const {
    return ignore_gather_estimates_for_construct_;
  }

 private:
  bool ignore_gather_estimates_for_construct_{false};
...
#if BUILDFLAG(TTNET_IMPLEMENT_UNITTEST)
  bool ignore_connect_change_for_testing_{false};
#endif
