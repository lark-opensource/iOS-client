...
class QUIC_EXPORT_PRIVATE QuicSpdyStream
 ...
 public:
  ...
  virtual bool FinishedReadingHeaders() const;
  QuicByteCount encoder_stream_sent_byte_count() const {
    return encoder_stream_sent_byte_count_;
  }
 private:
  QuicByteCount encoder_stream_sent_byte_count_ = 0;
