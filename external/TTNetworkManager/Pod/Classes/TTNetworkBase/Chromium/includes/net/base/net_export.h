...
#undef TTNET_IMPLEMENT_EXPORT
#if !defined(COMPONENT_BUILD) && defined(TTNET_IMPLEMENT_IOS)
#define TTNET_IMPLEMENT_EXPORT __attribute__((visibility("default")))
#else
#define TTNET_IMPLEMENT_EXPORT
#endif
