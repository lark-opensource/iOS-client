...
class SSLClientSocketImpl : public SSLClientSocket,
 ...
 public:
  ...
  bool CheckSSLSessionCacheExisted() override;
#endif
 ...
 public:
  ...
  const std::string& GetSSLHost() const;
 ...
 private:
  base::TimeTicks client_hello_start_time_;
  int64_t client_hello_to_server_hello_time_{0};
#endif
#endif
