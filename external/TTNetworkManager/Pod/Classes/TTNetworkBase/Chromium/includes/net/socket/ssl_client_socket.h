...
class NET_EXPORT SSLClientSocket : public SSLSocket {
 public:
  ...
  virtual bool CheckSSLSessionCacheExisted();
#endif
...
class NET_EXPORT SSLClientContext : public SSLConfigService::Observer,
 ...
 public:
  ...
  // Find the corresponding server in |ssl_client_auth_cache_| according to the
  // |server_host|. Returns a vector of HostPortPair for executing the
  // |ClearClientCertificate| function.
  std::vector<HostPortPair> FindServerForHost(
