...
class TTNET_IMPLEMENT_EXPORT NET_EXPORT URLFetcherResponseWriter {
 public:
...
#if BUILDFLAG(TTNET_IMPLEMENT)
  // True if we need to write file by append when downloading big file.
  // Default value is false.
  bool is_append_;
  // for 403 etc. response code on downloader
  std::unique_ptr<URLFetcherStringWriter> file_backup_string_writer_;
#endif
