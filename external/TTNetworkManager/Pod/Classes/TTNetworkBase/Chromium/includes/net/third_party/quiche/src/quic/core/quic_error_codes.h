...
enum QuicErrorCode {
  ...
  QUIC_TTNET_CLOSE_ACTIVELY = 171,

  QUIC_TTNET_UNEXPECTED_STREAM_ERROR = 172,

  QUIC_TTNET_UNEXPECTED_RESPONSE = 173,

  QUIC_TTNET_INVALID_RESPONSE_HEADERS = 174,

  QUIC_TTNET_STREAM_CLOSED_UNEXPECTED = 175,

  QUIC_TTNET_READ_TRAILING_HEADERS_ERROR = 176,

  QUIC_TTNET_CONNECT_FAILED = 177,

  QUIC_TTNET_NO_ACTIVE_SESSIONS = 178,

  QUIC_TTNET_NO_TARGET_SESSIONS = 179,

  QUIC_TTNET_NO_STREAM = 180,

  QUIC_TTNET_NO_SESSION_HANDLE = 181,
