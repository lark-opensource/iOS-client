...
class BASE_EXPORT TimeDelta {
 public:
  ...
  TTNET_IMPLEMENT_EXPORT double InMillisecondsF() const;
  TTNET_IMPLEMENT_EXPORT int64_t InMilliseconds() const;
...
// UTCExplode() and LocalExplode(). See method comments for further details.
  ...
  static TTNET_IMPLEMENT_EXPORT Time Now();
  ...
  TTNET_IMPLEMENT_EXPORT double ToDoubleT() const;
...
class BASE_EXPORT TimeTicks : public time_internal::TimeBase<TimeTicks> {
 public:
  ...
  // microsecond.
  static TTNET_IMPLEMENT_EXPORT TimeTicks Now();
