...
class TTNET_IMPLEMENT_EXPORT BASE_EXPORT FilePath {
 public:
#if defined(OS_WIN)
  ...
  static FilePath WideFilePathFromString(const std::string& storage_path);
  static std::string StringFromWideFilePath(const FilePath& file_path);

  void SetUTF8Flag(bool is_utf8);
  bool GetUTF8Flag() const;
