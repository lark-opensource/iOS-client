...
TTNET_IMPLEMENT_EXPORT BASE_EXPORT NSString* SysUTF8ToNSString(StringPiece utf8)
    WARN_UNUSED_RESULT;
...
TTNET_IMPLEMENT_EXPORT BASE_EXPORT std::string SysNSStringToUTF8(NSString* ref)
    WARN_UNUSED_RESULT;
