...
class TTNET_IMPLEMENT_EXPORT BASE_EXPORT BindStateBase
...
class TTNET_IMPLEMENT_EXPORT BASE_EXPORT CallbackBase {
 public:
...
class TTNET_IMPLEMENT_EXPORT BASE_EXPORT CallbackBaseCopyable
    : public CallbackBase {
 public:
