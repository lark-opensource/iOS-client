...
TTNET_IMPLEMENT_EXPORT BASE_EXPORT std::string JoinString(
    span<const std::string> parts,
    StringPiece separator);
TTNET_IMPLEMENT_EXPORT BASE_EXPORT string16
JoinString(span<const string16> parts, StringPiece16 separator);
TTNET_IMPLEMENT_EXPORT BASE_EXPORT std::string JoinString(
