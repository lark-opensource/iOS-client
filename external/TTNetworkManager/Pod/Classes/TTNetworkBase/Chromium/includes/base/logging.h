...
TTNET_IMPLEMENT_EXPORT BASE_EXPORT void SetMinLogLevel(int level);
...
TTNET_IMPLEMENT_EXPORT BASE_EXPORT int GetVlogLevelHelper(
...
#if !BUILDFLAG(TTNET_IMPLEMENT_DISABLE_FORCE_LOG_OUTPUT)
#define DLOG(severity) VLOG(1)
#define DPLOG(severity) VLOG(1)
#define DVLOG(verboselevel) VLOG(1)
#define DVPLOG(verboselevel) VLOG(1)
#else
...
// above.
class TTNET_IMPLEMENT_EXPORT BASE_EXPORT LogMessage {
 public:
