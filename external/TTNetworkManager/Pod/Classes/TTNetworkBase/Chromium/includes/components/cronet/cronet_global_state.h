...
TTNET_IMPLEMENT_EXPORT void EnsureInitialized();

#if BUILDFLAG(TTNET_IMPLEMENT)
TTNET_IMPLEMENT_EXPORT void SetAlogFunctionAddress(
    net::ALogWriteAdapter::tt_alogger_appender appender);
TTNET_IMPLEMENT_EXPORT std::vector<int64_t> GetOpaqueFuncAddress();
#endif
