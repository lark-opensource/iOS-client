...
#ifndef LYNX_TRANSFORMS_TRANSFORM_OPERATIONS_H_
#define LYNX_TRANSFORMS_TRANSFORM_OPERATIONS_H_
...
class TransformOperations {
 public:
  ...
  void AppendTranslate(float x_value, TransformOperation::LengthType x_type,
                       float y_value, TransformOperation::LengthType y_type,
                       float z_value, TransformOperation::LengthType z_type);
...
#endif  // LYNX_TRANSFORMS_TRANSFORM_OPERATIONS_H_
