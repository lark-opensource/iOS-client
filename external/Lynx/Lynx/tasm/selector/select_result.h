...
#ifndef LYNX_TASM_SELECTOR_SELECT_RESULT_H_
#define LYNX_TASM_SELECTOR_SELECT_RESULT_H_
...
struct NodeSelectResult {
  ...
  LynxGetUIResult PackageLynxGetUIResult() const {
    ...
    for (auto node : nodes) {
      ...
      // if nodes which have no element exists, report error
...
#endif  // LYNX_TASM_SELECTOR_SELECT_RESULT_H_
