...
static bool ToPositionType(std::string& str, int& result) {
...
static bool ToBoxSizingType(std::string& str, int& result) {
...
static bool ToDisplayType(std::string& str, int& result) {
...
static bool ToWhiteSpaceType(std::string& str, int& result) {
...
static bool ToTextAlignType(std::string& str, int& result) {
...
static bool ToTextOverflowType(std::string& str, int& result) {
...
static bool ToFontWeightType(std::string& str, int& result) {
...
static bool ToFlexDirectionType(std::string& str, int& result) {
...
static bool ToFlexWrapType(std::string& str, int& result) {
...
static bool ToAlignContentType(std::string& str, int& result) {
...
static bool ToJustifyContentType(std::string& str, int& result) {
...
static bool ToFontStyleType(std::string& str, int& result) {
...
static bool ToLinearOrientationType(std::string& str, int& result) {
...
static bool ToLinearGravityType(std::string& str, int& result) {
...
static bool ToLinearLayoutGravityType(std::string& str, int& result) {
...
static bool ToVisibilityType(std::string& str, int& result) {
...
static bool ToWordBreakType(std::string& str, int& result) {
...
static bool ToDirectionType(std::string& str, int& result) {
...
static bool ToRelativeCenterType(std::string& str, int& result) {
...
static bool ToLinearCrossGravityType(std::string& str, int& result) {
...
static bool ToFlexAlignType(CSSPropertyID key, std::string& str, int& result) {
...
static bool ToOverflowType(std::string& str, int& result) {
...
static bool ToJustifyType(CSSPropertyID key, std::string& str, int& result) {
...
static bool ToGridAutoFlowType(std::string& str, int& result) {
...
HANDLER_IMPL() {
  ...
  switch (key) {
    ...
    case kPropertyIDGridAutoFlow:
      ...
      break;
    default:
      if (!UnitHandler::CSSWarning(false, configs.enable_css_strict_mode,
                                   TYPE_UNSUPPORTED,
  ...
  if (!UnitHandler::CSSWarning(
          success, configs.enable_css_strict_mode, TYPE_UNSUPPORTED,
          CSSProperty::GetPropertyName(key).c_str(), str.c_str())) {
    return false;
  }
  output[key] = CSSValue(lepus::Value(result), CSSValuePattern::ENUM);
  return true;
}
