...
#ifndef LYNX_CSS_CSS_PROPERTY_H_
#define LYNX_CSS_CSS_PROPERTY_H_
...
using StyleMap = lynx::lynx_ordered_map<CSSPropertyID, tasm::CSSValue>;
using ParsedStyleMap =
    std::unordered_map<std::string, std::shared_ptr<StyleMap>>;
using CSSVariableMap = lynx::lynx_ordered_map<lepus::String, lepus::String>;
using RawStyleMap = lynx::lynx_ordered_map<CSSPropertyID, lepus::Value>;
using RawParsedStyleMap =
    lynx::lynx_ordered_map<CSSPropertyID, std::pair<lepus::Value, StyleMap>>;
...
class CSSProperty {
 public:
  BASE_EXPORT_FOR_DEVTOOL static CSSPropertyID GetPropertyID(
      const lepus::String& name);
  BASE_EXPORT_FOR_DEVTOOL static const lepus::String& GetPropertyName(
      CSSPropertyID id);

  static inline bool IsPropertyValid(const lepus::String& name) {
  ...
  static CSSPropertyID GetTimingOptionsPropertyID(const lepus::String& name);
 ...
 public:
  static const std::unordered_map<std::string, std::string>&
      ...
      GetComputeStyleMap();
  BASE_EXPORT_FOR_DEVTOOL static bool IsShorthand(CSSPropertyID id);
};
...
#endif  // LYNX_CSS_CSS_PROPERTY_H_
