...
#ifndef LYNX_BASE_SYS_BYTEORDER_H_
#define LYNX_BASE_SYS_BYTEORDER_H_
...
inline uintptr_t ByteSwapUintPtrT(uintptr_t x) {
  ...
  // because these conditionals are constexpr, the irrelevant branches will
...
#endif  // LYNX_BASE_SYS_BYTEORDER_H_
