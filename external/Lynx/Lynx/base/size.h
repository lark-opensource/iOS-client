 ...
 public:
  class Descriptor {
   public:
    ...
    static int GetMode(int descriptor) { return (descriptor & MODE_MASK); }

    static int GetSize(int descriptor) { return (descriptor & ~MODE_MASK); }
  ...
  inline bool IsEmpty() { return !width_ && !height_; }
