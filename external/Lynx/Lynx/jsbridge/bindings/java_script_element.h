...
#ifndef LYNX_JSBRIDGE_BINDINGS_JAVA_SCRIPT_ELEMENT_H_
#define LYNX_JSBRIDGE_BINDINGS_JAVA_SCRIPT_ELEMENT_H_
...
#endif  // LYNX_JSBRIDGE_BINDINGS_JAVA_SCRIPT_ELEMENT_H_
