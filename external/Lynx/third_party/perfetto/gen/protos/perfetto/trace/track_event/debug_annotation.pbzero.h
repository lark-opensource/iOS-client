...
class DebugAnnotationName_Decoder : public ::lynx::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
  ...
  explicit DebugAnnotationName_Decoder(const ::lynx::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
...
class DebugAnnotationName : public ::lynx::protozero::Message {
 public:
...
class DebugAnnotation_Decoder : public ::lynx::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/10, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
  ...
  explicit DebugAnnotation_Decoder(const ::lynx::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  ...
  ::lynx::protozero::ConstChars name() const { return at<10>().as_string(); }
  ...
  ::lynx::protozero::ConstChars string_value() const { return at<6>().as_string(); }
  ...
  ::lynx::protozero::ConstBytes nested_value() const { return at<8>().as_bytes(); }
  bool has_legacy_json_value() const { return at<9>().valid(); }
  ::lynx::protozero::ConstChars legacy_json_value() const { return at<9>().as_string(); }
};

class DebugAnnotation : public ::lynx::protozero::Message {
 public:
  ...
  using NestedValue = ::lynx::perfetto::protos::pbzero::DebugAnnotation_NestedValue;
...
class DebugAnnotation_NestedValue_Decoder : public ::lynx::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/8, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  ...
  explicit DebugAnnotation_NestedValue_Decoder(const ::lynx::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  ...
  ::lynx::protozero::RepeatedFieldIterator<::lynx::protozero::ConstChars> dict_keys() const { return GetRepeated<::lynx::protozero::ConstChars>(2); }
  bool has_dict_values() const { return at<3>().valid(); }
  ::lynx::protozero::RepeatedFieldIterator<::lynx::protozero::ConstBytes> dict_values() const { return GetRepeated<::lynx::protozero::ConstBytes>(3); }
  bool has_array_values() const { return at<4>().valid(); }
  ::lynx::protozero::RepeatedFieldIterator<::lynx::protozero::ConstBytes> array_values() const { return GetRepeated<::lynx::protozero::ConstBytes>(4); }
  ...
  ::lynx::protozero::ConstChars string_value() const { return at<8>().as_string(); }
};

class DebugAnnotation_NestedValue : public ::lynx::protozero::Message {
 public:
  ...
  using NestedType = ::lynx::perfetto::protos::pbzero::DebugAnnotation_NestedValue_NestedType;
  ...
  void set_nested_type(::lynx::perfetto::protos::pbzero::DebugAnnotation_NestedValue_NestedType value) {
