...
// * ::lynx::protozero::PackedVarInt
// * ::lynx::protozero::PackedFixedSizeInt</*element_type=*/ uint32_t>
...
//   ::lynx::protozero::HeapBuffered<::lynx::protozero::Message> msg;
//   ::lynx::protozero::PackedVarInt buf;
//   buf.Append(42);
//   buf.Append(-1);
