...
// clang-format off
#ifndef JSBRIDGE_BINDINGS_CANVAS_NAPI_REQUEST_PERMISSION_CALLBACK_H_
#define JSBRIDGE_BINDINGS_CANVAS_NAPI_REQUEST_PERMISSION_CALLBACK_H_
...
class NapiRequestPermissionCallback {
 public:
  NapiRequestPermissionCallback(Napi::Function callback);

  NapiRequestPermissionCallback(const NapiRequestPermissionCallback& cb) = delete;
...
#endif  // JSBRIDGE_BINDINGS_CANVAS_NAPI_REQUEST_PERMISSION_CALLBACK_H_
