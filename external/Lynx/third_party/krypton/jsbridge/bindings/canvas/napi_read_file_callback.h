...
// clang-format off
#ifndef JSBRIDGE_BINDINGS_CANVAS_NAPI_READ_FILE_CALLBACK_H_
#define JSBRIDGE_BINDINGS_CANVAS_NAPI_READ_FILE_CALLBACK_H_
...
class NapiReadFileCallback {
 public:
  NapiReadFileCallback(Napi::Function callback);

  NapiReadFileCallback(const NapiReadFileCallback& cb) = delete;
...
#endif  // JSBRIDGE_BINDINGS_CANVAS_NAPI_READ_FILE_CALLBACK_H_
