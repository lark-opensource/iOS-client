...
#ifndef ANIMAX_MODEL_SHAPE_REPEATER_MODEL_H_
#define ANIMAX_MODEL_SHAPE_REPEATER_MODEL_H_
...
class RepeaterModel : public ContentModel {
 public:
  ...
  std::unique_ptr<Content> ToContent(CompositionModel& composition,
    ...
    return std::make_unique<RepeaterContent>(layer, *this);
  }
...
#endif  // ANIMAX_MODEL_SHAPE_REPEATER_MODEL_H_
