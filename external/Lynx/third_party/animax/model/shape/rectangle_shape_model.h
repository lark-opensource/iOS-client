...
#ifndef ANIMAX_MODEL_SHAPE_RECTANGLE_SHAPE_MODEL_H_
#define ANIMAX_MODEL_SHAPE_RECTANGLE_SHAPE_MODEL_H_
...
class RectangleShapeModel : public ContentModel {
 public:
  ...
  std::unique_ptr<Content> ToContent(CompositionModel& composition,
    ...
    return std::make_unique<RectangleContent>(layer, *this);
  }
...
#endif  // ANIMAX_MODEL_SHAPE_RECTANGLE_SHAPE_MODEL_H_
