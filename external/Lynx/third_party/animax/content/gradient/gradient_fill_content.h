...
#ifndef ANIMAX_CONTENT_GRADIENT_GRADIENT_FILL_CONTENT_H_
#define ANIMAX_CONTENT_GRADIENT_GRADIENT_FILL_CONTENT_H_
...
class GradientFillContent : public AnimationListener,
 ...
 private:
  ...
  std::shared_ptr<BaseKeyframeAnimation<std::shared_ptr<ColorFilter>,
      ...
      color_filter_animation_ = nullptr;

  std::unique_ptr<GradientElement> gradient_element_;

  // TODO(aiyongbiao): value callback keyframe animation p1
...
#endif  // ANIMAX_CONTENT_GRADIENT_GRADIENT_FILL_CONTENT_H_
