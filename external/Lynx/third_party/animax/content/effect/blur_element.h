...
#ifndef ANIMAX_CONTENT_EFFECT_BLUR_ELEMENT_H_
#define ANIMAX_CONTENT_EFFECT_BLUR_ELEMENT_H_
...
class BlurElement : public AnimationListener {
 public:
 ...
 private:
  std::unique_ptr<BaseFloatKeyframeAnimation> blur_animation_;
...
#endif  // ANIMAX_CONTENT_EFFECT_BLUR_ELEMENT_H_
