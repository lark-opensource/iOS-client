...
/// This parameter is for gecko fetcher. If gecko local data exist, return the data and trigger lazy
/// sync. Otherwise, gecko fetcher will trigger normal sync. If waitGeckoUpdate = NO, gecko fetcher
/// will not wait for sync, thus fail If waitGeckoUpdate = YES, gecko fetcher will wait for sync and
...
/// CDN retry times, default value is 0
