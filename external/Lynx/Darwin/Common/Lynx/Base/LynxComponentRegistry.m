...
+ (BOOL)isSubClass:(Class)subclass ofClass:(Class)superClass {
  for (Class c = subclass.class; c; c = c.superclass) {
...
+ (void)registerUI:(Class)componentClass nameAs:(NSString*)name {
  ...
  if ([LynxComponentRegistry isSubClass:componentClass ofClass:LynxUI.class] &&
      methodPropSetter != nil) {
...
+ (void)registerNode:(Class)componentClass nameAs:(NSString*)name {
  ...
  Method methodPropSetter =
      class_getClassMethod(componentClass, NSSelectorFromString(LYNX_PROPS_SETTER_LOOK_UP));
  if ([LynxComponentRegistry isSubClass:componentClass ofClass:LynxShadowNode.class] &&
      methodPropSetter != nil) {
