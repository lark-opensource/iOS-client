...
static void LynxClassSwizzle(Class class, SEL originalSelector, SEL swizzledSelector) {
...
LYNX_LOAD_LAZY(LynxClassSwizzle(self.class, @selector(setContentOffset:),
                                @selector(fadingSetContentOffset:));
               LynxClassSwizzle(self.class, @selector(setContentSize:),
                                @selector(fadingSetContentSize:));)
