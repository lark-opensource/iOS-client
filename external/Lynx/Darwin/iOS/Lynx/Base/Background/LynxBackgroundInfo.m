...
- (instancetype)init {
  ...
  if (self) {
    ...
    _borderLeftStyle = _borderRightStyle = _borderTopStyle = _borderBottomStyle =
...
- (UIImage*)getBorderLayerImageWithSize:(CGSize)viewSize {
  ...
  LynxBorderStyles borderStyles = {_borderTopStyle, _borderLeftStyle, _borderBottomStyle,
                                   _borderRightStyle};
...
- (void)setBorderLeftStyle:(LynxBorderStyle)borderStyle {
  if (_borderLeftStyle != borderStyle) {
...
- (void)setBorderRightStyle:(LynxBorderStyle)borderStyle {
  if (_borderRightStyle != borderStyle) {
...
- (void)setBorderTopStyle:(LynxBorderStyle)borderStyle {
  if (_borderTopStyle != borderStyle) {
...
- (void)setBorderBottomStyle:(LynxBorderStyle)borderStyle {
  if (_borderBottomStyle != borderStyle) {
...
- (void)makeCssDefaultValueToFitW3c {
  _borderLeftStyle = _borderRightStyle = _borderTopStyle = _borderBottomStyle = LynxBorderStyleNone;
...
- (BOOL)updateBorderStyle:(LynxBorderPosition)position value:(LynxBorderStyle)style {
  switch (position) {
    case LynxBorderTop:
      if (_borderTopStyle != style) {
        _borderTopStyle = style;
        return YES;
      }
      break;
    case LynxBorderLeft:
      if (_borderLeftStyle != style) {
        _borderLeftStyle = style;
        return YES;
      }
      break;
    case LynxBorderBottom:
      if (_borderBottomStyle != style) {
        _borderBottomStyle = style;
        return YES;
      }
      break;
    case LynxBorderRight:
      if (_borderRightStyle != style) {
        _borderRightStyle = style;
        return YES;
      }
      break;
  }
...
- (BOOL)hasIdenticalBorderStyles {
  return !((_borderTopStyle ^ _borderLeftStyle) | (_borderTopStyle ^ _borderBottomStyle) |
...
- (BOOL)isSimpleBorder {
  ...
  if (_borderLeftStyle != LynxBorderStyleNone && _borderLeftStyle != LynxBorderStyleHidden) {
    if (_borderWidth.bottom < 1) {
      return NO;
    }
    if (_borderLeftStyle != LynxBorderStyleSolid) {
      return NO;
    }
...
- (BOOL)canUseBorderShapeLayer {
  ...
  return _borderLeftStyle == LynxBorderStyleSolid && [self hasIdenticalBorderStyles] &&
