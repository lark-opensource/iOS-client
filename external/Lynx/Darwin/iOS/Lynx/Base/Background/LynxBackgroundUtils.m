...
LynxCornerInsets LynxGetCornerInsets(CGRect bounds, LynxBorderRadii cornerRddi,
  ...
  LynxCornerInsets cornerInsets = {.topLeft =
                                       {
                                           LynxBorderUnitValToFloat(cornerRddi.topLeftX, width),
                                           LynxBorderUnitValToFloat(cornerRddi.topLeftY, height),
                                       },
                                   .topRight =
                                       {
                                           LynxBorderUnitValToFloat(cornerRddi.topRightX, width),
                                           LynxBorderUnitValToFloat(cornerRddi.topRightY, height),
                                       },
                                   .bottomLeft =
                                       {
                                           LynxBorderUnitValToFloat(cornerRddi.bottomLeftX, width),
                                           LynxBorderUnitValToFloat(cornerRddi.bottomLeftY, height),
                                       },
                                   .bottomRight = {
                                       LynxBorderUnitValToFloat(cornerRddi.bottomRightX, width),
                                       LynxBorderUnitValToFloat(cornerRddi.bottomRightY, height),
                                   }};
...
UIImage* LynxGetBackgroundImageWithClip(CGSize viewSize, LynxBorderRadii cornerRadii,
  ...
  if (@available(iOS 10.0, *)) {
    ...
    UIGraphicsImageRenderer* render = [[UIGraphicsImageRenderer alloc] initWithSize:viewSize
                                                                             format:format];
  ...
  CGContextRef ctx = LynxUIGraphicsBeginImageContext(viewSize, backgroundColor, hasCornerRadii,
                                                     drawToEdge, &hasOldCtx, clipType);
  LynxDrawBackgroundToImageContext(cornerRadii, borderInsets, backgroundColor, drawToEdge,
                                   bgImageInfoArr, rect, ctx);
...
UIImage* LynxGetBorderLayerImage(LynxBorderStyles borderStyles, CGSize viewSize,
  ...
  if (@available(iOS 10.0, *)) {
    ...
    UIImage* image = [renderer imageWithActions:^(UIGraphicsImageRendererContext* rendererContext) {
      CGContextRef ctx = rendererContext.CGContext;
      LynxDrawBorderToImageContext(borderStyles, viewSize, cornerRadii, borderInsets, borderColors,
                                   drawToEdge, rect, cornerInsets, hasCornerRadii, ctx);
    }];
    return image;
  }
  ...
  BOOL hasOldCtx;
  CGContextRef ctx =
      LynxUIGraphicsBeginImageContext(viewSize, [UIColor clearColor].CGColor, hasCornerRadii,
                                      drawToEdge, &hasOldCtx, LynxBackgroundClipBorderBox);
  LynxDrawBorderToImageContext(borderStyles, viewSize, cornerRadii, borderInsets, borderColors,
                               drawToEdge, rect, cornerInsets, hasCornerRadii, ctx);
