...
NSString *kAWECloudCommandReachabilityChangedNotification = @"kAWECloudCommandReachabilityChangedNotification";
...
#pragma unused (target, flags)
    ...
    NSCAssert([(__bridge NSObject*) info isKindOfClass: [AWECloudCommandReachability class]], @"info was wrong class in ReachabilityCallback");
    
    AWECloudCommandReachability* noteObject = (__bridge AWECloudCommandReachability *)info;
    // Post a notification to notify the client that the network reachability changed.
    [[NSNotificationCenter defaultCenter] postNotificationName: kAWECloudCommandReachabilityChangedNotification object: noteObject];
}

#pragma mark - Reachability implementation

@implementation AWECloudCommandReachability
{
...
{
    AWECloudCommandReachability* returnValue = NULL;
...
- (AWECloudCommandNetworkStatus)networkStatusForFlags:(SCNetworkReachabilityFlags)flags
{
    PrintReachabilityFlags(flags, "networkStatusForFlags");
    if ((flags & kSCNetworkReachabilityFlagsReachable) == 0)
    {
        // The target host is not reachable.
        return AWECloudCommandNotReachable;
    }
    
    AWECloudCommandNetworkStatus returnValue = AWECloudCommandNotReachable;
    ...
    if ((flags & kSCNetworkReachabilityFlagsConnectionRequired) == 0)
    {
         ...
         */
        returnValue = AWECloudCommandReachableViaWiFi;
    }
    ...
    if ((flags & kSCNetworkReachabilityFlagsIsWWAN) == kSCNetworkReachabilityFlagsIsWWAN)
    {
        ...
        if ([currentRadioAccessTechnology isEqualToString:CTRadioAccessTechnologyGPRS] || [currentRadioAccessTechnology isEqualToString:CTRadioAccessTechnologyEdge]) {
            returnValue = AWECloudCommandReachableVia2G;
            ...
            returnValue = AWECloudCommandReachableVia3G;
        } else if ([currentRadioAccessTechnology isEqualToString:CTRadioAccessTechnologyLTE]) {
            returnValue = AWECloudCommandReachableVia4G;
        }
    }
