...
typedef NS_OPTIONS(NSInteger, YYTextBottomLineType) {
    YYTextBottomLineTypeStraightLine     = 0,
    YYTextBottomLineTypeDottedLine    = 1
};
...
@property (nullable, nonatomic, strong) UIColor *bottomLineStrokeColor;
@property (nonatomic) CGFloat bottomLineStrokeWidth;
@property (nonatomic) YYTextBottomLineType bottomLineType;
@end
