...
@property (nullable, nonatomic, copy) YYTextAction textTapBeganAction;
@property (nullable, nonatomic, copy) YYTextAction textTapEndAction;
@property (nullable, nonatomic, strong) UIMenuController *customMenu;
@property (nonatomic) BOOL allowSelectionDot;
@property (nonatomic) BOOL allowShowMagnifierCaret;
@property (nonatomic) BOOL allowLongPressSelection;
@property (nonatomic) BOOL allowLongPressSelectionAlwaysAll;
@property (nonatomic, nonatomic) UIColor *selectionViewBackgroundColor;
@property (nonatomic) CGFloat dragAreaOffset;
...
- (void)setMenuItem:(NSArray *)menusItems;
...
UIKIT_EXTERN NSString *const YYTextViewIsInLongPressSelectionRects;
