...
@protocol OLEContainerScrollViewScrollingOffset
 ...
 */
@interface LynxOLEContainerScrollView : UIScrollView
...
/**
 subView observer update
 */

@property (nonatomic, assign) CGFloat endTopOffset;

@property (nonatomic, weak) UIScrollView *currentSubScrollView;

@property (nonatomic, weak) id <OLEContainerScrollViewScrollingOffset> offsetDelegate;
...
@protocol OLEContainerTabbarScrollAble

@required
@property (nonatomic, readonly) NSArray<UIView *> *tabContentViews;
