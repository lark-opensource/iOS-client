...
#import "BDXPagerSmoothView.h"

static NSString *BDXPagerSmoothViewCollectionViewCellIdentifier = @"cell";
...
@end
@implementation BDXPagerSmoothCollectionView
...
@interface BDXPagerSmoothView () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>

@property (nonatomic, weak) id<BDXPagerSmoothViewDataSource> dataSource;
@property (nonatomic, strong) BDXPagerSmoothCollectionView *listCollectionView;
@property (nonatomic, strong) NSMutableDictionary <NSNumber *, id<BDXPagerSmoothViewListViewDelegate>> *listDict;
...
@implementation BDXPagerSmoothView

- (void)dealloc
{
    for (id<BDXPagerSmoothViewListViewDelegate> list in self.listDict.allValues) {
...
- (instancetype)initWithDataSource:(id<BDXPagerSmoothViewDataSource>)dataSource
{
...
- (void)initializeViews {
    ...
    _listCollectionView = [[BDXPagerSmoothCollectionView alloc] initWithFrame:CGRectZero collectionViewLayout:layout];
    ...
    [self.listCollectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:BDXPagerSmoothViewCollectionViewCellIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    UICollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:BDXPagerSmoothViewCollectionViewCellIdentifier forIndexPath:indexPath];
    id<BDXPagerSmoothViewListViewDelegate> list = self.listDict[@(indexPath.item)];
    if (list == nil) {
    ...
    for (id<BDXPagerSmoothViewListViewDelegate> listItem in self.listDict.allValues) {
...
- (void)listDidAppear:(NSInteger)index {
    ...
    id<BDXPagerSmoothViewListViewDelegate> list = self.listDict[@(index)];
