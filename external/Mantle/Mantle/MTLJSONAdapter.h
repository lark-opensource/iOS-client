...
///Return if this class will automatically generate camel-style property to underscored JSON key and inherit all auto-generated mapping and self-defined mapping from its all super class chain
