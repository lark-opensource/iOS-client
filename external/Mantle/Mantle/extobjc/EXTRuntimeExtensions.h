...
typedef struct {
    /**
     * Whether this property should not ignored from Mantle scope.
     */
    BOOL ignore;
    /**
     ...
     * If objectClass cannot be deduced from property attributes or objectClass is a container class (Objective-C runtime does not support true generic type), we will deduce the type from a first matched deducedObjectClass from a protocol with the same name(always an empty declaration)
     */
    Class deducedObjectClass;
