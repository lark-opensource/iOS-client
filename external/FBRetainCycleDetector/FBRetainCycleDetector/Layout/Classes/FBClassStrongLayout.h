...
NSArray<id<FBObjectReference>> * _Nullable FBGetClassOrObjectStrongReferences(id _Nullable aClsOrObj,
                                                                              NSMutableDictionary<Class, NSArray<id<FBObjectReference>> *> * _Nullable layoutCache,bool isClass);

NSArray<id<FBObjectReference>> * _Nullable FBGetStrongReferencesForClass(Class _Nullable aCls);
