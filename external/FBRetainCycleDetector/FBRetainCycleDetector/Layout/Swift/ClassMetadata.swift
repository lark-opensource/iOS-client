...
struct TargetObjCClassWrapperMetadata {
    var Kind: InProcess
    var meclass: UnsafeMutablePointer<ClassMetadata>
}
...
struct TargetTupleTypeMetadata {
    var Kind: InProcess
    var NumElements:UInt
    var Labels: UnsafeMutablePointer<UnsafeRawPointer>
}
...
struct ClassMetadata {
    ...
    mutating func getFieldOffset(index: Int) -> Int {
        ...
        return withUnsafeMutablePointer(to: &self) {
            ...
            //属性的起始偏移量已32位整形存储的，转一下指针//class 应该是64，struct 里面是32
