...
extern NSString * const FBRetainCycleDetectorVersion;
...
- (nonnull NSSet<NSArray<FBObjectiveCGraphElement *> *> *)findRetainCyclesWithMaxCycleLength:(NSUInteger)length maxTraversedNodeNumber:(NSUInteger)nodeNumber maxCycleNum:(NSUInteger)maxCycleNum;
