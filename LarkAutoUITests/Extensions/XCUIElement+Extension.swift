    ...
    */
    ...
    /**
     ...
     - Parameters:
       ...
       - line: The line number to log in case of failure. Defaults to the caller's line.
     */
    func tapAndType(text: String, waitForFocus: Bool = false, _ file: StaticString = #fileID, _ line: UInt = #line) {
    ...
    /**
     ...
     - Parameters:
       ...
       - line: The line number to log in case of failure. Defaults to the caller's line.
     */
    func clearText(_ file: StaticString = #fileID, _ line: UInt = #line) {
        XCTAssert(self.exists, "\(self) doesn't exist", file: file, line: line)
    ...
    /**
     ...
     - Parameters:
       ...
       - line: The line number to log in case of failure. Defaults to the caller's line.
     */
    func tapAndClearText(_ file: StaticString = #fileID, _ line: UInt = #line) {
        self.tap(file, line)
