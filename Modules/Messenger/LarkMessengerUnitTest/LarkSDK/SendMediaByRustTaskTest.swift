...
class SendMediaCreateQuasiMsgTaskTest: XCTestCase {
    private var task: SendMediaCreateQuasiMsgTask<SendMediaCreateQuasiMsgTaskTest>!
    ...
    override func setUp() {
        ...
        task = SendMediaCreateQuasiMsgTask(context: self)
    }
...
extension SendMediaCreateQuasiMsgTaskTest: SendMediaCreateQuasiMsgTaskContext {
