//
//  SendAudioMsgOnScreenTaskTest.swift
//  LarkSDK-Unit-Tests
//
...
class SendAudioMsgOnScreenTaskTest: XCTestCase {
    private var task: SendAudioMsgOnScreenTask<SendAudioMsgOnScreenTaskTest>!
    ...
    override func setUp() {
        ...
        self.input = SendMessageProcessInput(context: APIContext(contextID: "123"),
                                             model: SendAudioModel(info: audioDataInfo,
                                                                   ...
                                                                   threadId: nil,
                                                                   content: content))
        task = SendAudioMsgOnScreenTask(context: self)
    }
...
extension SendAudioMsgOnScreenTaskTest: SendAudioMsgOnScreenTaskContext {
