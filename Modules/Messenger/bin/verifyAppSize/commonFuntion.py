...
USER_INFO = "https://open.feishu.cn/open-apis/user/v4/email2id"
...
BOT_HOST = "https://open.feishu.cn/open-apis/message/v4/send/"
...
def post_change_line_numbers(proj_dir):
    ...
    if result["code"] == 0:
        ...
        if __last_swift_line_number > 0 and __last_oc_line_number > 0:
            ...
            sendBotMsg("https://open.feishu.cn/open-apis/bot/hook/4290db362d404f06b8fb81eb122b083c","超限了", msg)
        else:
            print("没有检测到代码变更")
    else:
