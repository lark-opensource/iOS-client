...
#
# Be sure to run `pod lib lint LarkChatKeyboardInterface.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkChatKeyboardInterface'
  ...
  # s.resource_bundles = {
  #     'LarkChatKeyboardInterface' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkChatKeyboardInterfaceAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
