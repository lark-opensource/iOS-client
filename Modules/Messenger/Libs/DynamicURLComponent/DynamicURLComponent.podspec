...
#
# Be sure to run `pod lib lint DynamicURLComponent.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'DynamicURLComponent'
  s.version = '5.31.0.5479096'
  s.summary          = 'Message URL Preview'
  s.description      = 'Message URL Preview'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "yuanping.0": 'yuanping.0@bytedance.com'
  }
  ...
  s.resource_bundles = {
      'DynamicURLComponent' => ['resources/*.lproj/*', 'resources/*'],
      'DynamicURLComponentAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
  ...
  s.dependency 'RenderRouterInterface'
