//
//  FileAndFolderContentComponentBinder.swift
//  LarkMessageCore
//
...
public class BaseFileAndFolderContentComponentBinder<M: CellMetaModel, D: CellMetaModelDependency, C: FileAndFolderContentContext & PageContext>: NewComponentBinder<M, D, C> {
...
public final class FileAndFolderContentComponentBinder<M: CellMetaModel, D: CellMetaModelDependency, C: FileAndFolderContentContext & PageContext>:
    BaseFileAndFolderContentComponentBinder<M, D, C> {
    ...
    public override func syncToBinder(key: String?) {
        ...
        props.size = vm.size
        props.lastEditInfoString = vm.lastEditInfoString
        props.rate = vm.rateText
        props.icon = vm.icon
        ...
        props.permissionPreview = vm.permissionPreview
...
public class MessageDetailFileAndFolderContentComponentBinder<M: CellMetaModel, D: CellMetaModelDependency, C: FileAndFolderContentContext & PageContext>:
    BaseFileAndFolderContentComponentBinder<M, D, C> {
    fileprivate let style = ASComponentStyle()
    fileprivate let props = FileViewComponent<C>.Props()
...
final class PinFileAndFolderContentComponentBinder<M: CellMetaModel, D: CellMetaModelDependency, C: FileAndFolderContentContext & PageContext>:
    MessageDetailFileAndFolderContentComponentBinder<M, D, C> {
    public override func buildComponent(key: String? = nil, context: C? = nil) {
