//
//  ShowMoreMaskButtonComponent.swift
//  LarkMessageCore
//
...
public final class ShowMoreMaskButtonComponent<C: AsyncComponent.Context>: ASComponent<ShowMoreMaskButtonComponent.Props, EmptyState, ShowMoreButtonMaskView, C> {
    ...
    public override func update(view: ShowMoreButtonMaskView) {
        super.update(view: view)
        view.showMoreHandler = props.showMoreHandler
