...
#
# Be sure to run `pod lib lint LarkMessengerInterface.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #  s.resource_bundles = {
  #      'LarkMessengerInterface' => ['resources/*'] ,
  #      'LarkMessengerInterfaceAuto' => 'auto_resources/*'
  #  }
  ...
  s.dependency 'LarkOpenSetting/Interface'
  s.dependency 'LarkBaseKeyboard/FontPanel'
