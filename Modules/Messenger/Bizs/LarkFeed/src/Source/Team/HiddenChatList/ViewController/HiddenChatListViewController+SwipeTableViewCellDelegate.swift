//
//  HiddenChatListViewController+SwipeTableViewCellDelegate.swift
//  LarkFeed
//
...
extension HiddenChatListViewController: SwipeTableViewCellDelegate {
    func tableView(_ tableView: UITableView,
        ...
        return getActions([.hide], cellViewModel)
    }
