...
//  LarkSearch
//
//  Created by wangjingcan on 2023/6/27.
//
...
final class SearchAdvancedFilterView: UIView {
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.register(FilterItemCell.self, forCellReuseIdentifier: FilterItemCell.identifier)
        return tableView
    }()
    private let disposeBag = DisposeBag()

    init(frame: CGRect, dataSource: [SearchFilter]) {
    ...
    private func initSubViews() {
        ...
        editLabel.text = BundleI18n.LarkSearch.Lark_Search_ResetFilter
        ...
        titleLable.text = BundleI18n.LarkSearch.Lark_NewSearch_SecondarySearch_AdvancedSearchFilters_Title
...
extension SearchAdvancedFilterView: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: FilterItemCell.identifier, for: indexPath)
    ...
    var item: SearchFilter? {
        didSet {
            ...
            if newItem.isEmpty {
                ...
                if complexCount > 1 {
                    let suffixStr = BundleI18n.LarkSearch.Lark_NewFilter_Search_ChoseMoreSearchItems(complexCount - 1)
