...
public final class FlagStickerMessageCell: FlagMessageCell {
    ...
    private var stickerViewModel: FlagStickerMessageViewModel? {
        return viewModel as? FlagStickerMessageViewModel
    }
