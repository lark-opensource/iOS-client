//
//  WheeledCollectionFlowLayout.swift
//  LarkAI
//
...
public class WheeledCollectionFlowLayout: UICollectionViewFlowLayout {
    ...
    public init(cellSize: WheeledCollectionCellSize) {
...
extension WheeledCollectionFlowLayout {
    ...
    override public func prepare() {
        if cache.isEmpty || cache.count != numberOfItems {
            ...
            updateLayout(forBounds: collectionView?.bounds ?? .zero)
        }
    }
