...
final class SceneListErrorView: UIView {
    override init(frame: CGRect) {
        ...
        errorImageView.image = EmptyBundleResources.image(named: "emptyNegativeError")
        ...
        titleLabel.text = BundleI18n.LarkAI.MyAI_Scenario_MyScenarios_InternetError_EmptyState
