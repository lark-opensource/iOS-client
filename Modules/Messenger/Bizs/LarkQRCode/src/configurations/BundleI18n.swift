...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkQRCodeAutoBundle, moduleName: "LarkQRCode", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkQRCodeAutoBundle, moduleName: "LarkQRCode", lang: lang) ?? key
            #endif
        }
    ...
    final class LarkQRCode {
        ...
        @inlinable
        static var Lark_Legacy_QrCodeLoading: String {
            return LocalizedString(key: "Plo", originalKey: "Lark_Legacy_QrCodeLoading")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Legacy_QrCodeLoading(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "Plo", originalKey: "Lark_Legacy_QrCodeLoading", lang: __lang)
        }
        @inlinable
