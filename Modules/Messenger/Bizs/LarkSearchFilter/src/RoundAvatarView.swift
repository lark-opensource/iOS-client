...
final class RoundAvatarView: UIView {
    ...
    private let avatarInfo: SearchFilterView.AvatarInfo?
    private let avatarImageView = BizAvatar()

    init(avatarInfo: SearchFilterView.AvatarInfo, avatarWidth: CGFloat = 16, showBgColor: Bool = true, blueCircleWidth: CGFloat = 2) {
