//
//  ThreadPostForwardDetailViewController.swift
//  LarkThread
//
...
final class ThreadPostForwardDetailViewController: ThreadDetailBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        viewModel.loadData()
        observerViewModel()
        ChannelTracker.TopicDetail.View(self.viewModel.chat, self.viewModel.threadMessage?.rootMessage.id ?? "")
    ...
    private func setupView() {
        ...
        setupNavBar()
        threadTitleView.chatName = BundleI18n.LarkThread.Lark_Group_FromTopicGroup
    ...
    override func forwardButtonTapped(sender: UIButton) {
        ...
        /// TODO: liluobin 这里的这个类型 threadDetail, 转发的消息favroite 有没有带originMergeForwardId
        let body = ForwardMessageBody(originMergeForwardId: originMergeForwardId(),
                                      message: viewModel.message,
                                      type: .message(viewModel.message.id),
                                      from: .thread,
...
// MARK: - ChatPageAPI 多选
extension ThreadPostForwardDetailViewController: ChatPageAPI {
...
extension ThreadPostForwardDetailViewController: DetailTableDelegate {
...
extension ThreadPostForwardDetailViewController: PageAPI {
...
extension ThreadPostForwardDetailViewController: ChatMessagesOpenService {
    var pageAPI: PageAPI? {
        return self
    }
...
extension ThreadPostForwardDetailViewController: MessageMenuServiceDelegate, LongMessageMenuOffsetProtocol {
