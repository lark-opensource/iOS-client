//
//  ThreadTopMsgTipCellComponent.swift
//  LarkThread
//
...
final class ThreadTopMsgTipCellComponent: ASComponent<ThreadTopMsgTipCellComponent.Props, EmptyState, UIView, ThreadContext> {
    ...
    override init(props: ThreadTopMsgTipCellComponent.Props, style: ASComponentStyle, context: ThreadContext? = nil) {
        ...
        labelComponent.props.attributedText = formatRichText(text: props.tip)
    }

    override func willReceiveProps(_ old: Props, _ new: Props) -> Bool {
        labelComponent.props.attributedText = formatRichText(text: new.tip)
        return true
    }
