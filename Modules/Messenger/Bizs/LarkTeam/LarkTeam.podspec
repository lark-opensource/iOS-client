...
#
# Be sure to run `pod lib lint LarkTeam.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "JackZhao": 'zhaodong.23@bytedance.com'
  }
  ...
  s.resource_bundles = {
      'LarkTeam' => ['resources/*.lproj/*', 'resources/*'],
      'LarkTeamAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
