//
//  TeamMemberBaseTableView.swift
//  LarkTeam
//
//  Created by 夏汝震 on 2022/7/28.
//
...
final class TeamMemberBaseTableView: UITableView {
    lazy var emptyPlaceholder = BundleI18n.LarkTeam.Lark_Legacy_CurrentPageEmpty
    lazy var emptyPlaceholderImage = EmptyDataView.defaultEmptyImage
    enum Status {
        case display
        case loading
        case empty
    ...
    private func update(text: String) {
        let wholeText = BundleI18n.LarkTeam.Lark_Legacy_SearchNoResult(text)
        let template = BundleI18n.LarkTeam.__Lark_Legacy_SearchNoResult as NSString
