//
//  FavoriteLocationMessageDetailCell.swift
//  LarkFavorite
//
...
final class FavoriteLocationMessageDetailCell: FavoriteMessageDetailCell {
    ...
    private var locationViewModel: FavoriteLocationMessageViewModel? {
        return viewModel as? FavoriteLocationMessageViewModel
    }

    private let favoriteLocationView: ChatLocationViewWrapper = {
    ...
    override public func setupUI() {
        ...
        container.addSubview(favoriteLocationView)
    ...
    override public func updateCellContent() {
        ...
        favoriteLocationView.set(
            ...
            setLocationViewAction: { (imageView, completion) in
                ...
                let key = imageSet.generateImageMessageKey(forceOrigin: true)
