//
//  SubscriberFeedCardModule.swift
//  LarkFeedPlugin
//
...
class SubscriberFeedCardModule: FeedCardBaseModule {
    @ScopedInjectedLazy var dependency: SubscriberFeedCardDependency?
    ...
    override func bizData(feedPreview: FeedPreview) -> FeedPreviewBizData {
        ...
        shortcutChannel.type = .subscription
