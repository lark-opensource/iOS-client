...
#
# Be sure to run `pod lib lint LarkFeedPlugin.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkFeedPlugin'
  s.version = '5.32.0.5485092'
  s.summary          = 'Feed插件'
  s.description      = '注入Feed的组件可放此处'
  s.homepage         = 'https://ee.byted.org/madeira/browse/ee/lark/ios-client/tree/master/LarkFeedPlugin'
  ...
  s.resource_bundles = {
      'LarkFeedPlugin' => ['resources/*'] ,
      'LarkFeedPluginAuto' => ['auto_resources/*', 'R/**/*']
  }
  ...
  s.dependency 'LarkFeed'
  s.dependency 'LarkFeedBanner'
  s.dependency 'LarkFeedEvent'
