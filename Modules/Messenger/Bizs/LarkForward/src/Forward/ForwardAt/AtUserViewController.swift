...
public final class AtUserViewController: BaseUIViewController, PickerDelegate, UITextViewDelegate {
    ...
    public init(provider: ForwardAlertProvider,
        ...
        picker.defaultView = AtUserDefaultView(resolver: self.provider.userResolver,
    ...
    public convenience init(provider: ForwardAlertProvider,
        ...
        let pickerParam = AtPicker.InitParam()
        ...
        self.init(provider: provider,
                  picker: AtPicker(resolver: provider.userResolver, frame: .zero, params: pickerParam),
