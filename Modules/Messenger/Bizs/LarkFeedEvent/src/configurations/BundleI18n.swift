...
{
"keys":{
"Lark_Event_EventList_Clear_Button":{
"hash":"9y0",
"#vars":0
},
"Lark_Event_EventList_Details_Title":{
"hash":"ZZw",
"#vars":0
}
},
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkFeedEventAutoBundle, moduleName: "LarkFeedEvent", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkFeedEventAutoBundle, moduleName: "LarkFeedEvent", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class LarkFeedEvent {
        @inlinable
        static var Lark_Event_EventList_Clear_Button: String {
            return LocalizedString(key: "9y0", originalKey: "Lark_Event_EventList_Clear_Button")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Event_EventList_Clear_Button(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "9y0", originalKey: "Lark_Event_EventList_Clear_Button", lang: __lang)
        }
        @inlinable
        static var Lark_Event_EventList_Details_Title: String {
            return LocalizedString(key: "ZZw", originalKey: "Lark_Event_EventList_Details_Title")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Event_EventList_Details_Title(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "ZZw", originalKey: "Lark_Event_EventList_Details_Title", lang: __lang)
        }
    }
}
