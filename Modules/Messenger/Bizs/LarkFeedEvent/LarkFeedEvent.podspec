...
#
# Be sure to run `pod lib lint LarkFeedEvent.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'LarkFeedEvent' => ['resources/*.lproj/*', 'resources/*'],
      'LarkFeedEventAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
