...
//import RustPB
//
//class NormalDetailTableModelTest: XCTestCase {
//
...
//        -> (EventComponentViewControllerModel, NormalDetailTableModel) {
...
//            let detailTableModel = NormalDetailTableModel(model: componentModel,
...
//
//    func testScore() {
//        var instance = instancePB!
//        instance.importanceScore = "15"
//        var calendarPB = calendar!
//        calendarPB.type = .primary
//        let (componentModel, detailTableModel) = getDetailTableModel(event: event,
//                                                                     instancePB: instance,
//                                                                     calendar: calendarPB)
//        XCTAssertEqual(15, detailTableModel.score)
//    }
//
//    func testTime() {
//        do {
...
//            XCTAssertEqual(getDateFromInt64(instancePB.endTime),
//                           detailTableModel.time.endTime)
//            XCTAssertNil(detailTableModel.time.subTitle)
//            XCTAssertEqual(componentModel.eventDetailViewModel.isAllDay,
//                           detailTableModel.time.isAllDay)
//        }
//    }
...
//                                                            instancePB: instancePB,
//                                                            calendar: calendar)
//            XCTAssertNotNil(detailTableModel.meetingConditions)
//            XCTAssertEqual(false, detailTableModel.meetingConditions?.canEnterChat)
//        }
//    }
//
//    func testDesc() {
...
//                                                            calendar: calendar)
//            if let contactAttendee = detailTableModel.contactAttendee,
//                case ContactAttendee.attendeeInvisible = contactAttendee {
//                XCTFail("出错!")
//            }
//        }
//        do {
