...
//import RustPB
//
//class ShareDetailTableModelTest: XCTestCase {
//
//    var event: MockCalendarEventEntity!
//    var instancePB: CalendarEventInstance!
//    var calendar: MockCalendarEntity!
//    let allDayReminder = Reminder(minutes: 15, isAllDay: true)
//    let noneAllDayReminder = Reminder(minutes: 30, isAllDay: false)
//
//    override func setUp() {
//        super.setUp()
...
//                             currentUserCalendarId: String = "1591560057517060",
//                             calendar: CalendarModel?)
//        -> (EventComponentViewControllerModel, ShareDetailTableModel) {
//            let instance = CalendarEventInstanceEntityFromPB(withInstance: instancePB)
//            var eventDetailViewModel = CalendarEventDetailViewModel(fromEntity: event,
//                                                                    instance: instance,
//                                                                    calendar: calendar)
//            eventDetailViewModel.isForReview = true
//            let componentModel = EventComponentViewControllerModel(eventDetailViewModel: eventDetailViewModel)
//
//            let detailTableModel = ShareDetailTableModel(model: componentModel,
//                                                         allDayReminder: allDayReminder,
//                                                         noneAllDayReminder: noneAllDayReminder, currentUserCalendarId: currentUserCalendarId,
//                                                         currentTenantId: "1", is12HourStyle: false)
...
//                                                                     calendar: nil)
//            XCTAssertEqual(getDateFromInt64(instancePB.startTime),
//                           detailTableModel.time.startTime)
//            XCTAssertEqual(getDateFromInt64(instancePB.endTime),
...
//                                                            instancePB: instancePB,
//                                                            calendar: nil)
//            XCTAssertEqual(Reminder.description(of: [noneAllDayReminder], isAllDay: false, is12HourStyle: false),
...
//                                                            calendar: calendar)
//            guard let attendeeModel = detailTableModel.attendee,
//                case let DetailAttendee.attendees(attendee) = attendeeModel else {
//                    XCTAssert(false)
//                    return
//            }
...
//                                                            calendar: calendar)
//            guard let attendeeModel = detailTableModel.attendee,
//                case let DetailAttendee.attendees(_) = attendeeModel else {
//                    XCTAssert(false)
//                    return
//            }
//        }
