////
////  LocalDetailTableModelTest.swift
////  CalendarTests
////
...
//import RustPB
//
//class LocalDetailTableModelTest: XCTestCase {
//
...
//        -> (EventComponentViewControllerModel, LocalDetailTableModel) {
...
//            let detailTableModel = LocalDetailTableModel(model: componentModel, is12HourStyle: false)
...
//                                                            instancePB: instancePB,
//                                                            calendar: calendar)
//            if let contactAttendee = detailTableModel.contactAttendee, case let ContactAttendee.contactInfo(attendee) = contactAttendee {
