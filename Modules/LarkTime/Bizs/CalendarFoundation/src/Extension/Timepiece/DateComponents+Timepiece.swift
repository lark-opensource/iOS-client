...
extension DateComponents {
    public var ago: Date? {
        return Calendar.gregorianCalendar.date(byAdding: -self, to: Date())
    }
...
public extension Calendar {
    public static var gregorianCalendar = Calendar(identifier: .gregorian)

    public static func gregorianCalendarWithCurrentTimeZone() -> Calendar {
