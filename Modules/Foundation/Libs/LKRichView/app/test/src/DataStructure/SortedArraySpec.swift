...
class SortedArraySpec: XCTestCase {
    override func setUp() {
        super.setUp()
    }
    ...
    func testLinuxTestSuiteIncludesAllTests() {
            ...
            let darwinTestCount = SortedArraySpec.defaultTestSuite.testCaseCount
            let linuxTestCount = SortedArraySpec.allTests.count
...
extension SortedArraySpec {
    static var allTests: [(String, (SortedArraySpec) -> () throws -> Void)] {
        return [
