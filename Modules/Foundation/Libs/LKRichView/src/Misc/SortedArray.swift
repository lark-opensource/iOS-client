...
//  LKRichView
//
//  Created by qihongye on 2019/12/28.
//

import Foundation

/// reference: https://github.com/ole/SortedArray/blob/master/Sources/SortedArray.swift
...
struct SortedArray<Element> {
    ...
    init<S: Sequence>(unsorted: S, areInIncreasingOrder: @escaping Comparator<Element>) where S.Element == Element {
    ...
    init<S: Sequence>(sorted: S, areInIncreasingOrder: @escaping Comparator<Element>) where S.Element == Element {
