...
#
# Be sure to run `pod lib lint LarkCleanAssembly.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkCleanAssembly' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkCleanAssemblyAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
  ...
  s.if_pod 'LarkSafeMode' do |sp|
    sp.dependency 'LarkSafeMode'
  end
