...
public extension Date {
    ...
    /// LarkDate: Next five minutes to date.
    ///
    ///     var date = Date() // "5:54 PM"
    ///     date.minute = 32 // "5:32 PM"
    ///     date.nextFiveMinutes // "5:35 PM"
    ///
    ///     date.minute = 44 // "5:44 PM"
    ...
    var nextFiveMinutes: Date {
        var components = calendar.dateComponents([.year, .month, .day, .hour, .minute, .second, .nanosecond], from: self)
        let min = components.minute!
        components.minute! = min % 5 == 0 ? min + 5 : min + 5 - (min % 5)
        components.second = 0
        components.nanosecond = 0
        return calendar.date(from: components)!
    }

    /// LarkDate: Next ten minutes to date.
    ///
    ///     var date = Date() // "5:57 PM"
    ///     date.minute = 34 // "5:34 PM"
    ///     date.nextTenMinutes // "5:40 PM"
    ///
    ///     date.minute = 48 // "5:48 PM"
    ...
    var nextTenMinutes: Date {
        var components = calendar.dateComponents([.year, .month, .day, .hour, .minute, .second, .nanosecond], from: self)
        let min = components.minute!
        components.minute? = min % 10 == 0 ? min + 10 : min + 10 - (min % 10)
        components.second = 0
        components.nanosecond = 0
        return calendar.date(from: components)!
    }

    /// LarkDate: Next quarter hour to date.
    ///
    ///     var date = Date() // "5:57 PM"
    ///     date.minute = 34 // "5:34 PM"
    ...
    var nextQuarterHour: Date {
        var components = calendar.dateComponents([.year, .month, .day, .hour, .minute, .second, .nanosecond], from: self)
        let min = components.minute!
        components.minute! = min % 15 == 0 ? min + 15 : min + 15 - (min % 15)
        components.second = 0
        components.nanosecond = 0
        return calendar.date(from: components)!
    }

    /// LarkDate: Next half hour to date.
    ///
    ///     var date = Date() // "6:00 PM"
    ///     date.minute = 29 // "6:29 PM"
    ///     date.nextHalfHour // "6:30 PM"
    ///
    ///     date.minute = 30 // "6:30 PM"
    ///     date.minute = 51 // "6:51 PM"
    ...
    var nextHalfHour: Date {
        var components = calendar.dateComponents([.year, .month, .day, .hour, .minute, .second, .nanosecond], from: self)
        let min = components.minute!
        components.minute! = min % 30 == 0 ? min + 30 : min + 30 - (min % 30)
        components.second = 0
        components.nanosecond = 0
        return calendar.date(from: components)!
    }

    /// LarkDate: Next hour to date.
    ///
    ///     var date = Date() // "6:17 PM"
