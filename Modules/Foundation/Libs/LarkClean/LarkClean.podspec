...
#
# Be sure to run `pod lib lint LarkClean.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkClean' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkCleanAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
