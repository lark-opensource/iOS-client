...
- (BOOL)awe_escapesTargetDirectory:(NSString *)targetDirectory;
@end
    ...
    do {
        ...
        @autoreleasepool {
            ...
            else
            {
                ...
                if (symlinksValidWithin != nil && [symlinkFullDestinationPath awe_escapesTargetDirectory: symlinksValidWithin]) {
