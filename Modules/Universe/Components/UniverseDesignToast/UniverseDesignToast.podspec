...
#
# Be sure to run `pod lib lint UniverseDesignToast.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'UniverseDesignToast'
  s.version = '5.30.0.5442158'
