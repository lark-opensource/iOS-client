...
open class UDTagListItemView: UIButton {
    ...
    public var onTap: ((UDTagListItemView) -> Void)?
    public var onLongPress: ((UDTagListItemView) -> Void)?
...
internal final class CloseButton: UIButton {
    ...
    weak var tagView: UDTagListItemView?
