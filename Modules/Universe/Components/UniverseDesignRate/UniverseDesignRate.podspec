...
#
# Be sure to run `pod lib lint UniverseDesignRate.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'UniverseDesignRate' => ['resources/*.lproj/*', 'resources/*'],
  #     'UniverseDesignRateAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
