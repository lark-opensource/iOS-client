...
"Calendar_Common_Confirm":{
"hash":"lws",
"#vars":0
},
"Calendar_StandardTime_DateRelativeDayCombineFormat":{
"hash":"RCM",
"#vars":2,
"normal_vars":["relativeDay","date"]
},
...
"Calendar_TimeFormat_MonthAndDay":{
"hash":"+g8",
"#vars":0
}
},
"name":"UniverseDesignDatePicker",
"short_key":true,
"config":{
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.UniverseDesignDatePickerAutoBundle, moduleName: "UniverseDesignDatePicker", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.UniverseDesignDatePickerAutoBundle, moduleName: "UniverseDesignDatePicker", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class UniverseDesignDatePicker {
        @inlinable
        ...
        @inlinable
        static var Calendar_Common_Confirm: String {
            return LocalizedString(key: "lws", originalKey: "Calendar_Common_Confirm")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Calendar_Common_Confirm(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "lws", originalKey: "Calendar_Common_Confirm", lang: __lang)
        }
        @inlinable
        static var __Calendar_StandardTime_DateRelativeDayCombineFormat: String {
            return LocalizedString(key: "RCM", originalKey: "Calendar_StandardTime_DateRelativeDayCombineFormat")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Calendar_StandardTime_DateRelativeDayCombineFormat(_ relativeDay: Any, _ date: Any, lang __lang: Lang? = nil) -> String {
          return Calendar_StandardTime_DateRelativeDayCombineFormat(relativeDay: `relativeDay`, date: `date`, lang: __lang)
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        static func Calendar_StandardTime_DateRelativeDayCombineFormat(relativeDay: Any, date: Any, lang __lang: Lang? = nil) -> String {
            var template = LocalizedString(key: "RCM", originalKey: "Calendar_StandardTime_DateRelativeDayCombineFormat", lang: __lang)
            template = template.replacingOccurrences(of: "{{relativeDay}}", with: "\(`relativeDay`)")
        ...
        @inlinable
        static var Calendar_TimeFormat_MonthAndDay: String {
            return LocalizedString(key: "+g8", originalKey: "Calendar_TimeFormat_MonthAndDay")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Calendar_TimeFormat_MonthAndDay(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "+g8", originalKey: "Calendar_TimeFormat_MonthAndDay", lang: __lang)
        }
    }
}
