...
#
# Be sure to run `pod lib lint UniverseDesignActionPanel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'UniverseDesignActionPanel'
  ...
  # s.resource_bundles = {
  #     'UniverseDesignActionPanel' => ['resources/*.lproj/*' 'resources/*']
  # }
