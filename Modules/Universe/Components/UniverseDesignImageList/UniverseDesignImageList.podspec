...
#
# Be sure to run `pod lib lint UniverseDesignImageList.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'UniverseDesignImageList'
  ...
  # s.resource_bundles = {
  #     'UniverseDesignImageList' => ['resources/*.lproj/*', 'resources/*'],
  #     'UniverseDesignImageListAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
