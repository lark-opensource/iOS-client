...
Pod::Spec.new do |s|
  ...
  "src", "api",
  "src/realx/api", "src/realx/audio",
  "src/realx/engine", "src/realx/webrtc_impl",
  "src/realx/base", "src/realx/base/webrtc", "src/realx/base/ios",
  "third_party", "third_party/jsoncpp/source/include", "third_party/boya/include", "third_party/boya/include/vc",
  "third_party/usrsctp/usrsctplib",
  "third_party/libsrtp-2.1.0-pre", "third_party/libsrtp-2.1.0-pre/libsrtp", "third_party/libsrtp-2.1.0-pre/libsrtp/config",
  "third_party/libsrtp-2.1.0-pre/libsrtp/include", "third_party/libsrtp-2.1.0-pre/libsrtp/crypto/include",
  ].map { |f| "#{current_dir}/ByteRTCSDK/realx/#{f}" }

  pod_target_xcconfig['SYSTEM_HEADER_SEARCH_PATHS'] = [
  "abseil-cpp", "boringssl", "libyuv", "openh264", "bytevc0", "bytevc1enc", "bytevc1dec", "bytenn", "NICO", "opus", "bytenn"
