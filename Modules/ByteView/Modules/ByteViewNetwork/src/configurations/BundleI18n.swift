...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.ByteViewNetworkAutoBundle, moduleName: "ByteViewNetwork", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.ByteViewNetworkAutoBundle, moduleName: "ByteViewNetwork", lang: lang) ?? key
            #endif
        }
    ...
    final class ByteViewNetwork {
        ...
        @inlinable
        static func View_VM_Unknown(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "ido", originalKey: "View_VM_Unknown", lang: __lang)
        }
    }
}
