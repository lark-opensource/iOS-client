...
#
# Be sure to run `pod lib lint ByteViewMessenger.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'ByteViewMessenger'
  s.version = '5.31.0.5464556'
  s.summary          = '视频提供出去的Messenger能力，比如消息卡片'
  s.description      = '视频提供出去的Messenger能力，比如消息卡片'
  s.homepage         = 'https://code.byted.org/vc/ByteViewMessenger/tree/master/Bizs/ByteViewMessenger'
  ...
  s.resource_bundles = {
      'ByteViewMessenger' => ['resources/*.lproj/*', 'resources/*'],
      'ByteViewMessengerAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
  ...
  attributes_hash['extra'] = {
    ...
    "git_url": 'git@code.byted.org:vc/ByteViewMessenger.git'
  }
end
