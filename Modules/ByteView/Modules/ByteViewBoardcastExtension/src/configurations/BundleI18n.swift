...
{
"keys":{
"View_VM_NotInCallOrMeeting":{
"hash":"rYc",
"#vars":0
}
},
"name":"ByteViewBoardcastExtension",
"short_key":true,
"config":{
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.ByteViewBoardcastExtensionAutoBundle, moduleName: "ByteViewBoardcastExtension", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.ByteViewBoardcastExtensionAutoBundle, moduleName: "ByteViewBoardcastExtension", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class ByteViewExtension {
        @inlinable
        static var View_VM_NotInCallOrMeeting: String {
            return LocalizedString(key: "rYc", originalKey: "View_VM_NotInCallOrMeeting")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func View_VM_NotInCallOrMeeting(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "rYc", originalKey: "View_VM_NotInCallOrMeeting", lang: __lang)
        }
    }
}
