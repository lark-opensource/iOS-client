...
#
# Be sure to run `pod lib lint ByteViewInterface.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.subspec 'Navigator' do |ss|
    ss.source_files = 'src/Navigator/**/*.{swift}'
    ss.dependency 'EENavigator'
  end

  s.subspec 'Shortcut' do |ss|
    ss.source_files = 'src/Shortcut/**/*.{swift}'
    ss.dependency 'LarkShortcut'
  end

  s.subspec 'Calendar' do |ss|
    ss.source_files = 'src/Calendar/**/*.{swift}'
  end

  s.default_subspecs = ['Core', 'Navigator', 'Shortcut', 'Calendar']
