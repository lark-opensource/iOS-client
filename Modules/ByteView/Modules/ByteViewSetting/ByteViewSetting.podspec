...
#
# Be sure to run `pod lib lint ByteViewSetting.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.subspec 'Resource' do |cs|
    ...
    cs.resource_bundles = {
      ...
      'ByteViewSettingAuto' => ['auto_resources/*']
    }
  end

  s.subspec 'Core' do |cs|
    cs.source_files = 'src/Core/**/*.{swift}'
    cs.dependency 'ByteViewSetting/Resource'
  ...
  s.subspec 'UI' do |cs|
    cs.source_files = 'src/UI/**/*.{swift}'
    cs.dependency 'ByteViewSetting/Core'
