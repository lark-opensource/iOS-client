...
final class LanguageIcon {
    let type: InterpreterSetting.LanguageType
    let image: UIImage
    init(type: InterpreterSetting.LanguageType, image: UIImage) {
        self.type = type
        self.image = image
    }
}
...
final class LanguageIconManager {
    static let shared = LanguageIconManager()
    ...
    static func get(by type: InterpreterSetting.LanguageType,
                    font: UIFont? = nil,
