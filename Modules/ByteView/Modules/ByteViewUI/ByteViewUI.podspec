...
#
# Be sure to run `pod lib lint ByteViewUI.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'ByteViewUI' => ['resources/Lottie/*', 'resources/Images.xcassets'],
      'ByteViewUIAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
