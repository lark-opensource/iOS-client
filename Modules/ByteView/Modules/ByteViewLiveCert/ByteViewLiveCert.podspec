...
#
# Be sure to run `pod lib lint ByteViewLiveCert.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'ByteViewLiveCert' => ['resources/*'],
      'ByteViewLiveCertAuto' => ['auto_resources/*']
  }
