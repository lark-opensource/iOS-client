//
//  MeetTabPadLoadMoreSectionFooterView.swift
//  ByteView
//
...
class MeetTabPadLoadMoreSectionFooterView: MeetTabPadSectionFooterView {
    ...
    lazy var reloadButton: VisualButton = {
        ...
        reloadButton.setAttributedTitle(.init(string: I18n.View_G_UnableToLoadRetryButton, config: .bodyAssist, textColor: .ud.textDisabled), for: .normal)
        return reloadButton
    }()
    ...
    override init(reuseIdentifier: String?) {
        ...
        roundedView.snp.remakeConstraints {
            ...
            $0.height.equalToSuperview().offset(8.0)
        }
        contentStackView.snp.makeConstraints {
            $0.center.equalTo(paddingView)
        }
