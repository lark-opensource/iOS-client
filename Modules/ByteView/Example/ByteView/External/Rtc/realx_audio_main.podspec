...
Pod::Spec.new do |s|
  ...
  "src", "api",
  "src/realx/audio", "src/realx/api",
  "src/realx/base", "src/realx/base/webrtc", "src/realx/base/ios",
  "third_party/jsoncpp/source/include", "third_party/boya/include", "third_party/boya/include/vc",
  ].map { |f| "#{RtcBuildConfig.realx_root}/#{f}" }

  pod_target_xcconfig['SYSTEM_HEADER_SEARCH_PATHS'] = [
  "abseil-cpp", "boringssl", "bytenn", "opus", "NICO", "libyuv",
