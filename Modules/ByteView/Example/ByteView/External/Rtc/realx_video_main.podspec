...
Pod::Spec.new do |s|
  ...
  pod_target_xcconfig['PRELINK_LIBS'] = [
    'bytevc0', 'bytevc1dec'
  ].map { |f| "#{RtcBuildConfig.current_dir}/third_party/#{f}/lib/lib#{f}.a" }.join(' ')

  pod_target_xcconfig['HEADER_SEARCH_PATHS'] = [
    "src", "third_party", "third_party/jsoncpp/source/include",
    "src/realx/webrtc_impl", "src/realx/base", "src/realx/base/webrtc", "src/realx/base/ios"
  ].map { |f| "#{RtcBuildConfig.realx_root}/#{f}" }

  pod_target_xcconfig['SYSTEM_HEADER_SEARCH_PATHS'] = [
    "libyuv", "openh264", "bytevc0", "bytevc1enc", "bytevc1dec", "bytenn", "abseil-cpp", "boringssl"
