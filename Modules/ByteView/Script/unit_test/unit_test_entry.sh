...
project_dir="$(cd -- "$PROG_DIR/../../Example" && pwd -P)"

export TARGETCODEPATH="$project_dir"
export HOST_APP_XCWORKSPACE="ByteView.xcworkspace"
export HOST_APP_SCHEME="ByteView-Example"
export HOST_APP_PRODUCT="ByteView_Example.app"
