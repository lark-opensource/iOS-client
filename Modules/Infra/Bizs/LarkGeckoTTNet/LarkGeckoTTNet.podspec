...
#
# Be sure to run `pod lib lint LarkGeckoTTNet.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkGeckoTTNet'
  s.version = '5.31.0.5452567'
  ...
  # s.resource_bundles = {
  #     'LarkGeckoTTNet' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkGeckoTTNetAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
