...
#
# Be sure to run `pod lib lint LarkRustClientAssembly.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.if_pod 'AWEAnywhereArena' do |cs|
      cs.dependency 'AWEAnywhereArena'
  end
  s.if_pod 'LarkPushTokenUploader' do |ss|
    ss.dependency 'LarkPushTokenUploader'
  end
end
