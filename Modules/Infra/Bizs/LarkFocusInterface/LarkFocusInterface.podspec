...
#
# Be sure to run `pod lib lint LarkFocusInterface.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkFocusInterface' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkFocusInterfaceAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
