...
#
# Be sure to run `pod lib lint CTADialog.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.subspec 'Resources' do |cs|
    cs.source_files = 'src/{Icon,configurations}/**/*.{swift,h,m}'
    cs.resource_bundles = {
      'CTADialog' => ['resources/*.lproj/*' 'resources/*'] ,
      'CTADialogAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*']
    }
  ...
  s.subspec 'Core' do |cs|
    ...
    cs.dependency "CTADialog/Resources"
