...
#
# Be sure to run `pod lib lint LarkSceneManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |sub|
    ...
    sub.source_files = 'src/{Core,configurations}/**/*.{swift}'
  end
  
  s.subspec 'Extensions' do |sub|
    sub.dependency 'LarkKeyCommandKit/Core'
    sub.dependency 'LarkKeyCommandKit/Extensions'
    sub.dependency 'SnapKit'
    sub.dependency 'LarkBlur'
    sub.dependency 'UniverseDesignColor'
    sub.source_files = 'src/Extensions/**/*.{swift}'
    sub.resource_bundles = {
        'LarkSceneManager' => ['resources/*.lproj/*', 'resources/*'],
        'LarkSceneManagerAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
    }
  end
