...
#
# Be sure to run `pod lib lint LarkOuterTest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'LarkOuterTest' => ['resources/*.lproj/*', 'resources/*'],
      'LarkOuterTestAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
