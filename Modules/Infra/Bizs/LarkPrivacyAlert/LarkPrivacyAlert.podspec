...
#
# Be sure to run `pod lib lint LarkPrivacyAlert.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'LarkPrivacyAlert' => ['resources/*.lproj/*' 'resources/*'] ,
      'LarkPrivacyAlertAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*']
  }
  ...
  s.dependency 'LarkPrivacyMonitor'
  s.dependency 'LarkLaunchGuide'
