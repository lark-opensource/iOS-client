//
//  LarkPrivacyWebViewController.swift
//  LarkPrivacyAlert
//
...
final class LarkPrivacyWebViewController: BaseUIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    private lazy var closeItem: UIBarButtonItem = {
        let closeItem = LKBarButtonItem(image: Resources.navigation_close_light)
