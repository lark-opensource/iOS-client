...
{
"keys":{
"Lark_Security_SealCertificationImported":{
"hash":"m6M",
"#vars":1,
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.ZeroTrustAutoBundle, moduleName: "ZeroTrust", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.ZeroTrustAutoBundle, moduleName: "ZeroTrust", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class ZeroTrust {
        @inlinable
        static var __Lark_Security_SealCertificationImported: String {
            return LocalizedString(key: "m6M", originalKey: "Lark_Security_SealCertificationImported")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        static func Lark_Security_SealCertificationImported(lang __lang: Lang? = nil) -> String {
            var template = LocalizedString(key: "m6M", originalKey: "Lark_Security_SealCertificationImported", lang: __lang)
