...
#
# Be sure to run `pod lib lint LarkSettingsBundle.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkSettingsBundle' => ['resources/*.lproj/*' 'resources/*'] ,
  #     'LarkSettingsBundleAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*']
  # }
