...
#
# Be sure to run `pod lib lint TangramService.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'TangramService'
  s.version = '5.31.0.5479096'
  s.summary          = 'URL InlinePreview & PreviewCard集成'
  s.description      = 'URL InlinePreview & PreviewCard集成'
  ...
  s.resource_bundles = {
    'TangramService' => ['resources/*.lproj/*', 'resources/*'],
    'TangramServiceAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
  s.dependency 'RustPB'
