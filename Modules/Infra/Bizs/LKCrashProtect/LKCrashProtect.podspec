...
#
# Be sure to run `pod lib lint LKCrashProtect.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LKCrashProtect' => ['resources/*.lproj/*' 'resources/*'] ,
  #     'LKCrashProtectAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
