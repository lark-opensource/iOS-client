...
#
# Be sure to run `pod lib lint LarkTourInterface.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkTourInterface' => ['resources/*'] ,
  #     'LarkTourInterfaceAuto' => 'auto_resources/*'
  # }
