Pod::Spec.new do |s|
  ...
  s.summary          = 'UD Mention组件'
  s.description      = 'UD Mention组件'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "xiexufeng": 'xiexufeng@bytedance.com'
  }
  ...
  s.subspec 'Resources' do |ss|
    ss.resource_bundles = {
      'LarkMention' => ['resources/*.lproj/*', 'resources/*'],
      'LarkMentionAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
    }
  end
  ...
  s.subspec 'Provider' do |ss|
    ss.source_files = 'src/Provider/**/*.{swift,h,m}'
  ...
  s.subspec 'Util' do |ss|
    ...
    ss.dependency 'LarkMention/Model'
  end
  
  s.subspec 'View' do |ss|
    ss.source_files = 'src/{View,Model,configurations}/**/*.{swift,h,m}'
    ...
    ss.dependency 'LarkMention/Model'
    ss.dependency 'LarkMention/Util'
    ss.dependency 'LarkMention/Resources'
  end
  
  s.subspec 'Model' do |ss|
    ss.source_files = 'src/Model/**/*.{swift,h,m}'
  end
