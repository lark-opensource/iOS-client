...
#
# Be sure to run `pod lib lint LarkMinimumMode.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkMinimumMode'
  s.version = '5.30.0.5410491'
  s.summary          = '飞书基本功能模式相关逻辑'
  ...
  s.resource_bundles = {
      'LarkMinimumMode' => ['resources/*.lproj/*', 'resources/*'],
      'LarkMinimumModeAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
