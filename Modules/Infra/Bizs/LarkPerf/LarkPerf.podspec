...
#
# Be sure to run `pod lib lint LarkPerf.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files = 'src/**/*.{swift,h,m,cpp}'
  s.library = 'c++'
  s.xcconfig = {
  ...
  s.dependency 'Heimdallr/HMDLaunchOptimizer'
