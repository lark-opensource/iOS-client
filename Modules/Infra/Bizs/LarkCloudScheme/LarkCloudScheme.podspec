...
#
# Be sure to run `pod lib lint LarkCloudScheme.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkCloudScheme'
  s.version = '5.30.0.5410491'
  s.summary          = 'Lark云控scheme组件'
  s.description      = 'Lark云控scheme组件'
  ...
  s.resource_bundles = {
      'LarkCloudScheme' => ['resources/*.lproj/*', 'resources/*'],
      'LarkCloudSchemeAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*']
  }
