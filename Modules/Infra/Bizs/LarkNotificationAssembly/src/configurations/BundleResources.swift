...
final class BundleResources {
    private static func image(named: String) -> UIImage {
        return UIImage(named: named, in: BundleConfig.LarkNotificationAssemblyBundle, compatibleWith: nil) ?? UIImage()
    }
    /*
    ...
    */
    final class LarkNotificationAssembly {
        static let placeholder_avatar = BundleResources.image(named: "avatar")
    }
}
