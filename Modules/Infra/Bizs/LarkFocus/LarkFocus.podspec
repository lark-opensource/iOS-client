...
#
# Be sure to run `pod lib lint LarkFocus.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'LarkFocus' => ['resources/*.lproj/*', 'resources/*'],
      'LarkFocusAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
