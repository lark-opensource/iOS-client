...
final class FocusEditController: BaseUIViewController, UserResolverWrapper {
    ...
    private lazy var focusStatusDescCell = FocusStatusDescCell(userResolver: userResolver)
    ...
    private lazy var tableView: UITableView = {
        ...
        table.register(cellWithClass: FocusStatusDescCell.self)
    ...
    override func viewDidLoad() {
        ...
        focusStatusDescCell.onEditing = { [weak self] in
            guard let self = self else { return }
            self.focusTitleCell.resignFirstResponder()
        }
    ...
    private func didTapUpdateButton() {
        ...
        guard focusStatusDescCell.currentTextCount <= 400 else {
            UDToast.autoDismissWarning(BundleI18n.LarkFocus.Lark_Profile_StatusNoteTooLong_Toast, on: view)
            return
        }
        ...
        if let richText = focusStatusDescCell.getFocusStatusDescRichText() {
            changedFocusStatus.statusDesc.richText = richText
        } else {
            changedFocusStatus.clearStatusDesc()
        }
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        var sectionCount: Int = 3   // 头部、状态说明、消息通知
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            return cell
        case 1:
            let cell = self.focusStatusDescCell
            cell.baseViewController = self
            cell.setFocusStatusDesc(with: changedFocusStatus.statusDesc)
            return cell
        // 开启通知静音
        case 2:
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        switch section {
        case 1:
            header.title = BundleI18n.LarkFocus.Lark_Profile_StatusNote_Title
        case 2:
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 3, changedFocusStatus.canEdit {
            // 删除
...
extension FocusEditController: UITableViewDataSource, UITableViewDelegate {
}

@available(iOS 13, *)
extension FocusEditController: UIAdaptivePresentationControllerDelegate {
