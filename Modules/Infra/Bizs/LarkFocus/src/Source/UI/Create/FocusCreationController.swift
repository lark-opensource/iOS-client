...
public final class FocusCreationController: BaseUIViewController, UserResolverWrapper {
    ...
    private func makeNewFocusStatus() -> UserFocusStatus {
        ...
        focus.statusDesc = RustPB.Basic_V1_StatusDesc()
        focus.type = .custom
        return focus
    }
    ...
    public override func viewDidLoad() {
        ...
        focusTitleCell.onEditing = { [weak self] in
            ...
            self.focusStatusDescCell.resignFirstResponder()
    ...
    private func didTapSaveButton() {
        ...
        // 名称不能为空, 状态说明不超过 400 字符，英文数字为 1，中文为 2
        ...
        if var richText = focusStatusDescCell.getFocusStatusDescRichText() {
    ...
    private func didTapCancelButton() {
        focusTitleCell.resignFirstResponder()
        focusStatusDescCell.resignFirstResponder()
...
extension FocusCreationController: UITableViewDataSource, UITableViewDelegate {
}

@available(iOS 13, *)
extension FocusCreationController: UIAdaptivePresentationControllerDelegate {
