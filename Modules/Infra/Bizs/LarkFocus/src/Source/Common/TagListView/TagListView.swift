...
public protocol TagListViewDelegate {
    ...
    @objc
    optional func tagListView(_ tagListView: TagListView, didSelectTag tagView: TagView, atIndex index: Int)

    /// Inform the delegate that the tag remove button has been tapped.
    @objc
    optional func tagListView(_ tagListView: TagListView, didTapAccessoryButtonForTag tagView: TagView, atIndex index: Int)
}
...
open class TagListView: UIView {
    ...
    private func rearrangeViews() {
        ...
        var currentRow = 0
        var currentRowView: UIView = .init()
    ...
    @discardableResult
    public func addTag(icon: UIImage, title: String, spacing: CGFloat, iconSize: CGFloat, code: Int = 0) -> TagView {
        defer { rearrangeViews() }
    ...
    @discardableResult
    public func addTag(_ title: String, textColor: UIColor? = nil, backgroundColor: UIColor? = nil) -> TagView {
        defer { rearrangeViews() }
        let tagView = createNewTagView(title)
    ...
    public func contains(_ tagView: TagView) -> Bool {
    ...
    func removeButtonPressed(_ closeButton: CloseButton!) {
        if let tagView = closeButton.tagView {
            ...
            delegate?.tagListView?(self, didTapAccessoryButtonForTag: tagView, atIndex: index)
        }
    }
}
