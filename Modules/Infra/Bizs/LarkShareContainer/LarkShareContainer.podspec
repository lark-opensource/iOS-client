...
#
# Be sure to run `pod lib lint LarkShareContainer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkShareContainer'
  s.version = '5.30.0.5410491'
  s.summary          = '分享容器组件'
  s.description      = '分享特定链接、二维码、消息卡片的容器组件'
  ...
  s.resource_bundles = {
      'LarkShareContainer' => ['resources/*.lproj/*', 'resources/*'],
      'LarkShareContainerAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
