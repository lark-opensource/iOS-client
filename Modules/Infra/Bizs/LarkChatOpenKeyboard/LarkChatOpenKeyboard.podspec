...
#
# Be sure to run `pod lib lint LarkChatOpenKeyboard.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkChatOpenKeyboard' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkChatOpenKeyboardAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
