...
#
# Be sure to run `pod lib lint BootManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files = 'src/**/*.{swift,plist,m,h}'
  # s.resource_bundles = {
  #     'BootManager' => ['resources/*.lproj/*' 'resources/*'] ,
  #     'BootManagerAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
  ...
  s.dependency 'BootManagerConfig'
