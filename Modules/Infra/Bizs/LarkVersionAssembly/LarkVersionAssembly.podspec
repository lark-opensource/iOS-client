...
#
# Be sure to run `pod lib lint LarkVersionAssembly.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkVersionAssembly'
  s.version          = '0.1.0-alpha.0'
  s.summary          = 'Lark Version Aseembly'
  s.description      = 'Lark Version Aseembly'
