...
#
# Be sure to run `pod lib lint LarkOpenChat.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.authors = {
    ...
    "liyong": 'liyong.520@bytedance.com'
  }
  ...
  # s.resource_bundles = {
  #     'LarkOpenChat' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkOpenChatAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
