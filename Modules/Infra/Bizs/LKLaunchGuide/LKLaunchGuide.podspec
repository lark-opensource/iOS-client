...
#
# Be sure to run `pod lib lint LKLaunchGuide.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LKLaunchGuide'
  s.version = '5.31.0.5450560'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "quyiming": 'quyiming@bytedance.com',
    "wangmiaoqi": 'wangmiaoqi@bytedance.com',
  ...
  s.subspec 'Main' do |cs|
    cs.source_files = 'src/{Public,Source}/*.{swift}'
  ...
  s.subspec 'View' do |cs|
    cs.source_files = 'src/{View,configurations}/*.{swift}'
    cs.resource_bundles = {
        'LKLaunchGuide' => ['resources/*'] ,
        'LKLaunchGuideAuto' => 'auto_resources/*'
    }
