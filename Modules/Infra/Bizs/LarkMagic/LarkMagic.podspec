...
#
# Be sure to run `pod lib lint LarkMagic.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkMagic' => ['resources/*.lproj/*' 'resources/*'] ,
  #     'LarkMagicAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
