...
import Foundation
public final class ChatTagViewBuilder: TagViewBuilder {

    /// Chat 标签互斥约束
    public override var mutexTags: [[TagType]] {
        return customMutexTags ??
        [
            [.officialOncall, .relation, .connect, .organization, .external, .public],
    ...
    /// 互通
    public func isConnect(_ value: Bool) -> Self {
