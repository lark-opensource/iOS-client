...
{
"keys":{
"Lark_Core_AdminSettingNoGPSPermission_Toast":{
"hash":"xXI",
"#vars":0
}
},
"name":"LarkPrivacySetting",
"short_key":true,
"config":{
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkPrivacySettingAutoBundle, moduleName: "LarkPrivacySetting", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkPrivacySettingAutoBundle, moduleName: "LarkPrivacySetting", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class LarkPrivacySetting {
        @inlinable
        static var Lark_Core_AdminSettingNoGPSPermission_Toast: String {
            return LocalizedString(key: "xXI", originalKey: "Lark_Core_AdminSettingNoGPSPermission_Toast")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Core_AdminSettingNoGPSPermission_Toast(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "xXI", originalKey: "Lark_Core_AdminSettingNoGPSPermission_Toast", lang: __lang)
        }
    }
}
