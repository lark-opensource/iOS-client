...
#
# Be sure to run `pod lib lint CookieManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'CookieManager' => ['resources/*.lproj/*', 'resources/*'],
  #     'CookieManagerAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
