...
#
# Be sure to run `pod lib lint LarkEnterpriseNotice.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkEnterpriseNotice'
  s.version          = '0.1.0-alpha.0'
  s.summary          = 'Required. 企业通知卡片'
  ...
  s.resource_bundles = {
       'LarkEnterpriseNotice' => ['resources/*.lproj/*', 'resources/*'],
       'LarkEnterpriseNoticeAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
