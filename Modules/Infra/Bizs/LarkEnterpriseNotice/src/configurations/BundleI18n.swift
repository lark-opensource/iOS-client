...
{
"keys":{
"Lark_IM_SurveyPopup_Close_Button":{
"hash":"cn0",
"#vars":0
}
},
"name":"LarkEnterpriseNotice",
"short_key":true,
"config":{
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkEnterpriseNoticeAutoBundle, moduleName: "LarkEnterpriseNotice", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkEnterpriseNoticeAutoBundle, moduleName: "LarkEnterpriseNotice", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class LarkEnterpriseNotice {
        @inlinable
        static var Lark_IM_SurveyPopup_Close_Button: String {
            return LocalizedString(key: "cn0", originalKey: "Lark_IM_SurveyPopup_Close_Button")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_IM_SurveyPopup_Close_Button(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "cn0", originalKey: "Lark_IM_SurveyPopup_Close_Button", lang: __lang)
        }
    }
}
