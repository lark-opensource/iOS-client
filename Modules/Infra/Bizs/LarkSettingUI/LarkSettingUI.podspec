...
#
# Be sure to run `pod lib lint LarkSettingUI.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkSettingUI'
  s.version = '5.27.0.5295515'
  ...
  # s.resource_bundles = {
  #     'LarkSettingUI' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkSettingUIAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
