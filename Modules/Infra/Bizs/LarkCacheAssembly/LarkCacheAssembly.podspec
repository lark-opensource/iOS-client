...
#
# Be sure to run `pod lib lint LarkCacheAssembly.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.dependency 'LarkCache/Core'
  s.dependency 'LarkCache/CryptoRustImpl'
