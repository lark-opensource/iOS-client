...
#
# Be sure to run `pod lib lint LarkOpenSetting.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkOpenSetting'
  s.version = '5.31.0.5482869'
  ...
  # s.resource_bundles = {
  #     'LarkOpenSetting' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkOpenSettingAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
  ...
  s.subspec 'Interface' do |sub|
    sub.source_files = ['src/Source/Interface/**/*.{swift}']
    sub.dependency 'EENavigator'
  end

  s.subspec 'Core' do |sub|
    sub.source_files = ['src/Source/Core/**/*.{swift}', 'src/Source/Interface/**/*.{swift}']
    ...
    sub.dependency 'LarkSettingUI'
    sub.dependency 'LarkContainer'
    sub.dependency 'LarkNavigator'
  end
