...
#
# Be sure to run `pod lib lint LarkWidgetService.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkWidgetService'
  s.version          = '1.1.4'
  s.summary          = 'Smart Widget中网络接口层、数据服务层等'
  s.description      = 'Smart Widget中网络接口层、数据服务层等'
  ...
  # s.resource_bundles = {
  #     'LarkWidgetService' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkWidgetServiceAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
