...
#
# Be sure to run `pod lib lint LarkTraceId.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkTraceId' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkTraceIdAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
