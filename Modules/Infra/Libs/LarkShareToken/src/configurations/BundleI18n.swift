...
{
"keys":{
"Lark_Chat_TokenExpiredTitle":{
"hash":"VXw",
"#vars":0
},
"Lark_Chat_TokenGotIt":{
"hash":"r0c",
"#vars":0
}
},
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkShareTokenAutoBundle, moduleName: "LarkShareToken", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkShareTokenAutoBundle, moduleName: "LarkShareToken", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class LarkShareToken {
        @inlinable
        static var Lark_Chat_TokenExpiredTitle: String {
            return LocalizedString(key: "VXw", originalKey: "Lark_Chat_TokenExpiredTitle")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Chat_TokenExpiredTitle(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "VXw", originalKey: "Lark_Chat_TokenExpiredTitle", lang: __lang)
        }
        @inlinable
        static var Lark_Chat_TokenGotIt: String {
            return LocalizedString(key: "r0c", originalKey: "Lark_Chat_TokenGotIt")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Chat_TokenGotIt(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "r0c", originalKey: "Lark_Chat_TokenGotIt", lang: __lang)
        }
    }
}
