...
{
"keys":{
"Lark_Core_LowBatteryTurnOnDarkMode_Toast":{
"hash":"fZM",
"#vars":1,
"normal_vars":["APP_DISPLAY_NAME"]
}
},
"name":"LarkDowngradeDependency",
"short_key":true,
"config":{
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkDowngradeDependencyAutoBundle, moduleName: "LarkDowngradeDependency", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkDowngradeDependencyAutoBundle, moduleName: "LarkDowngradeDependency", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class LarkDowngradeDependency {
        @inlinable
        static var __Lark_Core_LowBatteryTurnOnDarkMode_Toast: String {
            return LocalizedString(key: "fZM", originalKey: "Lark_Core_LowBatteryTurnOnDarkMode_Toast")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        static func Lark_Core_LowBatteryTurnOnDarkMode_Toast(lang __lang: Lang? = nil) -> String {
            var template = LocalizedString(key: "fZM", originalKey: "Lark_Core_LowBatteryTurnOnDarkMode_Toast", lang: __lang)
