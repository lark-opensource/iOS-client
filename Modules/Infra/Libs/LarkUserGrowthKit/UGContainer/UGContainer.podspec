...
#
# Be sure to run `pod lib lint UGContainer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'UGContainer' => ['resources/*.lproj/*', 'resources/*'],
  #     'UGContainerAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
