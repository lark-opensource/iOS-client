...
#
# Be sure to run `pod lib lint UGCoordinator.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "zhenning": 'maozhenning@bytedance.com'
  }
  ...
  s.resource_bundles = {
      'UGCoordinator' => ['resources/*.lproj/*', 'resources/*'],
      'UGCoordinatorAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
