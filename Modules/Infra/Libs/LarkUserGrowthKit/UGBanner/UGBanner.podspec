...
#
# Be sure to run `pod lib lint UGBanner.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'UGBanner' => ['resources/*.lproj/*', 'resources/*'],
  #     'UGBannerAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
