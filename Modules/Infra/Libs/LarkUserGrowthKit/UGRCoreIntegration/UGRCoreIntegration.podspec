...
#
# Be sure to run `pod lib lint UGRCoreIntegration.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'UGRCoreIntegration'
  s.version = '5.28.0.5342678'
  s.summary          = 'UG 触达中台逻辑集成模块'
  s.description      = 'UG 触达中台逻辑集成模块，负责调度各个核心模块的功能流转'
  ...
  # s.resource_bundles = {
  #     'UGRCoreIntegration' => ['resources/*.lproj/*', 'resources/*'],
  #     'UGRCoreIntegrationAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
