...
#
# Be sure to run `pod lib lint UGSpotlight.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'UGSpotlight' => ['resources/*.lproj/*', 'resources/*'],
  #     'UGSpotlightAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
