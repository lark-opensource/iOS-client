...
{
"keys":{
"Lark_Legacy_Windowboxhint":{
"hash":"7fQ",
"#vars":0
},
"Lark_Legacy_iPadShortcutsNewline":{
"hash":"CzY",
"#vars":0
}
},
"name":"LarkKeyboardView",
"short_key":true,
"config":{
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkKeyboardViewAutoBundle, moduleName: "LarkKeyboardView", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkKeyboardViewAutoBundle, moduleName: "LarkKeyboardView", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class LarkKeyboardView {
        @inlinable
        static var Lark_Legacy_Windowboxhint: String {
            return LocalizedString(key: "7fQ", originalKey: "Lark_Legacy_Windowboxhint")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Legacy_Windowboxhint(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "7fQ", originalKey: "Lark_Legacy_Windowboxhint", lang: __lang)
        }
        @inlinable
        static var Lark_Legacy_iPadShortcutsNewline: String {
            return LocalizedString(key: "CzY", originalKey: "Lark_Legacy_iPadShortcutsNewline")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Legacy_iPadShortcutsNewline(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "CzY", originalKey: "Lark_Legacy_iPadShortcutsNewline", lang: __lang)
        }
    }
}
