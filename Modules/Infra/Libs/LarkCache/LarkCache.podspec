...
#
# Be sure to run `pod lib lint LarkCache.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'LarkFileKit'
    sp.dependency 'LarkStorage'
    sp.dependency 'LarkDebugExtensionPoint'
    sp.dependency 'EEAtomic'
    sp.dependency 'RxSwift'

    sp.source_files = 'src/Core/**/*.{swift}'
  end

  s.subspec 'CryptoRustImpl' do |sp|
    sp.dependency 'LarkFileKit'
    sp.dependency 'LarkRustClient/Interface'
    sp.dependency 'Homeric'
    sp.dependency 'LKCommonsLogging'

    sp.source_files = 'src/CryptoRustImpl/**/*.{swift}'
  end
