...
{
"keys":{
"Lark_Meetings_ClearAllCard_Button":{
"hash":"5Eo",
"#vars":0
},
"Lark_Meetings_ShowLessCard_Button":{
"hash":"mgI",
"#vars":0
}
},
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkPushCardAutoBundle, moduleName: "LarkPushCard", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkPushCardAutoBundle, moduleName: "LarkPushCard", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class LarkPushCard {
        @inlinable
        static var Lark_Meetings_ClearAllCard_Button: String {
            return LocalizedString(key: "5Eo", originalKey: "Lark_Meetings_ClearAllCard_Button")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Meetings_ClearAllCard_Button(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "5Eo", originalKey: "Lark_Meetings_ClearAllCard_Button", lang: __lang)
        }
        @inlinable
        static var Lark_Meetings_ShowLessCard_Button: String {
            return LocalizedString(key: "mgI", originalKey: "Lark_Meetings_ShowLessCard_Button")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Meetings_ShowLessCard_Button(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "mgI", originalKey: "Lark_Meetings_ShowLessCard_Button", lang: __lang)
        }
    }
}
