...
#
# Be sure to run `pod lib lint LarkPushCard.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'LarkPushCard' => ['resources/*.lproj/*', 'resources/*'],
      'LarkPushCardAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
