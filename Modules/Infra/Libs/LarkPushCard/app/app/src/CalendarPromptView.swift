...
class CalendarPromptView: UIView {
    ...
    private lazy var iconView: UIView = {
        let icon = UIView()
        icon.backgroundColor = UIColor.ud.udtokenTagBgGreen
    ...
    private lazy var invitationLabel: UILabel = {
        ...
        label.font = .systemFont(ofSize: 12, weight: UIFont.Weight.regular)
        label.textColor = UIColor.ud.textCaption
        label.text = Texts.invitationLabel
        label.textAlignment = .natural
        label.lineBreakMode = .byTruncatingTail
...
//        label.setContentHuggingPriority(UILayoutPriority(rawValue: 251), for: .horizontal)
    ...
    private lazy var confirmButton: UIButton = {
        ...
        button.titleLabel?.lineBreakMode = .byTruncatingMiddle
        button.titleLabel?.font = .systemFont(ofSize: 16, weight: UIFont.Weight.regular)
        button.setTitle("参加会议", for: .normal)
        button.setTitleColor(UIColor.ud.staticWhite, for: .normal)
        button.backgroundColor = UIColor.ud.functionSuccess500
        button.layer.cornerRadius = Layout.buttonRadius
        button.clipsToBounds = true
    ...
    private lazy var descriptionLabel: UILabel = {
        ...
        label.lineBreakMode = .byTruncatingTail
        label.textAlignment = .left
        label.text = Texts.descriptionLabel
        return label
    }()
    ...
    private lazy var tipsInfo: UIView = { //warningView的内部封装
        ...
        iconWarningImageView.snp.makeConstraints { (maker) in
            ...
            maker.centerY.equalTo(descriptionLabel)
        }
    ...
    private lazy var warningView: UIView = { // 最下面的黄色视图部分
        let v = UIView()
        v.backgroundColor = UIColor.ud.functionWarning500
    ...
    private func initialize() {
        ...
        setTopic(Texts.topicLabel)
        layoutWarningViews()
    }

    private func setTopic(_ topic: String) {
        topicLabel.attributedText = NSAttributedString(string: topic)
    }
...
enum Texts {
    static var inviterLabel: String {
        "inviterLabelinviterLabelinviterLabelinviterLabelinviterLabelinviterLabelinviterLabelinviterLabelLabelinviterLabelLabelinviterLabel"
    }
    static var invitationLabel: String { "invitationLabelinvitationLabelinvitationLabelinvitationLabelinvitationLabelinvitationLabelinvitationLabelinvitationLabelinvitationLabel"
    }

    static var roleLabel: String {
        "sdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsssss"
    }

    static var topicLabel: String {
        "topicLassssssssssstopicLassssssssssstopicLassssssssssstopicLassssssssssstopicLassssssssssstopicLasssssssssss"
    }

    static var descriptionLabel: String {
        "sdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdddddddd"
    }
}
