...
#
# Be sure to run `pod lib lint LarkOCR.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.summary          = 'Lark OCR 组件'
  s.description      = 'Lark OCR 组件'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "name": 'lichen.arthur@bytedance.com'
  }
  ...
  s.resource_bundles = {
      'LarkOCR' => ['resources/*.lproj/*', 'resources/*'],
      'LarkOCRAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
