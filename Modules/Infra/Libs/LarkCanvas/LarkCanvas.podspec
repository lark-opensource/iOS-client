...
#
# Be sure to run `pod lib lint LarkCanvas.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.summary          = '基于 PencilKit 的画板'
  s.description      = '基于 PencilKit 的画板，对业务方提供简单的画板和工具'
  s.homepage         = 'https://code.byted.org/lark/ios-infra/tree/develop/Libs/LarkCanvas'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "黄浩庭": 'huanghaoting@bytedance.com'
  }
  ...
  s.resource_bundles = {
      'LarkCanvas' => ['resources/*.lproj/*', 'resources/*'],
      'LarkCanvasAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
  ...
  s.dependency 'LarkKeyCommandKit/Extensions'
