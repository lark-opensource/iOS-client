...
#
# Be sure to run `pod lib lint OfflineResourceManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'OfflineResourceManager'
  s.version = '5.31.0.5449536'
  ...
  # Gecko 中依赖，但是 Gecko 没加，先加上解决编译问题
  s.frameworks = 'SystemConfiguration'

  # s.dependency 'AFNetworking', '~> 2.3'
  s.dependency 'IESGeckoKit/Core'
