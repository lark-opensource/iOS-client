...
@property (nonatomic, assign) BOOL isDatabaseMalformed;
...
/// Get file information from DB with file name
/// @param fileName file name
/// @return item associate with file name, will return null when no associated file information stored in DB, or the file does not exit
