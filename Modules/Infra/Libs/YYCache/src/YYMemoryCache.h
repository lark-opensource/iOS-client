...
/**
 ...
 @param anObject If the cached object is the exceptObject, return 'NO'.
 @return Whether the key is in cache.
 */
- (BOOL)containsObjectForKey:(id)key exceptObject:(id)anObject;
...
/**
  New feature, provide trim to mark point function, to extend the original LRU logic design.
 */
- (void)mark;
- (void)trimToMark;
