...
- (nullable instancetype)initWithPath:(NSString *)path inlineThreshold:(NSUInteger)inlineThreshold needAutoTrim:(BOOL)needAutoTrim;

- (nullable instancetype)initWithDiskCache: (YYDiskCache *)diskCache NS_DESIGNATED_INITIALIZER;
