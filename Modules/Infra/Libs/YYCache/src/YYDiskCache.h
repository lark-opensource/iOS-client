...
FOUNDATION_EXPORT NSNotificationName const YYDiskCacheDidRemoveAllAfterCorruptedNotification; // {"path":"directory path of cache files"}

FOUNDATION_EXPORT NSNotificationName const YYDiskCacheWillTrimWALNotification;
...
/**
 The maximum size of wal file.

 @discussion The default value is 20*1024*1024 byte. The checkpoint begins when app enters background and post YYDiskCacheWillTrimWALNotification.
 */
...
- (nullable instancetype)initWithPath:(NSString *)path
                      inlineThreshold:(NSUInteger)threshold
                         needAutoTrim:(BOOL)needAutoTrim NS_DESIGNATED_INITIALIZER;
...
/// Save file infromation ( filename, filesize, last access time) to DB
/// @param fileName  file name
/// @param size file size
/// @param data extra data assicated with file
/// @return whether save sucess, will return false if file not exist
- (BOOL)saveFileWith:(NSString*)key fileName:(NSString*)fileName size:(int)size extendData:(nullable NSData*)data;

/// Get file storeage item with file name
/// @param fileName file name
- (nullable YYKVStorageItem*)storageItem:(NSString*)fileName;

/// Remove file and delete file information in DB
/// @param fileName file name
