...
#
# Be sure to run `pod lib lint LarkOrientation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkOrientation'
  s.version          = "0.21.0"
  s.summary          = '处理 ViewController 默认方向问题'
  s.description      = '处理 ViewController 默认方向问题'
