...
#
# Be sure to run `pod lib lint LarkInteraction.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkInteraction'
  s.version          = '0.19.0'
  s.summary          = 'Lark Interaction 交互封装库'
  s.description      = 'Lark Interaction 交互封装库'
