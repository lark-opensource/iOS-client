...
#
# Be sure to run `pod lib lint LarkQuickLaunchBar.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkQuickLaunchBar' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkQuickLaunchBarAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
