...
"name":"LarkNotificationContentExtension",
"short_key":true,
"config":{
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkNotificationContentExtensionAutoBundle, moduleName: "LarkNotificationContentExtension", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkNotificationContentExtensionAutoBundle, moduleName: "LarkNotificationContentExtension", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class LarkNotificationContentExtension {
        @inlinable
        static var Emoji_OK: String {
            return LocalizedString(key: "FjA", originalKey: "Emoji_OK")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Emoji_OK(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "FjA", originalKey: "Emoji_OK", lang: __lang)
        }
        @inlinable
