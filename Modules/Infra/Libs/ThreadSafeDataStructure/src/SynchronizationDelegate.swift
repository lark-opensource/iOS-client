...
public enum SynchronizationType {
    ...
    public func generateSynchronizationDelegate() -> SynchronizationDelegate {
        switch self {
...
public protocol SynchronizationDelegate: AnyObject {
...
final class ReadWriteLock: SynchronizationDelegate {
...
final class Semaphore: SynchronizationDelegate {
...
final class ConcurrentQueue: SynchronizationDelegate {
...
final class UnfairLock: SynchronizationDelegate {
...
final class RecursiveLock: SynchronizationDelegate {
