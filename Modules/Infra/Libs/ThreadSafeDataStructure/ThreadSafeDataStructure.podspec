...
#
# Be sure to run `pod lib lint ThreadSafeDataStructure.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'ThreadSafeDataStructure'
...
#  s.resource_bundles = {
#      'ThreadSafeDataStructure' => ['resources/*'] ,
#      'ThreadSafeDataStructureAuto' => 'auto_resources/*'
#  }
