...
//  LarkThread
//
//  Created by lizhiqiang on 2019/9/14.
//
//  获取图片主色调使用了 MMCQ (modified median cut quantization) algorithm 来自the Leptonica library 的实现（知名图片处理库）。
//
...
//  refrece
//  ------
//  Lokesh Dhakar - for the original Color Thief JavaScript version MIT
//  http://lokeshdhakar.com/projects/color-thief/
//  Sven Woltmann - for the fast Java Implementation MIT
//  https://github.com/SvenWoltmann/color-thief-java
//  Kazuki Ohara - Grabs the dominant color or a representative color palette from an image MIT
...
open class MMCQ {
    ...
    public struct Color {
        ...
        public func makeColor() -> UIColor {
            return UIColor.ud.color(CGFloat(r) / CGFloat(255), CGFloat(g) / CGFloat(255), CGFloat(b) / CGFloat(255), CGFloat(1))
        }
    }
