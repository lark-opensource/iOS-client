...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkDatePickerView'
  s.version = '5.30.0.5410491'
  s.summary          = '日期选择器'
  s.homepage         = 'git.byted.org:29418/ee/ios-infra/Libs/LarkDatePickerView'
  ...
  s.resource_bundles = {
      'LarkDatePickerView' => ['resources/*'] ,
      'LarkDatePickerViewAuto' => 'auto_resources/*'
  }
