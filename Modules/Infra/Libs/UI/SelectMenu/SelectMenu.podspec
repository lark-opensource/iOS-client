...
#
# Be sure to run `pod lib lint SelectMenu.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.summary          = '文本选择控件'
  s.homepage         = 'git.byted.org:29418/ee/ios-infra/Libs/SelectMenu'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "Songwen": 'dingsongwen@bytedance.com'
  }
  ...
  s.resource_bundles = {
      'SelectMenu' => ['resources/*'] ,
      'SelectMenuAuto' => 'auto_resources/*'
  }
