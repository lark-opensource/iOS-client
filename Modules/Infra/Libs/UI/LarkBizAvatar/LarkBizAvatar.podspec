...
#
# Be sure to run `pod lib lint LarkBizAvatar.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'LarkBizAvatar' => ['resources/*'] ,
      'LarkBizAvatarAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
  ...
  s.dependency 'LarkAvatarComponent'
