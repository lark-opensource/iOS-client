...
#
# Be sure to run `pod lib lint LarkAvatarComponent.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkAvatarComponent' => ['resources/*.lproj/*' 'resources/*'] ,
  #     'LarkAvatarComponentAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
