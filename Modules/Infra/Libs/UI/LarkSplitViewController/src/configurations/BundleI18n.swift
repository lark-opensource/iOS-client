...
"Lark_Settings_ShortcutsEnterExitFullScreen":{
"hash":"Fak",
"#vars":0
}
},
"name":"LarkSplitViewController",
"short_key":true,
"config":{
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkSplitViewControllerAutoBundle, moduleName: "LarkSplitViewController", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkSplitViewControllerAutoBundle, moduleName: "LarkSplitViewController", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class LarkSplitViewController {
        @inlinable
        ...
        @inlinable
        static var Lark_Settings_ShortcutsEnterExitFullScreen: String {
            return LocalizedString(key: "Fak", originalKey: "Lark_Settings_ShortcutsEnterExitFullScreen")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_Settings_ShortcutsEnterExitFullScreen(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "Fak", originalKey: "Lark_Settings_ShortcutsEnterExitFullScreen", lang: __lang)
        }
    }
}
