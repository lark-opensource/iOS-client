...
#
# Be sure to run `pod lib lint LarkSplitViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkSplitViewController'
  s.version = '5.31.0.5463996'
  s.summary          = 'Lark 基础 splitVC 组件'
  s.description      = 'Lark 基础 splitVC 组件'
  ...
  s.resource_bundles = {
      'LarkSplitViewController' => ['resources/*'] ,
      'LarkSplitViewControllerAuto' => 'auto_resources/*'
  }
