...
{
"keys":{
"Lark_IM_MessageActionListEnd_Text":{
"hash":"KKs",
"#vars":0
}
},
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkSheetMenuAutoBundle, moduleName: "LarkSheetMenu", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkSheetMenuAutoBundle, moduleName: "LarkSheetMenu", lang: lang) ?? key
            #endif
        }
     ...
     */
    final class LarkSheetMenu {
        @inlinable
        static var Lark_IM_MessageActionListEnd_Text: String {
            return LocalizedString(key: "KKs", originalKey: "Lark_IM_MessageActionListEnd_Text")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_IM_MessageActionListEnd_Text(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "KKs", originalKey: "Lark_IM_MessageActionListEnd_Text", lang: __lang)
        }
    }
}
