 ...
 */
public final class SwipeAction: NSObject {
    ...
    public var handler: ((SwipeAction, IndexPath, Bool) -> Void)?
    ...
    */
    public init(style: SwipeActionStyle, title: String?, handler: ((SwipeAction, IndexPath, Bool) -> Void)?) {
        self.title = title
        self.style = style
