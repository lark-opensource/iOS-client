...
public struct SwipeActionTransitioningContext {
    ...
    internal init(actionIdentifier: String?,
                  button: UIButton,
...
/**
 ...
 As button's percentage visibility crosses the `threshold`, the `ScaleTransition` object will animate from `initialScale` to `identity`.
