...
final class BundleResources {
    ...
    */
    final class AnimatedTabBar {
        static let quick_tab_btn_uneditable = BundleResources.image(named: "quick_tab_btn_uneditable")
        static let quick_tab_empty_placeholder = BundleResources.image(named: "quick_tab_empty_placeholder")
    }
