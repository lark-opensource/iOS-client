...
#
# Be sure to run `pod lib lint LarkGuideUI.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.summary          = '统一引导UI组件'
  s.description      = '详见: https://bytedance.feishu.cn/docs/doccn6DO0XYERW31ohL1s9Pbvec'
  ...
  s.resource_bundles = {
      'LarkGuideUI' => ['resources/*'] ,
      'LarkGuideUIAuto' => 'auto_resources/*'
  }
