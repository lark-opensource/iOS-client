...
#
# Be sure to run `pod lib lint LarkAlertController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'LarkAlertController' => ['resources/*'] ,
      'LarkAlertControllerAuto' => 'auto_resources/*'
  }
