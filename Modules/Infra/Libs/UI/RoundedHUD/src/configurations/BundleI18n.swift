...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.RoundedHUDAutoBundle, moduleName: "RoundedHUD", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.RoundedHUDAutoBundle, moduleName: "RoundedHUD", lang: lang) ?? key
            #endif
        }
