...
final class ZipTests: XCTestCase {
    ...
    // MARK: should not matter when downstream send request while sending value
    ...
    // MARK: should not matter when receive upstream's value while sending value
    ...
    // MARK: should complete after sending value
    ...
    // MARK: should ignore unpaired value
    ...
    // MARK: should buffer for sending when demand resumes
    ...
    // MARK: should zip multiple children
    ...
    // MARK: should immediate finish when one child finishes with no surplus
    ...
    // MARK: should delayed finish when one child finishes with surplus
    ...
    // MARK: should cancel other children after failed
    ...
    // MARK: should not finish when one child finishes with surplus
    ...
    // MARK: should not matter when finish after finished
    ...
    // MARK: should not matter when finish after failed
    ...
    // MARK: should not matter when fail after finished
    ...
    // MARK: should not matter when fail after failed
    ...
    // MARK: should cancel the second subscription
    ...
    // MARK: should crash when return zero demand
