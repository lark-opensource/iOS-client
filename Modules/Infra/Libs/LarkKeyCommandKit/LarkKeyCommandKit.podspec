...
#
# Be sure to run `pod lib lint LarkKeyCommandKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |sub|
    ...
    sub.source_files = 'src/Core/**/*.{swift,h,m}'
  end

  s.subspec 'Extensions' do |sub|
    sub.dependency 'LarkKeyCommandKit/Core'
    sub.source_files = 'src/Extensions/**/*.{swift,h,m}'
  end
