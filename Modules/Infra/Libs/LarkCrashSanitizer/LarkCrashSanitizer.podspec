...
#
# Be sure to run `pod lib lint LarkCrashSanitizer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #  s.resource_bundles = {
  #      'LarkCrashSanitizer' => ['resources/*'] ,
  #      'LarkCrashSanitizerAuto' => 'auto_resources/*'
  #  }
