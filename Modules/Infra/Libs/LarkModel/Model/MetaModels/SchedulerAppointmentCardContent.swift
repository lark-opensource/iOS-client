//
//  SchedulerAppointmentCardContent.swift
//  LarkModel
//
...
// 日历助手 bot 消息
public struct SchedulerAppointmentCardContent: MessageContent {
    ...
    public var pb: AppointmentMessageNotify

    public init(pb: AppointmentMessageNotify) {
        self.pb = pb
    }
    ...
    public var eventLink: String { pb.eventLink }  // Scheduler详情链接
    public var isExternal: Bool { pb.isExternal } // 是否显示外部标签
    ...
    public var cancelReason: Calendar_V1_AppointmentMessageCancelReason { pb.cancelReason }  // 卡片取消原因
