...
#
# Be sure to run `pod lib lint LarkShortcut.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkShortcut' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkShortcutAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
