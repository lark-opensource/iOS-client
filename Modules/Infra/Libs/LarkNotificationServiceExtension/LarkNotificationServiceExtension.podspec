...
#
# Be sure to run `pod lib lint LarkNotificationServiceExtension.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkNotificationServiceExtension'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "name": 'mochangxing@bytedance.com'
  }
  ...
  #  s.resource_bundles = {
  #      'LarkNotificationServiceExtension' => ['resources/*'] ,
  #      'LarkNotificationServiceExtensionAuto' => 'auto_resources/*'
  #  }
