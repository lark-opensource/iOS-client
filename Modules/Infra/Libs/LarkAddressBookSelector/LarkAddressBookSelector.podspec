...
#
# Be sure to run `pod lib lint LarkAddressBookSelector.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkAddressBookSelector'
  s.version = '5.31.0.5463996'
  s.summary          = 'Lark通讯录选择器'
  s.description      = 'Lark通讯录选择器，支持单选多选'
  ...
  s.resource_bundles = {
      'LarkAddressBookSelector' => ['resources/*.lproj/*', 'resources/*'] ,
      'LarkAddressBookSelectorAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
  ...
  s.dependency 'LarkSensitivityControl/API/Contacts'
