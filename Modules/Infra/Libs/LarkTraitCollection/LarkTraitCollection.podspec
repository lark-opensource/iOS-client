...
#
# Be sure to run `pod lib lint LarkTraitCollection.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkTraitCollection'
  s.version          = '0.15.0'
  s.summary          = 'Lark TraitCollection 相关工具库'
  s.description      = 'Lark TraitCollection 相关工具库'
