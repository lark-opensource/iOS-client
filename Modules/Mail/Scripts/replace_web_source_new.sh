...
use_online_web_source(){
    ...
    cp -rf $tmp_tmp_file_tar_dir/$channel/eesz/current_revision eesz
    cp -rf $tmp_tmp_file_tar_dir/$channel/eesz/resource eesz
    cp -rf $tmp_tmp_file_tar_dir/$channel/eesz/template eesz
    cp -rf $tmp_tmp_file_tar_dir/$channel/eesz/rn eesz
