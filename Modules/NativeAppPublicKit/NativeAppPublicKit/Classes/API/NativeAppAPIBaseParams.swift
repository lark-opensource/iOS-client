...
protocol NativeAppAPIBaseParamsArrayType {
    static var elementType: Any.Type { get }
}

extension Array: NativeAppAPIBaseParamsArrayType where Element: NativeAppAPIBaseParams {
...
/// API参数协议
@objc
public protocol NativeAppAPIParamPropertyProtocol: NSObjectProtocol {
...
open class NativeAppAPIBaseParams: NSObject {

    public var checkResults: [[String: String]] = []
    ...
    open var autoCheckProperties: [NativeAppAPIParamPropertyProtocol] {
        return []
    }
}
