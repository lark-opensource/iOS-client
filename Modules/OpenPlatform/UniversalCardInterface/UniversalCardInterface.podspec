...
#
# Be sure to run `pod lib lint UniversalCardInterface.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'UniversalCardInterface' => ['resources/*.lproj/*', 'resources/*'],
  #     'UniversalCardInterfaceAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
