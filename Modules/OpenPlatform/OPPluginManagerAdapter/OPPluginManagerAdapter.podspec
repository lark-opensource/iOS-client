...
#
# Be sure to run `pod lib lint OPPluginManagerAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'OPPluginManagerAdapter' => ['resources/*.lproj/*', 'resources/*'],
  #     'OPPluginManagerAdapterAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
