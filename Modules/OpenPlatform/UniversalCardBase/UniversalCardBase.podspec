...
#
# Be sure to run `pod lib lint UniversalCardBase.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'UniversalCardBase' => ['resources/*'],
      'UniversalCardBaseAuto' => ['auto_resources/*']
  }
