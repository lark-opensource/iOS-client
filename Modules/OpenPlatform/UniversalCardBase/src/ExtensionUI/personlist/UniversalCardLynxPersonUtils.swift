//
//  UniversalCardLynxPersonUtils.swift
//  LarkMessageCard
//
...
extension Person {
    func getContent() -> String {
        return content ?? BundleI18n.UniversalCardBase.OpenPlatform_CardCompt_UnknownUser
    }
}
...
extension LKRichElement {
    ...
    static func parseAvatarListChildrenNode(
        ...
        let listElement = UniversalCardAvatarListElement(
            ...
            moreInfo: MoreInfo(
                ...
                moreMaxCount: props.styles.moreMaxCount
            )
        )
        ...
        func calculatePersonList(
            ...
            let widthWithoutName = showAvatar ? avatarSize + avatarMarginRight :
                ...
                isLastPerson ? 0 : String(
                    BundleI18n.UniversalCardBase.OpenPlatform_Common_Comma
            ...
            let moreWidth = showAvatar ? avatarSize : String(
                BundleI18n.UniversalCardBase.OpenPlatform_CardForMyAi_PplCntAppend(count: totalCount - (index + 1))
            ...
            // case 1-3: 不是最后一行, 且完整的一行放不下人名, 且这行剩余的空间可以显示人名一个字以上, 则放入人名 + ...
                        ...
                        (String(person.getContent().prefix(1)).getWidth(font: nameFont) + widthWithoutName + ellipsisWidth < leftWidth) {
                let nameElement = Self.name(
                    formPerson: PersonWithSize(
                        person: person,
                        index: index,
    ...
    static func textMoreElement(
        ...
        let element = LKTextElement(
            id: "", style: style, text: BundleI18n.UniversalCardBase.OpenPlatform_CardForMyAi_PplCntAppend(count: count)
        )
    ...
    static func commaElement(font: UIFont) -> LKRichElement {
        let comma = LKTextElement(text: BundleI18n.UniversalCardBase.OpenPlatform_Common_Comma)
