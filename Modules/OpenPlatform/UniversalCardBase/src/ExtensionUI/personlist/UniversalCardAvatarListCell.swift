//
//  UniversalCardAvartarList.swift
//  LarkMessageCard
//
...
final class UniversalCardAvatarListCell: UITableViewCell {
    ...
    func update(person: Person) {
        ...
        title.text = person.content ?? BundleI18n.UniversalCardBase.OpenPlatform_CardCompt_UnknownUser
    }
}
