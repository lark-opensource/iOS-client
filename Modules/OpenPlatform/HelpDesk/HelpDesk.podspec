...
#
# Be sure to run `pod lib lint HelpDesk.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.summary          = 'lark helpdesk/oncall capability'
  s.description      = 'A module to contain helpdesk related logic used in lark ios-client'
  ...
  s.resource_bundles = {
      'HelpDesk' => ['resources/*.lproj/*', 'resources/*'],
      'HelpDeskAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
