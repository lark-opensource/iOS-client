...
#
# Be sure to run `pod lib lint OPJSEngine.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'OPJSEngine' => ['resources/*.lproj/*', 'resources/*'],
      'OPJSEngineAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
  ...
  s.dependency 'LarkJSEngine'
  s.dependency 'OPFoundation'
  s.dependency 'vmsdk/lark_worker'
  s.dependency 'vmsdk/umbrella'
