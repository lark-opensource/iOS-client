...
#
# Be sure to run `pod lib lint OPBlock.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'OPBlock' => ['resources/*.lproj/*', 'resources/*'] ,
      'OPBlockAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
