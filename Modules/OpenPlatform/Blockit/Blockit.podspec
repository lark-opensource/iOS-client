...
#
# Be sure to run `pod lib lint Blockit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://ee.byted.org/madeira/browse/ee/lark/ios-client/tree/master/Blockit'
  ...
  s.resource_bundles = {
      'Blockit' => ['resources/*.lproj/*' 'resources/*'] ,
      'BlockitAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
