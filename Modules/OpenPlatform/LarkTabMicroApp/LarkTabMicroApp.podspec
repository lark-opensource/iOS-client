...
#
# Be sure to run `pod lib lint LarkTabMicroApp.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkTabMicroApp'
  s.version = '5.31.0.5463996'
  s.summary          = '主导航小程序'
  s.description      = '主导航小程序运行页面'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "tujinqiu": 'tujinqiu@bytedance.com'
  }
  ...
  s.resource_bundles = {
      'LarkTabMicroApp' => ['resources/*'] ,
      'LarkTabMicroAppAuto' => 'auto_resources/*'
  }
