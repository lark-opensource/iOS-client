...
@implementation BDPTextAreaStyleModel
...
- (void)updateWithDictionary:(NSDictionary *)dict
{
    if (!BDPIsEmptyDictionary(dict)) {
        ...
        if ([dict valueForKey:@"minHeight"]) self.minHeight = [dict bdp_doubleValueForKey:@"minHeight"];
        if ([dict valueForKey:@"maxHeight"]) self.maxHeight = [dict bdp_doubleValueForKey:@"maxHeight"];
        if ([dict valueForKey:@"lineSpace"]) self.lineSpace = [dict bdp_doubleValueForKey:@"lineSpace"];
