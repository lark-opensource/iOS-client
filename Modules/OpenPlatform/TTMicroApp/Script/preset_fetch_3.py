...
#default session: XN0YXJ0-6e1re3ed-de60-431f-aec4-df9bbcr102i1-WVuZA
#feishu01 session: XN0YXJ0-3acpce81-a912-41a0-b656-5f14414f8151-WVuZA
#luo's session: XN0YXJ0-23emca8e-6903-4910-98cf-17ebad66730a-WVuZA
...
def fetchMetaData(appId):
    ...
    headers = {'content-type':'application/json',
               'accept':'*/*',
               'called_from':'miniapp',
               'x-tma-host-sessionid':'XN0YXJ0-23emca8e-6903-4910-98cf-17ebad66730a-WVuZA',
    ...
    "language": "ZH-CN",
    "platform": "ios",
    "sessionid": "XN0YXJ0-23emca8e-6903-4910-98cf-17ebad66730a-WVuZA",
    "token": "",
...
if __name__ == '__main__':
    ...
    for meta in metaList:
        ...
        packageData = urllib.request.urlopen(packageURL).read()
