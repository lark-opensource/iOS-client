...
#
# Be sure to run `pod lib lint BlockMod.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'BlockMod' => ['resources/*.lproj/*', 'resources/*'],
  #     'BlockModAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
