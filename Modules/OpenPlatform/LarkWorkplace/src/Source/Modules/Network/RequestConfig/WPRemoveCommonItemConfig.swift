//
//  WPRemoveCommonItemConfig.swift
//  LarkWorkplace
//
...
/// 工作台删除常用应用, itemId 与 appID 二选一
struct WPRemoveCommonItemConfig: ECONetworkRequestConfig {
    ...
    static var path: String {
        return "/lark/workplace/api/DeleteCommonItem"
    }
