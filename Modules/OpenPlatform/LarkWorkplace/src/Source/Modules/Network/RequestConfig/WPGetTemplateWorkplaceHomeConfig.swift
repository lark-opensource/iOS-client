//
//  WPGetTemplateWorkplaceHomeConfig.swift
//  LarkWorkplace
//
...
/// 获取模板化工作台首页相关数据
struct WPGetTemplateWorkplaceHomeConfig: ECONetworkRequestConfig {
    ...
    static var path: String {
        return "/lark/workplace/api/GetTemplateWorkplaceHome"
    }
