//
//  WPGetOperationNotificationConfig.swift
//  LarkWorkplace
//
...
/// 获取运营弹窗数据
struct WPGetOperationNotificationConfig: ECONetworkRequestConfig {
    ...
    static var path: String {
        return "/lark/workplace/api/operating/notifications"
    }
