...
#
# Be sure to run `pod lib lint OPFoundation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'OPFoundation' => ['resources/*.lproj/*' 'resources/*'] ,
      'OPFoundationAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }

  s.subspec 'OPPerformanceMonitor' do |ss|
    ss.source_files = 'src/PerformanceMonitor/**/*.{h,m,mm,swift}'
  end
  ...
  s.subspec 'OPAdapter' do |ss|
    ss.source_files = 'src/OPAdapter/**/*.{h,m,mm,swift}'
    ss.dependency 'LarkSensitivityControl'
    ss.dependency 'LarkSensitivityControl/Debug'
    ss.dependency 'LarkSetting'
    ss.dependency 'LarkOpenAPIModel'
  end
