...
#
# Be sure to run `pod lib lint OPUnitTestFoundation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'OPUnitTestFoundation' => ['resources/*.lproj/*', 'resources/*'],
  #     'OPUnitTestFoundationAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
