...
#
# Be sure to run `pod lib lint LarkOpenPluginManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkOpenPluginManager'
  s.version = '5.31.0.5476679'
  ...
  s.resource_bundles = {
      'LarkOpenPluginManager' => ['resources/*.lproj/*', 'resources/*'],
      'LarkOpenPluginManagerAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
