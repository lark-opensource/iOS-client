//
//  OPXScreenTransition.swift
//  OPGadget
//
//  Created by qianhongqiang on 2022/08/09.
//

import Foundation
import UniverseDesignColor

private class OPXScreenPresentationController: UIPresentationController {
...
class OPXScreenTransition: NSObject, UIViewControllerTransitioningDelegate {
    ...
    func presentationController(forPresented presented: UIViewController,
        ...
        -> UIPresentationController? {
            let vc = OPXScreenPresentationController(presentedViewController: presented,
        ...
        -> UIViewControllerAnimatedTransitioning? {
            if let horizontalSizeClass = presenting.view.superview?.traitCollection.horizontalSizeClass,
               horizontalSizeClass == .regular {
                ...
                let vc = OPXScreenPresentAnimatedTransitioning()
                vc.dimmingView = dimmingView
                return vc
            }
    }
...
class OPXScreenPresentAnimatedTransitioning: NSObject, UIViewControllerAnimatedTransitioning {
