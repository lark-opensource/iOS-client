...
#
# Be sure to run `pod lib lint LarkBlockHost.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'LarkBlockHost' => ['resources/*.lproj/*', 'resources/*'],
      'LarkBlockHostAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
