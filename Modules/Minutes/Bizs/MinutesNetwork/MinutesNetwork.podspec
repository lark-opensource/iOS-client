...
#
# Be sure to run `pod lib lint MinutesNetwork.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'MinutesNetwork'
  s.version          = '0.1.1'
  s.summary          = '妙记网络请求和Model相关仓库模块'
  s.description      = '妙记妙记网络请求和Model相关仓库模块'
  ...
  s.resource_bundles = {
      'MinutesNetwork' => ['resources/*.xcprivacy']
  }
