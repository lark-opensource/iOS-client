...
#
# Be sure to run `pod lib lint MinutesFoundation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files = 'src/**/*.{swift,metal}'
  s.resource_bundles = {
      'MinutesFoundation' => ['resources/*.lproj/*', 'resources/*.xcprivacy', 'resources/*'],
      'MinutesFoundationAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }

  s.ios.pod_target_xcconfig = { 'METAL_LIBRARY_OUTPUT_DIR' => '${TARGET_BUILD_DIR}/MinutesFoundation.bundle/' }
  ...
  s.weak_frameworks = 'MetalKit', 'Metal'
  ...
  s.dependency 'LarkTTNetInitializor'
  s.dependency 'LKCommonsTracker'
