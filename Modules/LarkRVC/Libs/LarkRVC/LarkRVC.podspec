...
#
# Be sure to run `pod lib lint LarkRVC.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.summary          = 'Lark RVC'
  s.description      = 'Room Virtual Controller'
  s.homepage         = 'https://code.byted.org/ee/LarkRVC'
  ...
  s.resource_bundles = {
      'LarkRVC' => ['resources/*.lproj/*', 'resources/*'],
      'LarkRVCAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
