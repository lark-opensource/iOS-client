...
{
"keys":{
"Lark_RVC_ImageSent_Toast":{
"hash":"JsU",
"#vars":0
},
"Lark_RVC_UnableToShareToChat_Toast":{
"hash":"/44",
"#vars":0
}
},
...
final class BundleI18n: LanguageManager {
    ...
    static func LocalizedString(key: String, originalKey: String, lang: Lang? = nil) -> String {
        func fetch() -> String {
            ...
            return self.localizedString(key: key, originalKey: originalKey, bundle: BundleConfig.LarkRVCAutoBundle, moduleName: "LarkRVC", lang: lang) ?? key
            #else
            return self.localizedString(key: key, bundle: BundleConfig.LarkRVCAutoBundle, moduleName: "LarkRVC", lang: lang) ?? key
            #endif
        }
    ...
    final class LarkRVC {
        @inlinable
        static var Lark_RVC_ImageSent_Toast: String {
            return LocalizedString(key: "JsU", originalKey: "Lark_RVC_ImageSent_Toast")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_RVC_ImageSent_Toast(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "JsU", originalKey: "Lark_RVC_ImageSent_Toast", lang: __lang)
        }
        @inlinable
        static var Lark_RVC_UnableToShareToChat_Toast: String {
            return LocalizedString(key: "/44", originalKey: "Lark_RVC_UnableToShareToChat_Toast")
        }
        /// - Parameter lang: 使用指定语言获取文案，同时获取多个不同语言的文案时，注意初始化加载主线程卡死风险
        @inlinable
        static func Lark_RVC_UnableToShareToChat_Toast(lang __lang: Lang? = nil) -> String {
            return LocalizedString(key: "/44", originalKey: "Lark_RVC_UnableToShareToChat_Toast", lang: __lang)
        }
    }
}
