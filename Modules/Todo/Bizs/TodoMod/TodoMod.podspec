...
#
# Be sure to run `pod lib lint TodoMod.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    ...
    s.subspec 'Core' do |cs|
      ...
      cs.dependency 'LarkAssembler/default'
      cs.dependency 'LarkAssembler/SwinjectBuilder'
      cs.dependency 'LarkAssembler/BootManagerBuilder'
      cs.dependency 'LarkBizTag/Chatter'
    ...
    s.if_pod 'MessengerMod' do |cs|
      ...
      cs.dependency 'LarkMessageBase'
      cs.dependency 'LarkMessageCore'
      cs.dependency 'LarkForward'
      cs.dependency 'LarkChat'
      cs.dependency 'LarkFlag'
