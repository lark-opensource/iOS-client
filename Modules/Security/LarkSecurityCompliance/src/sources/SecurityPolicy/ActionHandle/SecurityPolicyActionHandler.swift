//
//  SecurityPolicyActionHandler.swift
...
protocol SecurityPolicyActionHandler {
    init(resolver: UserResolver)
    func execute(action: SecurityActionProtocol, actionModel: ActionModel)
}

internal struct DefaultHandler: SecurityPolicyActionHandler {
    ...
    func execute(action: SecurityActionProtocol, actionModel: ActionModel) {
        SPLogger.info("cant fine style handler")
    }
}

internal struct CommonDialogActionHandler: SecurityPolicyActionHandler {
...
fileprivate extension SecurityPolicyActionOperation {
