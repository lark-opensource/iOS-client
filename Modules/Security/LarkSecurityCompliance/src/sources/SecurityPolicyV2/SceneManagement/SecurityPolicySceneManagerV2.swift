...
extension SecurityPolicyV2 {
    public class EventManager: SceneEventService {
        @SafeWrapper var sceneContexts: [SecurityPolicy.SceneContext] // SceneContext 在 interface层
        @SafeWrapper var sceneHandlers: [String: BizSceneEventHandler]
        ...
        private func startHandler(_ context: SecurityPolicy.SceneContext) {
        ...
        private func createHandler(_ sceneContext: SecurityPolicy.SceneContext) -> BizSceneEventHandler? {
