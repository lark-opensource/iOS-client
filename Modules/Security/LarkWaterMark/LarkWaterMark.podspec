...
#
# Be sure to run `pod lib lint LarkWaterMark.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.resource_bundles = {
  #     'LarkWaterMark' => ['resources/*.lproj/*', 'resources/*'],
  #     'LarkWaterMarkAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
