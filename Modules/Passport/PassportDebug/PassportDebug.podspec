...
#
# Be sure to run `pod lib lint PassportDebug.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'PassportDebug'
  s.version = '5.31.0.5463996'
  s.summary          = 'Passport 高级调试组件'
  s.description      = 'Passport 高级调试组件，包含Passport各类高级调试入口等'
  s.homepage         = 'git@code.byted.org:ee/LarkPassportSDK-iOS.git'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "name": 'caiweiwei.liam@bytedance.com'
  }
  ...
  # s.resource_bundles = {
  #     'PassportDebug' => ['resources/*.lproj/*', 'resources/*'],
  #     'PassportDebugAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
