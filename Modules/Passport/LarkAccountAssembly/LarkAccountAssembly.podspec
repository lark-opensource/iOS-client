...
#
# Be sure to run `pod lib lint LarkAccountAssembly.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkAccountAssembly'
  s.version = '5.31.0.5467269'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "caiweiwei": 'caiweiwei.liam@bytedance.com'
  }
  ...
  s.resource_bundles = {
      'LarkAccountAssembly' => ['resources/*.lproj/*', 'resources/*'],
      'LarkAccountAssemblyAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  }
  ...
  s.dependency 'LarkRustClientAssembly'
