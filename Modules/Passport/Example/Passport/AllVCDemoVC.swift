...
//            }),
//            ("Select User", {
//                let vc = DebugFactory.shared.selectUserList()
//                self.navigationController?.pushViewController(vc, animated: true)
//            }),
//            ("Set Password", {
//                let vc = DebugFactory.shared.setPassword()
//                self.navigationController?.pushViewController(vc, animated: true)
//            }),
//            ("User Operation", {
//                AccountServiceAdapter.shared.pushToTeamConversion(fromNavigation: self.navigationController!, trackPath: nil)
//            }),
//            ("OAuth Code", {
