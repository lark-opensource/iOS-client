...
#
# Be sure to run `pod lib lint LarkAccountInterface.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkAccountInterface'
  s.version = '5.31.0.5454235'
  ...
  s.subspec 'Core' do |cs|
    cs.source_files  = 'src/Core/**/*.{h,m,mm,swift}'
  ...
  s.subspec 'Authorization' do |cs|
    cs.source_files = 'src/Authorization/**/*.{h,m,mm,swift}'

    cs.dependency 'LarkAccountInterface/Core'
    cs.pod_target_xcconfig = { 'OTHER_SWIFT_FLAGS' => '-D LarkAccountInterface_Authorization' }
  end
