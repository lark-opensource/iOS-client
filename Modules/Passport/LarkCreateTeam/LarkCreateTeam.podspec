...
#
# Be sure to run `pod lib lint LarkCreateTeam.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name             = 'LarkCreateTeam'
  s.version = '5.31.0.5470170'
  ...
  #  s.resource_bundles = {
  #      'LarkCreateTeam' => ['resources/*'] ,
  #      'LarkCreateTeamAuto' => 'auto_resources/*'
  #  }
