...
#
# Be sure to run `pod lib lint WebAppContainer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
      'WebAppContainer' => ['resources/*'],
      'WebAppContainerAuto' => ['auto_resources/*']
  }
