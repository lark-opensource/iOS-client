...
Pod::Spec.new do |s|
  ...
  s.summary = 'SpaceKit UIKit'
  s.description = 'SpaceKit UI 通用组件'
  s.homepage = 'https://code.byted.org/ee/spacekit-ios/tree/develop/Libs/SKUIKit'
  ...
  s.preserve_paths = ['Scripts', 'SKUIKit.podspec']

  # s.public_header_files = 'Pod/Classes/**/*.h'
  s.source_files = 'src/**/*.{swift,h,m,mm,cpp}'
  # s.resource_bundles = {
  #     'SKUIKit' => ['Resources/**/*'] ,
  #     'SKUIKitAuto' => ['auto_resources/*']
  # }
