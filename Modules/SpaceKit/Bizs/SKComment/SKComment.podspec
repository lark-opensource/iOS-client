...
#
# Be sure to run `pod lib lint SKComment.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.summary          = '文档评论模块'
  s.description      = '评论业务相关'
  s.homepage         = 'https://code.byted.org/lark/iOS-client/tree/develop/Modules/SpaceKit/Bizs/SKComment'
  ...
  # s.resource_bundles = {
  #     'SKComment' => ['resources/*.lproj/*', 'resources/*'],
  #     'SKCommentAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
