...
#
# Be sure to run `pod lib lint SKDrive.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.summary          = 'CCM Drive 业务'
  s.description      = 'CCM 云盘文件预览能力'
  s.homepage         = 'https://code.byted.org/ee/spacekit-ios/tree/develop/Bizs/SKDrive'
