...
final class QuickAccessViewModelTests: XCTestCase {
    ...
    static func mockVM(usingV2API: Bool = true, homeType: SpaceHomeType = .spaceTab) -> QuickAccessViewModel {
        let dm = QuickAccessDataModel(userID: "userID", apiType: usingV2API ? .v2 : .v1)
        let vm = QuickAccessViewModel(dataModel: dm, homeType: homeType)
        return vm
    }
