...
class BitableRecentListViewModelTests: XCTestCase {
    ...
    private func createRecentListViewModel(homeType: SpaceHomeType = .spaceTab) -> BitableRecentListViewModel {
        ...
        let mockDM = RecentListDataModel(userResolver: self.userResolver,
                                         ...
                                         homeType: homeType)
        let viewModel = BitableRecentListViewModel(dataModel: mockDM)
        return viewModel
    }
