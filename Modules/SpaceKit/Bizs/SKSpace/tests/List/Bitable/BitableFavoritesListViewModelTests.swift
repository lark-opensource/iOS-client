...
final class BitableFavoritesListViewModelTests: XCTestCase {
    ...
    static func mockVM(homeType: SpaceHomeType = .spaceTab) -> BitableFavoritesViewModel {
        BitableFavoritesViewModel(dataModel: FavoritesDataModelTests.mockDM(), homeType: homeType)
    }
