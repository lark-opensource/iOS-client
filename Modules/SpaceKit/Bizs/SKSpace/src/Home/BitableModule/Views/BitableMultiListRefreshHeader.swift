//
//  BitableMultiListRefreshHeader.swift
//  SKSpace
//
...
open class BitableMultiListIndicatorView: UIView {
    ...
    public var color: UIColor = BitableMultiListIndicatorView.defaultColor
    ...
    public init(frame: CGRect = .zero, color: UIColor? = nil) {
        self.color = color ?? BitableMultiListIndicatorView.defaultColor
...
class BitableMultiListRefreshHeader: UIView, ESRefreshProtocol, ESRefreshAnimatorProtocol {
    ...
    private let indicatorView = BitableMultiListIndicatorView(color: UIColor.ud.primaryContentDefault)
    ...
    override init(frame: CGRect) {
        ...
        indicatorView.snp.makeConstraints {
            $0.width.height.equalTo(BitableMultiListIndicatorView.defaultSize.width)
