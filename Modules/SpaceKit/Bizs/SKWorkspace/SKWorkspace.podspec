...
#
# Be sure to run `pod lib lint SKWorkspace.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.summary          = 'space和wiki公共模块'
  s.description      = 'space和wiki公共业务基础库'
  s.homepage         = 'https://code.byted.org/lark/iOS-client/tree/develop/Modules/SpaceKit/Bizs/SKWorkspace'
  ...
  # s.resource_bundles = {
  #     'SKWorkspace' => ['resources/*.lproj/*', 'resources/*'],
  #     'SKWorkspaceAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
