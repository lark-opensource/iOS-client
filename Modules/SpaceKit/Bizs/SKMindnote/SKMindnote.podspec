...
#
# Be sure to run `pod lib lint SKMindnote.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version  = '5.28.0'
  s.summary = '思维导图'
  s.description = '只存在于思维导图里面的功能的代码'
  s.homepage = 'https://code.byted.org/ee/spacekit-ios/tree/develop/Bizs/SKMindnote'
  ...
  s.preserve_paths = ['Scripts', 'SKMindnote.podspec']
