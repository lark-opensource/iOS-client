...
#
# Be sure to run `pod lib lint SKPermission.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.summary          = '文档权限模块'
  s.description      = '文档权限业务相关'
  s.homepage         = 'https://code.byted.org/lark/iOS-client/tree/develop/Modules/SpaceKit/Bizs/SKPermission'
  ...
  # 责任人，必填。必要时要及时更新该信息
  s.authors = {
    "wuwenjian": 'wuwenjian.weston@bytedance.com'
  }
  ...
  # s.resource_bundles = {
  #     'SKPermission' => ['resources/*.lproj/*', 'resources/*'],
  #     'SKPermissionAuto' => ['auto_resources/*.lproj/*', 'auto_resources/*', 'R/**/*']
  # }
  ...
  # 依赖 PermissionStatistics 抽离
  s.dependency 'SKCommon'
  ...
  attributes_hash['extra'] = {
    ...
    test_spec.dependency 'LarkLocalizations'
    test_spec.dependency 'LarkKAFKMS'
  end
end
